...
class WorksheetInfo:
	...
	#  @return None
	def testdata_getTableFile(self, str_output_pathTable):
	...
	for name_workbook in list_workbook:
		...
		for worksheet in list_worksheet:
			...
			if bool_enable_write_test_data:
				...
				class_worksheet_info.testdata_getTableFile(str_output_pathTable)
			...
			if bool_enable_write_test_code:
				...
				# write test code
				uts_tsc_write_test_code(str_output_pathCode, worksheet, str_function_name, list_pattern_info, config_parser)
