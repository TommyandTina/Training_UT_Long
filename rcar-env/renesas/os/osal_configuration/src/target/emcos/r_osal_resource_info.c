...
#define    OSAL_THREAD_CPURTT_TP_TASK                (RESORCE_ID_CPURTT +  7U)
...
#define    OSAL_MUTEX_SMD_PSO_00                     (RESORCE_ID_VIP   + 18U)
#define    OSAL_MUTEX_SMD_PSO_01                     (RESORCE_ID_VIP   + 19U)
...
const st_osal_mmngr_config_t g_osal_memory_max_configration =
{
    ...
    .memory_limit = (384U * 1024U * 1024U),
    .max_allowed_allocations = (1U * 1024U),
    .max_registered_monitors_cbs = (1U * 1024U)
};
...
const st_osal_rcfg_thread_config_t g_osal_thread_config[] =
{
    ...
    {OSAL_THREAD_CPURTT_TP_TASK,    {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "cpurtt_tp_task",      0x1000} },
...
const st_osal_rcfg_mutex_config_t g_osal_mutex_config[] =
{
    ...
    {OSAL_MUTEX_SMD_PSO_00     },
    {OSAL_MUTEX_SMD_PSO_01     },
