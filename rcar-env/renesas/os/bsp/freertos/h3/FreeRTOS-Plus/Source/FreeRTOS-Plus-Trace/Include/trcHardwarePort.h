...
#elif (TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_Renesas_RCar)

/* Cortex-R7 Private Timer */
#define CR7_PRIV_TIMER_BASEADDR     0xf0000600U
#define CR7_PRIV_TIMER_LOAD         (CR7_PRIV_TIMER_BASEADDR + 0x00)
#define CR7_PRIV_TIMER_COUNTER      (CR7_PRIV_TIMER_BASEADDR + 0x04)
#define CR7_PRIV_TIMER_CLOCK        200000000   /* Hz */

	#define TRC_HWTC_TYPE TRC_OS_TIMER_INCR
	#define TRC_HWTC_COUNT *((uint32_t *)(CR7_PRIV_TIMER_COUNTER))

	#define TRC_HWTC_PERIOD *((uint32_t *)(CR7_PRIV_TIMER_LOAD))
	#define TRC_HWTC_DIVISOR 1
