...
#ifndef RAVB_DEVNP_IOCTL_H
#define RAVB_DEVNP_IOCTL_H

#include <stdint.h>


#define RAVB_IOCTL SIOCGDRVSPEC
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devnp/ravb/public/hw/ravb_devnp_ioctl.h $ $Rev: 916704 $")
#endif
