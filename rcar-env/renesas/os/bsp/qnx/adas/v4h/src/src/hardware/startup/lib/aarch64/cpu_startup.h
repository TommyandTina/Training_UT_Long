...
#define CPU_COMMON_OPTIONS_STRING	"E:X:U"
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/aarch64/cpu_startup.h $ $Rev: 971387 $")
#endif
