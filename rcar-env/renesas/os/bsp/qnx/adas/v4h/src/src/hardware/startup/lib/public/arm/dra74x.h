...
#define DRA74X_TIMER_SIZE                       0x1000

#define DRA74X_TIMER_TIDR			0x00		/* Timer Identification Register */
#define DRA74X_TIMER_THWINFO			0x04
#define DRA74X_TIMER_TIOCP_CFG			0x10		/* Timer OCP Configuration Register */
#define DRA74X_TIMER_IRQ_EOI			0x20		/* Timer IRQ EOI Register */
#define DRA74X_TIMER_IRQSTATUS_RAW		0x24		/* Timer IRQ STATUS RAW Register */
#define DRA74X_TIMER_IRQSTATUS			0x28		/* Timer IRQ STATUS Register */
#define DRA74X_TIMER_IRQENABLE_SET		0x2C		/* Timer IRQ ENABLE SET Register*/
#define DRA74X_TIMER_IRQENABLE_CLR		0x30		/* Timer IRQ ENABLE CLR Register*/
#define DRA74X_TIMER_IRQWAKEEN			0x34		/* Timer IRQ WAKEUP ENABLE Register*/
#define DRA74X_TIMER_TCLR			0x38		/* Timer Control Register */
#define DRA74X_TIMER_TCRR			0x3C		/* Timer Counter Register */
#define DRA74X_TIMER_TLDR			0x40		/* Timer Load Value Register*/
#define DRA74X_TIMER_TTGR			0x44		/* Timer Trigger Register */
#define DRA74X_TIMER_TWPS			0x48		/* Timer Write Posted Status Register */
#define DRA74X_TIMER_TMAR			0x4C		/* Timer Match Register*/
#define DRA74X_TIMER_TCAR1			0x50		/* Timer Capture Register 1 */
#define DRA74X_TIMER_TSICR			0x54		/* Timer Synchronous Interface Control Register */
#define DRA74X_TIMER_TCAR2			0x58		/* Timer Capture Register 2 */
#define DRA74X_TIMER_TPIR			0x5C		/* Timer Postive Increment Register */
#define DRA74X_TIMER_TNIR			0x60		/* Timer Negative Increment Register */

/* Timer register bits */
#define BIT(x)				        (1 << x)
#define CL_BIT(x)			        (0 << x)
#define DRA74X_TIMER_MAT_EN_FLAG		BIT(0)		/* IRQ bit for Match */
#define DRA74X_TIMER_OVF_EN_FLAG		BIT(1)		/* IRQ bit for Overflow */
#define DRA74X_TIMER_TCAR_EN_FLAG		BIT(2)		/* IRQ bit for Compare */

#define DRA74X_TIMER_TCLR_ST			BIT(0)		/* Start=1 Stop=0 */
#define DRA74X_TIMER_TCLR_AR			BIT(1)		/* Auto reload */
#define DRA74X_TIMER_TCLR_PTV_SHIFT		(2)			/* Pre-scaler shift value */
#define DRA74X_TIMER_TCLR_PRE			BIT(5)		/* Pre-scaler enable for the timer input clk */
#define DRA74X_TIMER_TCLR_PRE_DISABLE	        CL_BIT(5)	/* Pre-scalar disable for the timer input clk */


/*************************************************/
/* Real time clock */
/*************************************************/
#define DRA74X_RTC_BASE                         0x48838000
#define DRA74X_RTC_SIZE                         0x1000

#define DRA74X_RTC_SECONDS                      0x00
#define DRA74X_RTC_MINUTES                      0x04
#define DRA74X_RTC_HOURS                        0x08
#define DRA74X_RTC_DAYS                         0x0c
#define DRA74X_RTC_MONTHS                       0x10
#define DRA74X_RTC_YEARS                        0x14
#define DRA74X_RTC_WEEKS                        0x18
#define DRA74X_RTC_ALARM_SECONDS                0x20
#define DRA74X_RTC_ALARM_MINUTES                0x24
#define DRA74X_RTC_ALARM_HOURS                  0x28
#define DRA74X_RTC_ALARM_DAYS                   0x2c
#define DRA74X_RTC_ALARM_MONTHS                 0x30
#define DRA74X_RTC_ALARM_YEARS                  0x34
#define DRA74X_RTC_CTRL                         0x40
    #define DRA74X_RTC_CTRL_RTC_DISABLE         0x40
    #define DRA74X_RTC_CTRL_SET_32_CNTR         0x20
    #define DRA74X_RTC_CTRL_TEST_MODE           0x10
    #define DRA74X_RTC_CTRL_MODE_12_24          0x08
    #define DRA74X_RTC_CTRL_AUTO_COMP           0x04
    #define DRA74X_RTC_CTRL_ROUND_30S           0x02
    #define DRA74X_RTC_CTRL_STOP_RTC            0x01
#define DRA74X_RTC_STATUS                       0x44
    #define DRA74X_RTC_STATUS_ALARM             0x40
    #define DRA74X_RTC_STATUS_1D_EVENT          0x20
    #define DRA74X_RTC_STATUS_1H_EVENT          0x10
    #define DRA74X_RTC_STATUS_1M_EVENT          0x08
    #define DRA74X_RTC_STATUS_1S_EVENT          0x04
    #define DRA74X_RTC_STATUS_RUN               0x02
    #define DRA74X_RTC_STATUS_BUSY              0x01
#define DRA74X_RTC_INTERRUPTS                   0x48
#define DRA74X_RTC_COMP_LSB                     0x4c
#define DRA74X_RTC_COMP_MSB                     0x50
#define DRA74X_RTC_OSC                          0x54
    #define DRA74X_RTC_OSC_CLK_EN               0x40
    #define DRA74X_RTC_OSC_SWRESET              0x20
    #define DRA74X_RTC_OSC_OSC32KPWRDNR         0x10
    #define DRA74X_RTC_OSC_SWRESPROG_MASK       0x0F
    #define DRA74X_RTC_OSC_32CLK_SEL            0x08
    #define DRA74X_RTC_OSC_RES_SEL              0x04
    #define DRA74X_RTC_OSC_SW2                  0x02
    #define DRA74X_RTC_OSC_SW1                  0x01
#define DRA74X_RTC_SCRATCH0                     0x60
#define DRA74X_RTC_SCRATCH1                     0x64
#define DRA74X_RTC_SCRATCH2                     0x68
#define DRA74X_RTC_KICK0R                       0x6C
    #define DRA74X_RTC_UNLOCK_SEQ0              0x83e70b13
    #define DRA74X_RTC_UNLOCK_SEQ1              0x95a4f1e0
#define DRA74X_RTC_KICK1R                       0x70
#define DRA74X_RTC_REVISION                     0x74
#define DRA74X_RTC_SYSCONFIG                    0x78
#define DRA74X_RTC_IRQWAKEEN_0                  0x7A
...
#define DRA74X_UART6_BASE                       0x48068000
#define DRA74X_UART7_BASE                       0x48420000
#define DRA74X_UART8_BASE                       0x48422000
#define DRA74X_UART9_BASE                       0x48424000
...
#define DRA74X_MA_PRIORITY                      0x482A2000
...
/* IODELAYCONFIG */
/*************************************************/
#define IODELAY_CONFIG_BASE                     0x4844A000
...
/* PWMSS */
/*************************************************/
#define DRA74X_PWMSS1_BASE                      0x4843E200
#define DRA74X_PWMSS2_BASE                      0x48440200
#define DRA74X_PWMSS3_BASE                      0x48442200
    #define PWMSS_TBCTL                         0x00
    #define PWMSS_TBPRD                         0x0A
    #define PWMSS_CMPA                          0x12
    #define PWMSS_CMPB                          0x14
    #define PWMSS_AQCTLA                        0x16
    #define PWMSS_AQCTLB                        0x18
    #define PWMSS_AQSFRC                        0x1A
    #define PWMSS_AQCSFRC                       0x1C
...
#define CM_AUTOIDLE_DPLL_DSP			0x23C
...
#define CM_AUTOIDLE_DPLL_EVE			0x28C
#define CM_CLKMODE_DPLL_GMAC                    0x2A8
#define CM_AUTOIDLE_DPLL_GMAC			0x2B0
#define CM_CLKMODE_DPLL_GPU                     0x2D8
#define CM_AUTOIDLE_DPLL_GPU			0x2E0

/* cm1.mpu */
#define CM_MPU_CLKSTCTRL                        0x300
...
#define CM_IPU_MCASP1_CLKCTRL                   0x550
    ...
    #define CM_MCASP_CLKSEL_AHCLKX_XREF0        8
...
/* RTC  */
/*************************************************/
#define CM_RTC_CLKSTCTRL                        0x740
#define CM_RTC_RTCSS_CLKCTRL                    0x744
...
#define CM_AUTOIDLE_DPLL_PCIE_REF		0x3208
...
#define CM_COREAON_CLKOUTMUX1_CLKCTRL           0x36A0
#define CM_COREAON_CLKOUTMUX2_CLKCTRL           0x36B0
#define CM_COREAON_L3INIT_60M_GFCLK_CLKCTRL     0x36C0
#define CM_COREAON_ABE_GICLK_CLKCTR             0x36D0
...
#define CM_GPU_GPU_CLKCTRL_FCLK_GPU             0x02000000
#define CM_GPU_GPU_CLKCTRL_HYDCLK_PER           0x04000000
#define CM_GPU_GPU_CLKCTRL_HYDCLK_GPU           0x08000000
...
/* Power Management */
/*************************************************/
#define PM_MPU_PWRSTCTL                         0x4AE06300
#define PM_DSP1_PWRSTCTL                        0x4AE06400
#define PM_IPU_PWRSTCTRL                        0x4AE06500
#define PM_DSP2_PWRSTCTL                        0x4AE07B00
...
#define PM_DSP1_PWRSTST                         0x4AE06404
#define PM_DSP2_PWRSTST                         0x4AE07B04
...
// Manual/Virtual Modes
#define MANUAL_MODE                            (1 << 8)
#define VIRTUAL_MODE0                          ((1 << 8) | (0x0 << 4))
#define VIRTUAL_MODE1                          ((1 << 8) | (0x1 << 4))
#define VIRTUAL_MODE2                          ((1 << 8) | (0x2 << 4))
#define VIRTUAL_MODE3                          ((1 << 8) | (0x3 << 4))
#define VIRTUAL_MODE4                          ((1 << 8) | (0x4 << 4))
#define VIRTUAL_MODE5                          ((1 << 8) | (0x5 << 4))
#define VIRTUAL_MODE6                          ((1 << 8) | (0x6 << 4))
#define VIRTUAL_MODE7                          ((1 << 8) | (0x7 << 4))
#define VIRTUAL_MODE8                          ((1 << 8) | (0x8 << 4))
#define VIRTUAL_MODE9                          ((1 << 8) | (0x9 << 4))
#define VIRTUAL_MODE10                         ((1 << 8) | (0xa << 4))
#define VIRTUAL_MODE11                         ((1 << 8) | (0xb << 4))
#define VIRTUAL_MODE12                         ((1 << 8) | (0xc << 4))
#define VIRTUAL_MODE13                         ((1 << 8) | (0xd << 4))
#define VIRTUAL_MODE14                         ((1 << 8) | (0xe << 4))
#define VIRTUAL_MODE15                         ((1 << 8) | (0xf << 4))
...
#define CTRL_CORE_CONTROL_PBIAS_SDCARD_BIAS_1_8V          (0 << 21)
#define CTRL_CORE_CONTROL_PBIAS_SDCARD_BIAS_3V            (1 << 21)
#define CTRL_CORE_CONTROL_PBIAS_SDCARD_BIAS_MASK          (1 << 21)
#define CTRL_CORE_CONTROL_PBIAS_SDCARD_BIAS_VMODE_ERROR   (1 << 23)
...
#define CTRL_WKUP_ID_CODE                       0x204
    ...
    #define DRA7xx_ID_CODE_ES2_0                0x2B99002F
    #define DRA7xx_ID_CODE_ES1_1                0x1B99002F
    #define DRA7xx_ID_CODE_ES2_0                0x2B99002F
    #define DRA72x_ID_CODE_ES1_0                0x0B9BC02F
...
#define CTRL_WKUP_EFUSE_1                       0x5C8
#define CTRL_WKUP_EFUSE_2                       0x5CC
#define CTRL_WKUP_EFUSE_3                       0x5D0
#define CTRL_WKUP_EFUSE_4                       0x5D4
#define CTRL_WKUP_EFUSE_13                      0x5F8
...
#define EMIF_DDR_EXT_PHY_STATUS(x)              (0x144 + 4*(x))
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/dra74x.h $ $Rev: 870901 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/dra74x.h $ $Rev: 870901 $" )
#endif
#endif
