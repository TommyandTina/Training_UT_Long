...
const struct debug_device debug_devices[] = {
    ...
    {   "hscif0",
        {   "0xE6540000.0.266666666.16",    /* HSCIF0, set the baud rate set by boot loader */
        },
        init_scif,
        put_scif,
        {   &display_char_scif,
    ...
    {   "hscif1",
        {   "0xE6550000.0.266666666.16",    /* HSCIF1, set the baud rate set by boot loader */
        },
        init_scif,
        put_scif,
        {   &display_char_scif,
    ...
    {   "hscif2",
        {   "0xE6560000.0.266666666.16",    /* HSCIF2, set the baud rate set by boot loader */
        },
        init_scif,
        put_scif,
        {   &display_char_scif,
    ...
    {   "hscif3",
        {   "0xE65A0000.0.266666666.16",    /* HSCIF3, set the baud rate set by boot loader */
        },
        init_scif,
        put_scif,
        {   &display_char_scif,
