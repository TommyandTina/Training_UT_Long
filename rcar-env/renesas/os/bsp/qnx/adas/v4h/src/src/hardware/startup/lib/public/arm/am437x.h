...
#define AM437X_L2_CACHE_SET_CONTROL_REG            0x102
...
#define AM437X_L2_CACHE_SET_FILTER_REG             0x114
#define AM437X_L2_CACHE_CLEAN_SET_WAY_REG          0x115
#define AM437X_L1_CACHE_SET_CONTROL_REG            0x116 // L1 Cache Set Pre-fetch Enable: enable and disable L1 pre-fetch.
#define AM437X_SCTLR_RR_CONTROL                    0x117 // SCTLR Round-Robin Enable: enable and disable round-robin replacement strategy for caches, BTAC, and micro TLBs.
#define AM437X_CP15_SET_ACTLR_REG                  0x118 // CP15 Set ACTLR Register: sets the given input value in the CP15 ACTLR register.
...
/******************************/
/* PWMSS  register defines */
/******************************/
#define AM437X_PWMSS0_BASE                0x48300000
#define AM437X_PWMSS1_BASE                0x48302000
#define AM437X_PWMSS2_BASE                0x48304000
#define AM437X_PWMSS3_BASE                0x48306000
#define AM437X_PWMSS4_BASE                0x48308000
#define AM437X_PWMSS5_BASE                0x4830A000
#define AM437X_PWMSS_SIZE                 0x260

    #define PWMSS_ECAP_TSCTR              0x100
    #define PWMSS_ECAP_CTRPHS             0x104
    #define PWMSS_ECAP_CAP1               0x108
    #define PWMSS_ECAP_CAP2               0x10C
    #define PWMSS_ECAP_CAP3               0x110
    #define PWMSS_ECAP_CAP4               0x114
    #define PWMSS_ECAP_ECCTL1             0x128
    #define PWMSS_ECAP_ECCTL2             0x12A
    #define PWMSS_ECAP_ECEINT             0x12C
    #define PWMSS_ECAP_ECFLG              0x12E
    #define PWMSS_ECAP_ECCLR              0x130
    #define PWMSS_ECAP_ECFRC              0x132
    #define PWMSS_ECAP_REVID              0x15C
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/am437x.h $ $Rev: 870901 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/am437x.h $ $Rev: 870901 $" )
#endif
#endif
