...
#define LS10XX_SCFG_QSPI_CFG        0x15C
    #define LS10XX_SCFG_QSPI_CFG_CLK_SEL(x) ((x & 0xF) << 28)
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/aarch64/ls10xx.h $ $Rev: 937164 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/aarch64/ls10xx.h $ $Rev: 937164 $" )
#endif
#endif
