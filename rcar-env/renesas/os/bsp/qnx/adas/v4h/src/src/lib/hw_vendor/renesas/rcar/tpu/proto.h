...
#define RCAR_TPU_BASE				    0xE6E80000
#define RCAR_TPU_SIZE 				    0x200

#define RCAR_TPU_REFCLOCK               66666667

#define RCAR_TPU_CHANNELS               4

#define RCAR_TPU_0_OFFSET			    0x000
#define RCAR_TPU_1_OFFSET			    0x040
#define RCAR_TPU_2_OFFSET			    0x080
#define RCAR_TPU_3_OFFSET			    0x0C0

/* Timer start register */
#define RCAR_TPU_TSTR                   0x00
...
#define RCAR_TPU_TIER				    0x1C
#define RCAR_TPU_TSR				    0x20
...
#define RCAR_TPU_TCNT				    0x24		// Timer counter
#define RCAR_TPU_TGRA				    0x28		// Timer general register A 
#define RCAR_TPU_TGRB				    0x2C		// Timer general register B
#define RCAR_TPU_TGRC				    0x30		// Timer general register C
#define RCAR_TPU_TGRD				    0x44		// Timer general register D

/* Motor control */
#define RCAR_TPU_TMIR                   0x100
#define RCAR_TPU_TMRR                   0x104
#define RCAR_TPU_TMSR                   0x108
#define RCAR_TPU_TMMPR0                 0x10C
#define RCAR_TPU_TMMPR1                 0x110
#define RCAR_TPU_TMSPR0                 0x114
#define RCAR_TPU_TMSPR1                 0x118
#define RCAR_TPU_TMOPR                  0x11C
#define RCAR_TPU_TMASR                  0x120
#define RCAR_TPU_TMTSR                  0x130
#define RCAR_TPU_TMRSR                  0x134
#define RCAR_TPU_TMSCR                  0x140
#define RCAR_TPU_TMTCR                  0x144
