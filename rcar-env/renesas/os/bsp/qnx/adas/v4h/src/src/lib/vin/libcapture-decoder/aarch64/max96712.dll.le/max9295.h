...
/* Possible MAX9295 addresses on i2c bus */
#define MAX9295_SLAVE_ADDR0      0x80
#define MAX9295_SLAVE_ADDR1      0x84
#define MAX9295_SLAVE_ADDR2      0xC0
#define MAX9295_SLAVE_ADDR3      0xC4
