...
* 			on error
*/ 
unsigned hwibus_add_sdio(unsigned parent_hwi_off, hwiattr_sdio_t *attr)
{
	unsigned hwi_off = hwibus_add(HWI_ITEM_BUS_SDIO, parent_hwi_off);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/hwibus_add_sdio.c $ $Rev: 680332 $")
#endif
