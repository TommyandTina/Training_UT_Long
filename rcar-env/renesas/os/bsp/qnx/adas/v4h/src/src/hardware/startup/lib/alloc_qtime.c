 ...
 *	IPL info or an RTC chip. Also initializes some generic options.
 */
...
alloc_qtime() {
	...
	// initialize generic fields here
	qtime->timer_prog_time = timer_prog_time;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/alloc_qtime.c $ $Rev: 910727 $")
#endif
