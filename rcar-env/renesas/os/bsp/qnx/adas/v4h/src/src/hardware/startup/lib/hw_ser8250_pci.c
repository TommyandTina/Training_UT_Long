...
/* taken directly from deprecated hw/pci.h */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/hw_ser8250_pci.c $ $Rev: 819074 $")
#endif
