...
typedef struct
{
	...
	*/
	...
	unsigned				num_dma;	// number of 'dma' tags to create
} hwiattr_common_t;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/sys/hwinfo.h $ $Rev: 842080 $")
#endif
