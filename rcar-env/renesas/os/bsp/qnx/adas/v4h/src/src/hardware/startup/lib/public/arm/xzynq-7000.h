/*
 * $QNXLicenseC:
 * Copyright 2007, 2019, 2022, QNX Software Systems.
 *
...
#define XZYNQ_HWI_WDT                           "wdog"
#define XZYNQ_HWI_DMA                           "dma"
#define XZYNQ_HWI_ENET                          "xzynq"
#define XZYNQ_HWI_ENET_MDIO                     "xzynq,mdio"
#define XZYNQ_HWI_ENET_SWITCH                   "bcm"
...
#define XZYNQ_EMAC_NAME			XZYNQ_HWI_ENET
...
#define XZYNQ_GPIOPS_DATA_1_LSW_OFFSET  0x008  /* Mask and Data Register LSW, WO - Bank 1*/
#define XZYNQ_GPIOPS_DATA_1_MSW_OFFSET  0x00C  /* Mask and Data Register MSW, WO - Bank 1*/
#define XZYNQ_GPIOPS_DATA_OFFSET        0x040  /* Output Data Register, RW */
#define XZYNQ_GPIOPS_DATA_RO_OFFSET     0x060  /* Input Data Register, RO */
...
#define XZYNQ_GPIOPS_DIRM_1_OFFSET      0x244  /* Direction Mode Register, RW - Bank 1*/
#define XZYNQ_GPIOPS_OUTEN_1_OFFSET     0x248  /* Output Enable Register, RW - Bank 1*/
/* @} */
...
#define XZYNQ_MPCORE_SCU_CTRL_REG           0x00000000
...
/* GEM RCLK CTRL registers */
#define XZYNQ_SLCR_GEM_RCLK_CTRL_SRCSEL_MIO		(0x0 << 4)
#define XZYNQ_SLCR_GEM_RCLK_CTRL_SRCSEL_EMIO		(0x1 << 4)
#define XZYNQ_SLCR_GEM_RCLK_CTRL_CLKACT_EN		(0x1 << 0)
#define XZYNQ_SLCR_GEM_RCLK_CTRL_CLKACT_DIS		(0x0 << 0)
...
#define XZYNQ_SLCR_PSS_RST_MASK			(1)
#define XZYNQ_SLCR_CAN0_RST_MASK		(1)
#define XZYNQ_SLCR_CAN1_RST_MASK		(2)

#define XZYNQ_SLCR_MIO_PIN_REG_WRITE(pin_num, val)		\
	out32(XZYNQ_SLCR_BASE + XZYNQ_SLCR_MIO_PIN_REG + (pin_num * 4), val)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/xzynq-7000.h $ $Rev: 965830 $")
#endif
