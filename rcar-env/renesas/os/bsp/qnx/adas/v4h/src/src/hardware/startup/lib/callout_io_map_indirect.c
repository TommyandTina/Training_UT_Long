...
uintptr_t
callout_io_map_indirect(unsigned size, paddr_t *phys) {
	return callout_io_map(size, *phys);
}

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/callout_io_map_indirect.c $ $Rev: 680332 $")
#endif
