...
unsigned syspage_roundup = sizeof(uint64_t);
...
cpu_alloc_syspage_memory(PADDR_T *cpupagep, PADDR_T *syspagep, unsigned spsize)
{
	...
	spsize = ROUND(spsize, syspage_roundup);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/aarch64/cpu_syspage_memory.c $ $Rev: 951543 $")
#endif
