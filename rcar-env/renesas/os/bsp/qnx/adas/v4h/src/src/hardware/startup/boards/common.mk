...
NAME = startup-$(SOC)-$(BOARD)
BUILD_NAME = $(SOC)-$(BOARD)
#EXTRA_SILENT_VARIANTS+=$(subst -, ,$(BOARD) $(SECTION))
EXTRA_SILENT_VARIANTS+=$(subst -, ,$(BOARD) $(SECTION) $(SOC))
USEFILE = 
...
define POST_INSTALL
	-$(foreach build,$(EXAMPLE_BUILDFILES) $(EXAMPLE_READMES), $(CP_HOST) $(build) $(INSTALL_ROOT_nto)/$(CPUVARDIR)/boot/build/$(BUILD_NAME).$(notdir $(build));)
endef
...
CCFLAGS_aarch64 += -mstrict-align -fno-store-merging -fno-gcse  -fno-inline-small-functions
