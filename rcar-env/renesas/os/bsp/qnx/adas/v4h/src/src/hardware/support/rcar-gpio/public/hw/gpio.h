...
#define GPIO_BOTHEDGE_ONE			0	//one edge
#define GPIO_BOTHEDGE_BOTH			1	//both edge
...
#define IOCTL_GPIO_CONFIG            __DIOTF (_DCMD_GPIO, 13, gpio_cmd_t)
#define IOCTL_GPIO_GET_IRQ_NUM       __DIOTF (_DCMD_GPIO, 14, gpio_cmd_t)
