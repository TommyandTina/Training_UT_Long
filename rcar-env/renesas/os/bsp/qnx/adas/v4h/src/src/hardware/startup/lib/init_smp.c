...
start_aps(void) {
	...
	/* the AP's cannot seem to use the boot services so suspend UEFI based output */
	uefi_io_suspend();
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/init_smp.c $ $Rev: 834524 $")
#endif
