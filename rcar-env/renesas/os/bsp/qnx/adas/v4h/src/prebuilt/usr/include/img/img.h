...
#define IMG_SETUP_READONLY		0x00000010	/* img_t structure cannot be modified */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/imaging/branches/7.1.0/trunk/lib/img/lib/public/img/img.h $ $Rev: 844835 $")
#endif
