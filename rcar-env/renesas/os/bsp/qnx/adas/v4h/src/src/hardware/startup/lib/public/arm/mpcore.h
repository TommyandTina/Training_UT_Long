 ...
 *
 * Register offsets from MPCORE_SCU_BASE
 * -----------------------------------------------------------------------
 */
#define GTIM_COUNTERL	0x200
#define GTIM_COUNTERH	0x204
#define GTIM_CONTROL	0x208
#define GTIM_STATUS		0x20c
#define GTIM_COMPAREL	0x210
#define GTIM_COMPAREH	0x214
#define GTIM_AUTOINC	0x218
...
#define	MPCORE_A7_GIC_CPU_BASE		0x2000
#define	MPCORE_A7_GIC_CPU_SIZE		0x2000
...
/* __SRCVERSION("mpcore.h $Rev: 870901 $"); */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/mpcore.h $ $Rev: 870901 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/mpcore.h $ $Rev: 870901 $" )
#endif
#endif
