...
* 			on error
*/ 
unsigned hwibus_add_spi(unsigned parent_hwi_off, hwiattr_spi_t *attr)
{	
	unsigned hwi_off = hwibus_add(HWI_ITEM_BUS_SPI, parent_hwi_off);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/hwibus_add_spi.c $ $Rev: 680332 $")
#endif
