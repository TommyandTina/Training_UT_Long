...
#define XZYNQ_IRQ_SDIO0                56
#define XZYNQ_IRQ_UART0                59
#define XZYNQ_IRQ_CAN0                 60
#define XZYNQ_IRQ_AXI_GPIO             66
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/xzynq_irq.h $ $Rev: 953487 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/xzynq_irq.h $ $Rev: 953487 $" )
#endif
#endif
