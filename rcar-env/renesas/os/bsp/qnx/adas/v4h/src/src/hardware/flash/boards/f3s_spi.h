...
#define FLASH_WEL       (1 << 1)    // Write enable
...
/* Macronix */
_int32 mx25_ident(f3s_dbase_t * dbase, f3s_access_t * access,
            _uint32 flags, _uint32 offset);
...
_int32 mx25_write(f3s_dbase_t * dbase, f3s_access_t * access,
            _uint32 flags, _uint32 offset,
            _int32 size, _uint8 * buffer);

int mx25_suspend(f3s_dbase_t *dbase, f3s_access_t *access,
                     uint32_t flags, uint32_t offset);

int mx25_resume(f3s_dbase_t *dbase, f3s_access_t *access,
                     uint32_t flags, uint32_t offset);

int mx25_erase(f3s_dbase_t * dbase, f3s_access_t * access,
            _uint32 flags, _uint32 offset);

int32_t mx25_sync(f3s_dbase_t *dbase, f3s_access_t *access,
                    uint32_t flags, uint32_t offset);

int mx25_islock(f3s_dbase_t *dbase, f3s_access_t *access,
                   uint32_t flags, uint32_t offset);
...
/* Micron */
_int32 mt25q_ident(f3s_dbase_t * dbase, f3s_access_t * access,
            _uint32 flags, _uint32 offset);
...
_int32 mt25q_write(f3s_dbase_t * dbase, f3s_access_t * access,
            _uint32 flags, _uint32 offset,
            _int32 size, _uint8 * buffer);

int mt25q_suspend(f3s_dbase_t *dbase, f3s_access_t *access,
                     uint32_t flags, uint32_t offset);

int mt25q_resume(f3s_dbase_t *dbase, f3s_access_t *access,
                     uint32_t flags, uint32_t offset);

int mt25q_erase(f3s_dbase_t * dbase, f3s_access_t * access,
            _uint32 flags, _uint32 offset);

int32_t mt25q_sync(f3s_dbase_t *dbase, f3s_access_t *access,
                    uint32_t flags, uint32_t offset);

int mt25q_islock(f3s_dbase_t *dbase, f3s_access_t *access,
                   uint32_t flags, uint32_t offset);
...
/* W25Q */
int32_t w25q_ident(f3s_dbase_t * dbase, f3s_access_t * access,
                      _uint32 flags, _uint32 offset);
...
int32_t w25q_write(f3s_dbase_t * dbase, f3s_access_t * access,
                      _uint32 flags, _uint32 offset,
                      _int32 size, _uint8 * buffer);

int w25q_suspend(f3s_dbase_t *dbase, f3s_access_t *access,
                    uint32_t flags, uint32_t offset);

int w25q_resume(f3s_dbase_t *dbase, f3s_access_t *access,
                   uint32_t flags, uint32_t offset);

int w25q_erase(f3s_dbase_t * dbase, f3s_access_t * access,
                  _uint32 flags, _uint32 offset);

int32_t w25q_sync(f3s_dbase_t *dbase, f3s_access_t *access,
                     uint32_t flags, uint32_t offset);

int w25q_islock(f3s_dbase_t *dbase, f3s_access_t *access,
                   uint32_t flags, uint32_t offset);
...
int qspi_nor_page_program(void *hdl, uint8_t cmd, int csize, uint32_t addr, int alen, int asize, uint8_t *buf, int len, int dsize);
...
int qspi_nor_write_any_registers(void *hdl, uint32_t reg, uint8_t data);
...
#define SPI_MODE_QPI        (1 << 1)    // QPI mode
    uint32_t    param_sect_addr;
    uint32_t    param_sect_size;
    uint32_t    param_sect_num;
    int         (*dinit)(void *hdl);
    int         (*spi_read_flash)(void *hdl, uint8_t cmd, int csize, uint32_t addr, int alen, int asize, void *data, int dsize, int dlen, int dummy);
    int         (*spi_write_flash)(void *hdl, uint8_t cmd, int csize, uint32_t addr, int alen, int asize, void *data, int dsize, int dlen);
    //int         (*spi_quad_read)(void *hdl, uint8_t cmd, int csize, uint32_t addr, int alen, int asize, void *data,int dsize, int dlen, int dummy);
    //int         (*spi_quad_write)(void *hdl, uint8_t cmd, uint32_t addr , int alen, void *data, int dlen);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/flash/boards/rcar_qspi/f3s_spi.h $ $Rev: 882162 $")
#endif
