 ...
 * -------------------------------------------------------------------------
 */
#define MPSOC_SDRAM_BANK1_BASE        0
#define MPSOC_SDRAM_BANK2_BASE        GIG(32)
#define MPSOC_SDRAM_BANK1_SIZE        GIG(2)
#define MPSOC_SDRAM_BANK2_SIZE        GIG(32)
...
#define XZYNQ_CRL_APB_SIZE          0x28C
#define XZYNQ_RESET_CTRL_OFFSET     0x218
#define XZYNQ_RST_LPD_IOU2_OFFSET   0x238
  #define XZYNQ_RST_LPD_IOU2_QSPI   (1 << 0)
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/mpsoc.h $ $Rev: 922478 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/mpsoc.h $ $Rev: 922478 $" )
#endif
#endif
