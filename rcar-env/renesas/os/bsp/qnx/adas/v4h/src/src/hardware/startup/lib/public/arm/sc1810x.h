...
/* Definitions for the LPCM (Low Power Module Control) */

/* LPCM Module base relative to CRG base */
#define LPCM_ZERO_BASE                          0x08000

/* LPCM sub-modules base relative to LCPM_BASE */
#define LPCM_ZERO_CBASE                         0x000
#define LPCM_ZERO_QBASE                         0x200
#define LPCM_ZERO_RBASE                         0x400

#define LPCM_BASE(x)                            ( LPCM_ZERO_BASE + (x * 0x1000) )
#define LPCM_CBASE(x)                           ( LPCM_BASE(x) + LPCM_ZERO_CBASE )
#define LPCM_QBASE(x)                           ( LPCM_BASE(x) + LPCM_ZERO_QBASE )
#define LPCM_RBASE(x)                           ( LPCM_BASE(x) + LPCM_ZERO_RBASE )

/* Relative reset base addresses */
#define LPCM_RBASE_UMC0                         LPCM_RBASE(0)
#define LPCM_RBASE_UMC1                         LPCM_RBASE(1)
#define LPCM_RBASE_DISP1                        LPCM_RBASE(2)
#define LPCM_RBASE_SEERIS                       LPCM_RBASE(3)
#define LPCM_RBASE_GPU                          LPCM_RBASE(4)
#define LPCM_RBASE_DEC0                         LPCM_RBASE(5)
#define LPCM_RBASE_ENC0                         LPCM_RBASE(6)
#define LPCM_RBASE_VPU                          LPCM_RBASE(7)
#define LPCM_RBASE_ETH                          LPCM_RBASE(8)
#define LPCM_RBASE_HS_SPI0                      LPCM_RBASE(10)
#define LPCM_RBASE_HDMAC1                       LPCM_RBASE(11)
#define LPCM_RBASE_WDTA                         LPCM_RBASE(13)
#define LPCM_RBASE_DCC                          LPCM_RBASE(14)
#define LPCM_RBASE_CA9                          LPCM_RBASE(16)

#define LPCM_RESET_DEASSERT                     0x1
 ...
 * -------------------------------------------------------------------------
 */
#define SC1810X_ENET_BASE                      0x04800000
#define SC1810X_ENET_SIZE                      0x1500
#define SC1810X_ENET_IRQ                       97
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/public/arm/sc1810x.h $ $Rev: 858743 $")
#endif
