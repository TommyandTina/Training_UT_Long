...
VALUE(QT_TIMER_LOAD_HI,		offsetof(struct qtime_entry, timer_load_hi));
#endif
...
VALUE(INTR_CONFIG_FLAG_SYS,		INTR_CONFIG_FLAG_SYS);
#endif
...
/* __SRCVERSION("asmoff.h $Rev: 864619 $"); */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.x_dev/trunk/hardware/startup/lib/asmoff.h $ $Rev: 864619 $")
#endif
