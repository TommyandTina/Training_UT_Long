...
static int rcar_gen4 = 0;


#define SYSC_PDR_CA57_SCU    (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_CA57_SCU)
#define SYSC_PDR_CA53_SCU    (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_CA53_SCU)
#define SYSC_PDR_CR7         (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_CR7)
#define SYSC_PDR_A3IR        (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3IR: SYSC_PDR_GEN3_A3IR)
#define SYSC_PDR_A2IR0       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2IR0)
#define SYSC_PDR_A2IR1       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2IR1)
#define SYSC_PDR_A2IR2       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2IR2)
#define SYSC_PDR_A2IR3       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2IR3)
#define SYSC_PDR_A2IR4       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2IR4)
#define SYSC_PDR_A2IR5       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2IR5)
#define SYSC_PDR_A2SC0       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2SC0)
#define SYSC_PDR_A2SC1       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2SC1)
#define SYSC_PDR_A2SC2       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2SC2)
#define SYSC_PDR_A2SC3       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2SC3)
#define SYSC_PDR_A2SC4       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2SC4)
#define SYSC_PDR_A2DP0       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2DP0 : SYSC_PDR_GEN3_A2DP0)
#define SYSC_PDR_A2DP1       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2DP1 : SYSC_PDR_GEN3_A2DP1)
#define SYSC_PDR_A2DP        (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2DP)
#define SYSC_PDR_A2CN        (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2CN0)
#define SYSC_PDR_A3VIP0      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3VIP0 : SYSC_PDR_GEN3_A3VIP0)
#define SYSC_PDR_A3VIP1      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3VIP1 : SYSC_PDR_GEN3_A3VIP1)
#define SYSC_PDR_A3VIP2      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3VIP2 : SYSC_PDR_GEN3_A3VIP2)
#define SYSC_PDR_A3VP        (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A3VP)
#define SYSC_PDR_A3VC        (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A3VC)
#define SYSC_PDR_A2VC0       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2VC0)
#define SYSC_PDR_A2VC1       (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_A2VC1)
#define SYSC_PDR_3DGA        (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_3DGA : SYSC_PDR_GEN3_3DGA)
#define SYSC_PDR_3DGB        (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_3DGB : SYSC_PDR_GEN3_3DGB)
#define SYSC_PDR_3DGC        (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_3DGC)
#define SYSC_PDR_3DGD        (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_3DGD)
#define SYSC_PDR_3DGE        (rcar_gen4 == 1 ?  -1 : SYSC_PDR_GEN3_3DGE)
#define SYSC_PDR_A1E0D0C0    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E0D0C0 : -1)
#define SYSC_PDR_A1E0D0C1    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E0D0C1 : -1)
#define SYSC_PDR_A1E0D1C0    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E0D1C0 : -1)
#define SYSC_PDR_A1E0D1C1    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E0D1C1 : -1)
#define SYSC_PDR_A1E1D0C0    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E1D0C0 : -1)
#define SYSC_PDR_A1E1D0C1    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E1D0C1 : -1)
#define SYSC_PDR_A1E1D1C0    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E1D1C0 : -1)
#define SYSC_PDR_A1E1D1C1    (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1E1D1C1 : -1)
#define SYSC_PDR_A2E0D0      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2E0D0 : -1)
#define SYSC_PDR_A2E0D1      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2E0D1 : -1)
#define SYSC_PDR_A2E1D0      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2E1D0 : -1)
#define SYSC_PDR_A2E1D1      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2E1D1  : -1)
#define SYSC_PDR_A3E0        (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3E0  : -1)
#define SYSC_PDR_A3E1        (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3E1  : -1)
#define SYSC_PDR_A1CNN2      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1CNN2  : -1)
#define SYSC_PDR_A1DSP0      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1DSP0  : -1)
#define SYSC_PDR_A2IMP0      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2IMP0  : -1)
#define SYSC_PDR_A2CV0       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV0  : -1)
#define SYSC_PDR_A2CV1       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV1  : -1)
#define SYSC_PDR_A2CV4       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV4  : -1)
#define SYSC_PDR_A2CV6       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV6  : -1)
#define SYSC_PDR_A2CN2       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CN2  : -1)
#define SYSC_PDR_A1CNN0      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1CNN0  : -1)
#define SYSC_PDR_A2CN0       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CN0  : -1)
#define SYSC_PDR_A1CNN1      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1CNN1  : -1)
#define SYSC_PDR_A1DSP1      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1DSP1  : -1)
#define SYSC_PDR_A2IMP2      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2IMP2  : -1)
#define SYSC_PDR_A2CV2       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV2  : -1)
#define SYSC_PDR_A2CV3       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV3  : -1)
#define SYSC_PDR_A2CV5       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV5  : -1)
#define SYSC_PDR_A2CV7       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CV7  : -1)
#define SYSC_PDR_A2CN1       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A2CN1  : -1)
#define SYSC_PDR_A1DSP2      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1DSP2  : -1)
#define SYSC_PDR_A1DSP3      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A1DSP3  : -1)
#define SYSC_PDR_A3VIP3      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3VIP3  : -1)
#define SYSC_PDR_A3ISP0      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3ISP0  : -1)
#define SYSC_PDR_A3ISP1      (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3ISP1  : -1)
#define SYSC_PDR_A3DUL       (rcar_gen4 == 1 ?  SYSC_PDR_GEN4_A3DUL  : -1)
...
void usage()
{
    ...
    if (!rcar_gen4) {
    printf(" or sysc_ctrl pdr=<pdr_numbber> -e -d                         \n");
    }
    printf("                                                              \n");
    ...
    printf("        a1dsp2    for    A1DSP2                               \n");
    printf("        a1dsp3    for    A1DSP3                               \n");
    printf("        a3vip0    for    A3VIP0                               \n");
    printf("        a3vip1    for    A3VIP1                               \n");
    printf("        a3vip2    for    A3VIP2                               \n");
    printf("        a3vip3    for    A3VIP3                               \n");
    printf("        a3isp01   for    A3ISP01                              \n");
    printf("     or a3isp0    for    A3ISP0                               \n");
    printf("        a3isp23   for    A3ISP23                              \n");
    printf("     or a3isp1    for    A3ISP1                               \n");
    printf("        a3dul     for    A3DUL                                \n");

    printf("  <pdr_number> : Power Domain Register Index (from 0 to 63)   \n");
    }
...
#define CS_MACHINE_LEN (32 + 1)
    ...
    while (i < argc) {
        ...
        if (strstr(opt,"dom=")) {
            ...
            } else if  (strstr(opt + 4, "a2psc")) {
                dom_id = SYSC_PDR_A2DP0;
                strcpy(dom_name, "A2PSC");
            } else if  (strstr(opt + 4, "a2dp0")) {
                dom_id = SYSC_PDR_A2DP0;
                strcpy(dom_name, "A2DP0");
            ...
            } else if  (strstr(opt + 4, "a1dsp2")) {
                dom_id = SYSC_PDR_A1DSP2;
                strcpy(dom_name, "A1DSP2");
            } else if  (strstr(opt + 4, "a1dsp3")) {
                dom_id = SYSC_PDR_A1DSP3;
                strcpy(dom_name, "A1DSP3");
            } else if  (strstr(opt + 4, "a3vip0")) {
                dom_id = SYSC_PDR_A3VIP0;
                strcpy(dom_name, "A3VIP0");
            } else if  (strstr(opt + 4, "a3vip1")) {
            ...
            } else if  (strstr(opt + 4, "a3isp0")) {
                dom_id = SYSC_PDR_A3ISP0;
                strcpy(dom_name, "A3ISP0");
            } else if  (strstr(opt + 4, "a3isp1")) {
                dom_id = SYSC_PDR_A3ISP1;
                strcpy(dom_name, "A3ISP1");
            ...
            } else if  (strstr(opt + 4, "a3dul")) {
                dom_id = SYSC_PDR_A3DUL;
                strcpy(dom_name, "A3DUL");
            }
        } else if (strstr(opt,"pdr=")) {
            dom_id = strtoul(opt + 4, NULL, 0);
            if (!rcar_gen4 || (dom_id < 0 || dom_id > 63)) {
                usage();
                return -1;
            }
            sprintf(dom_name, "PDR%d", dom_id);
    ...
    if (sysc_mgr_getfuncs(&syschwfuncs, (int)sizeof(sysc_mgr_funcs_t))){
        printf("sysc_mgr_getfuncs failed \n");
        return -1;
    }

    /* Open an instant and clock SYSC init */
    if (syschwfuncs.init()) {
