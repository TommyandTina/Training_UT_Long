...
ipl_uart_boot_t v4h_uart_boot [] = {
     /*  SCIF0 @115200   */ [UART_USE_SCIF0]  = { 0xE6E60000,  115200,  66666666, 0 },
     /*  HSCIF0 @921600  */ [UART_USE_HSCIF0] = { 0xE6540000,  921600, 266666666, 0 },
};

void init_board(int uart_boot_idx)
{
    ipl_uart_boot_t *uart_boot_cfg = &v4h_uart_boot[uart_boot_idx];
    ...
    soc_config(&v4h_uart_config[uart_boot_idx], 1);
	soc_config(v4h_config, 0);
