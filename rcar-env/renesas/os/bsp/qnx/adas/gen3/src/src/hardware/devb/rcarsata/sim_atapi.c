...
/******************************************************************************/
static int atapi_error(EIDE_TARGET *tgt, int scsi_status, int cam_status)
{
...
/******************************************************************************/
static void atapi_ccb_init(EIDE_TARGET *tgt, CCB_SCSIIO *ccb, void (*cbfcnp)(),
...
/******************************************************************************/
static void atapi_spindle_cbf(CCB_SCSIIO *ccb)
{
    EIDE_TARGET     *tgt;
    CCB_DEVCTL      *dccb;
    eide_apm_t      *apm;
...
/******************************************************************************/
static int atapi_spindle(EIDE_TARGET *tgt, CCB_SCSIIO *ccb, int loej, int start)
{
    SIM_HBA         *hba = tgt->hba;
    uint8_t         *cdb;
...
/******************************************************************************/
static void atapi_internal_cbf(CCB_SCSIIO *ccb)
{
    EIDE_TARGET     *tgt;
...
/******************************************************************************/
static void atapi_setup_rsense(EIDE_TARGET *tgt)
{
    SIM_HBA         *hba = tgt->hba;
    CCB_SCSIIO      *ccb;
    CCB_HEADER      *cam_ch;
...
/******************************************************************************/
static int atapi_io_cbf(EIDE_TARGET *tgt, uint8_t timeo)
{
    CCB_SCSIIO      *ccb = tgt->nexus;
    CCB_SCSIIO      *ccbl;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/rcarsata/sim_atapi.c $ $Rev: 896546 $")
#endif
