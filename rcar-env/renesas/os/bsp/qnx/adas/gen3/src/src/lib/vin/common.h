...
enum input_support {
    /* For connectors */
    INPUT_FROM_CAMERA = 0x00000001,
    INPUT_FROM_HDMI   = 0x00000002,
    INPUT_FROM_CVBS   = 0x00000004,
    /* For modules is connected to VIN */
    CAPTURE_VIA_CSI   = 0x00000008,
    CAPTURE_VIA_ISP   = 0x00000010,
};
