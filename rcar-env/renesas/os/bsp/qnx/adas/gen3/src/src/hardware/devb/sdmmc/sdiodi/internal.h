...
#define	HC_CAP_HS400ES				(1LL << 34)	// hs400 enhanced strobe
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/sdmmc/sdiodi/internal.h $ $Rev: 896546 $")
#endif
