...
typedef struct cam_devinfo {
    _Uint32t    num_sctrs;      /* Size of disk in sectors         */
    _Uint32t    cylinders;      /* Number of tracks                */
    _Uint32t    heads;          /* Number of heads                 */
    _Uint32t    tracks;         /* Sectors per track               */
    _Uint32t    sctr_size;      /* Bytes per sector                */
    _Uint32t    flags;          /* Device flags                    */
    _Uint32t    media_changes;  /* Number of media changes         */
    _Uint32t    type;           /* Device type                     */
    _Uint64t    num_sctrs64;
    _Uint32t    path_id;        /* Path */
    _Uint32t    target_id;      /* Target */
    _Uint64t    lun_id;         /* Lun */
...
#define DEV_DPOFUA              0x200000     /* Disable Page Out and Force Unit Access Support */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/cam/public/sys/cam_device.h $ $Rev: 861395 $")
#endif
