...
static struct pll_offset_table  v3u_pll_offset_table[] = {
    ...
    PLL_OFF(20, 1, RCAR_V3U_CPG_PLL20CR, CPG_PLL_ALWAYS_ON),
    PLL_OFF(21, 2, RCAR_V3U_CPG_PLL21CR, CPG_PLL_ALWAYS_ON),
    PLL_OFF(30, 3, RCAR_V3U_CPG_PLL30CR, CPG_PLL_ALWAYS_ON),
    PLL_OFF(31, 4, RCAR_V3U_CPG_PLL31CR, CPG_PLL_ALWAYS_ON),
    PLL_OFF(4,  5, RCAR_V3U_CPG_PLL4CR,  CPG_PLL_ALWAYS_ON),
...
static int cpg_pll_clock_rate_get(const int pll_id, uint32_t *pllvco)
{
    ...
    if ( (cpg_read(cpg_dev.ecr_off) & BIT((8 + offset->bit_idx))) == 0) {
...
static int cpg_cpu_clock_rate_get(const int idx, uint32_t* const rate)
{
    ...
    if (cpg_dev.soc_id == PRODUCT_ID_RCAR_V3M) {
        ...
        if ( ((cpg_dev.soc_id == PRODUCT_ID_RCAR_H3)  ||
            ...
            const uint32_t frqcrc = cpg_read(RCAR_V3U_CPG_FRQCRC);
            const uint32_t pll20cr = cpg_read(RCAR_V3U_CPG_PLL20CR);
...
static uint32_t cpg_sd_clock_get_ctlr_offset(const uint32_t soc_id, const int idx)
{
    switch (soc_id) {
        case PRODUCT_ID_RCAR_V3U:
            switch (idx) {
                case 0:  return RCAR_V3U_CPG_SD0CKCR;
...
static int cpg_sd_clock_rate_get(const int idx, uint32_t* const rate)
{
    ...
    if ( (cpg_dev.soc_id == PRODUCT_ID_RCAR_V3H) && (cpg_dev.soc_rev == PRODUCT_V3H_REV_2_0 || cpg_dev.soc_rev == PRODUCT_V3H_REV_2_1) ) {
...
/* This table is calculated with PLL1VCO=3200MHz */
static const struct rpc_div_table cpg_rpc_div_table[] = {
    /*      parent                val   div   rate(MHz) of RPCD2φ */
    RPC_DIV(GEN3_CPG_PLL1VCO_CLK, 0x01,  16,   200),     /* For V3U only */
    RPC_DIV(GEN3_CPG_PLL1VCO_CLK, 0x03,  32,   100),     /* For V3U only */
    RPC_DIV(GEN3_CPG_PLL1VCO_CLK, 0x07,  64,    50),     /* For V3U only */
...
static uint32_t cpg_clock_get_post_reg_offset(const uint32_t soc_id, const int idx)
{
    if (soc_id == PRODUCT_ID_RCAR_V3U) {
        switch (idx) {
            case 0: return RCAR_V3U_CPG_POSTCKCR;
            case 2: return RCAR_V3U_CPG_POST2CKCR;
            case 3: return RCAR_V3U_CPG_POST3CKCR;
            case 4: return RCAR_V3U_CPG_POST4CKCR;
            default : return CPG_REG_OFF_UNKNOWN;
        }
...
static uint32_t cpg_clock_get_offset(const uint32_t soc_id, const cpg_clk_id_t id, const int idx)
{
    if (soc_id == PRODUCT_ID_RCAR_V3U) {
        switch (id) {
            case CPG_CLK_CANFD: return RCAR_V3U_CPG_CANFDCKCR;
            case CPG_CLK_MSIOF: return RCAR_V3U_CPG_MSOCKCR;
            case CPG_CLK_CSI2:  return RCAR_V3U_CPG_CSI0CKCR;
            case CPG_CLK_DSI:   return RCAR_V3U_CPG_DSICKCR;
            case CPG_CLK_IPC:   return RCAR_V3U_CPG_IPCCKCR;
            case CPG_CLK_FRAY:  return RCAR_V3U_CPG_FRAYCKCR;
            case CPG_CLK_RPC:   return RCAR_V3U_CPG_RPCCKCR;
