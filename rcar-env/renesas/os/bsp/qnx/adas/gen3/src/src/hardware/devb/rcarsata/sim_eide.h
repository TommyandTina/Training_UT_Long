...
extern SIM_HBA *eide_alloc_hba(void);
...
extern ssize_t __attribute__((__format__(__printf__, 5, 6))) eide_slogf(EIDE_TARGET *tgt, int opcode, int severity, int verbosity, const char *fmt, ...);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/rcarsata/sim_eide.h $ $Rev: 896546 $")
#endif
