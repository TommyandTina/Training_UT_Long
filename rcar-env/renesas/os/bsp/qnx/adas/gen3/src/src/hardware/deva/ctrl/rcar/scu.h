...
#define SCU_SRC_CHANNEL_NUM     10
#define SCU_CMD_CHANNEL_NUM     2

#define SCU_DVC_MAX_VOLUME scu_dvc_get_max_vol()
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/deva/ctrl/rcar/scu.h $ $Rev: 895184 $")
#endif
