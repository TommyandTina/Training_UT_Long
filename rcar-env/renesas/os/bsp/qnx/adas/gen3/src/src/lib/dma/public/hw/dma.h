...
typedef enum {
	...
	DMA_MODE_FLAG_INFI_REPEAT =    0x00000002,	/* Use burst mode */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/dma/public/hw/dma.h $ $Rev: 893668 $")
#endif
