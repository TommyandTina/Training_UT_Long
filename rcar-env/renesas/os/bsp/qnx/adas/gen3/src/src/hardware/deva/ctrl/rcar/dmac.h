...
typedef enum
{
    ...
    AUDIO_PERIPHERAL_SSI_BUSIF_1_4,
    AUDIO_PERIPHERAL_SSI_BUSIF_1_5,
    AUDIO_PERIPHERAL_SSI_BUSIF_1_6,
    AUDIO_PERIPHERAL_SSI_BUSIF_1_7,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_0,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_1,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_2,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_3,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_4,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_5,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_6,
    AUDIO_PERIPHERAL_SSI_BUSIF_2_7,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_0,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_1,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_2,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_3,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_4,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_5,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_6,
    AUDIO_PERIPHERAL_SSI_BUSIF_3_7,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_0,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_1,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_2,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_3,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_4,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_5,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_6,
    AUDIO_PERIPHERAL_SSI_BUSIF_4_7,
    ...
    AUDIO_PERIPHERAL_SSI_BUSIF_9_4,
    AUDIO_PERIPHERAL_SSI_BUSIF_9_5,
    AUDIO_PERIPHERAL_SSI_BUSIF_9_6,
    AUDIO_PERIPHERAL_SSI_BUSIF_9_7,
...
#define AUDIO_PERIPHERAL_SSI_BUSIF(idx,sub_idx) (idx < 5 ? AUDIO_PERIPHERAL_SSI_BUSIF_0_0 + idx * AUDIO_PERIPHERAL_SSI_SUBCHAN_NUM + sub_idx : \
                                                 idx < 9 ? AUDIO_PERIPHERAL_SSI_BUSIF_5 + idx - 5 : \
...
int audio_dmac_alloc_buf(void *audiodma_chn, dma_addr_t *addr, unsigned size, unsigned flags);
int audio_dmac_free_buf(void *audiodma_chn, dma_addr_t *addr);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/deva/ctrl/rcar/dmac.h $ $Rev: 879897 $")
#endif
