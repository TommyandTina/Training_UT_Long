...
#define SSI_MODE2_SSI9PIN_SSIO9_39_INDEPENDENT  0
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/deva/ctrl/rcar/ssiu_reg.h $ $Rev: 911285 $")
#endif
