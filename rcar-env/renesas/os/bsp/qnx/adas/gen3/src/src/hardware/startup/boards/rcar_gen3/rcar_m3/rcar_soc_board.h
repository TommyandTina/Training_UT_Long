...
rcar_config m3w_config[] = {
    ...
    [DEV_SDHI] = {
        ...
        .settings = (rcar_pin[])
        {
            ...
            { .reg = TDSELCTRL(0), .bits = BITS(0,1),     .val = TDSEL(TDSEL_40PF, 0)}, /* Set SD0 TDSEL to 40 pF */
            { .reg = TDSELCTRL(0), .bits = BITS(6,7),     .val = TDSEL(TDSEL_40PF, 6)}, /* Set SD3 TDSEL to 40 pF */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_6_8, 20) }, /* SD0_CLK */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_6_8, 16) }, /* SD0_CMD */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_6_8, 12) }, /* SD0_DAT0 */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_6_8, 8)  }, /* SD0_DAT1 */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_6_8, 4)  }, /* SD0_DAT2 */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_6_8, 0)  }, /* SD0_DAT3 */
            { .reg = DRVCTRL(17),  .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_6_8, 28) }, /* SD0_CD */
            { .reg = DRVCTRL(17),  .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_6_8, 24) }, /* SD0_WP */
            { .reg = DRVCTRL(15),  .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_6_8, 8)  }, /* SD3_CLK */
            { .reg = DRVCTRL(15),  .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_6_8, 4)  }, /* SD3_CMD */
            { .reg = DRVCTRL(15),  .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_6_8, 0)  }, /* SD3_DAT0 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_6_8, 28) }, /* SD3_DAT1 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_6_8, 24) }, /* SD3_DAT2 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_6_8, 20) }, /* SD3_DAT3 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_6_8, 8)  }, /* SD3_CD */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_6_8, 4)  }, /* SD3_WP */
            { 0 }
        },
    },
    [DEV_MMCIF] = {
        ...
        .settings = (rcar_pin[])
        {
            ...
            { .reg = TDSELCTRL(0), .bits = BITS(2,5), .val = TDSEL(TDSEL_40PF, 2)|TDSEL(TDSEL_40PF, 4) }, /* Set SD1, SD2 TDSEL to 30 pF */
            { 0 }
        }
    },
    [DEV_DMAC] = {
...
rcar_config m3n_config[] = {
    ...
    [DEV_SDHI] = {
        ...
        .settings = (rcar_pin[])
        {
            ...
            { .reg = TDSELCTRL(0), .bits = BITS(0,1),     .val = TDSEL(TDSEL_40PF, 0)}, /* Set SD0 TDSEL to 40 pF */
            { .reg = TDSELCTRL(0), .bits = BITS(6,7),     .val = TDSEL(TDSEL_40PF, 6)}, /* Set SD3 TDSEL to 40 pF */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_FULL, 20) }, /* SD0_CLK */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_FULL, 16) }, /* SD0_CMD */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_FULL, 12) }, /* SD0_DAT0 */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_FULL, 8)  }, /* SD0_DAT1 */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_FULL, 4)  }, /* SD0_DAT2 */
            { .reg = DRVCTRL(13),  .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_FULL, 0)  }, /* SD0_DAT3 */
            { .reg = DRVCTRL(17),  .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_FULL, 28) }, /* SD0_CD */
            { .reg = DRVCTRL(17),  .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_FULL, 24) }, /* SD0_WP */
            { .reg = DRVCTRL(15),  .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_FULL, 8)  }, /* SD3_CLK */
            { .reg = DRVCTRL(15),  .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_FULL, 4)  }, /* SD3_CMD */
            { .reg = DRVCTRL(15),  .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_FULL, 0)  }, /* SD3_DAT0 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_FULL, 28) }, /* SD3_DAT1 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_FULL, 24) }, /* SD3_DAT2 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_FULL, 20) }, /* SD3_DAT3 */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_FULL, 8)  }, /* SD3_CD */
            { .reg = DRVCTRL(16),  .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_FULL, 4)  }, /* SD3_WP */
    ...
    [DEV_DISPLAY] = {
        ...
        .mod = (rcar_module[])
        {
            ...
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(22) }, /* VSPD1 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(19) }, /* FCPCS */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(15) }, /* FCPC0 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(11) }, /* FCPVI0 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(7)  },  /* FCPVB0 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(3)  },  /* FCPVD0 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(2)  },  /* FCPVD1 */
