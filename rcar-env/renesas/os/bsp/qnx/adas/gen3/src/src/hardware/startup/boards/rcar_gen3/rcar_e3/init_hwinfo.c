...
void init_hwinfo()
{
...

    {
        ...
        sd_info_t sd[] = {
            {.pwr_base=RCAR_GEN3_GPIO5_BASE, .pwr_size=RCAR_GEN3_GPIO_SIZE, .pwr_vdd_offset=RCAR_GEN3_GPIO_OUTDT, .pwr_if_offset=RCAR_GEN3_GPIO_OUTDT,      .pwr_vdd_shift=17, .pwr_if_shift=18, .pfc_base=RCAR_GEN3_PFC_BASE, .pfc_offset=RCAR_GEN3_PFC_POCCTRL0, .pfc_mask=0x3F, .pfc_shift=0},
            {.pwr_base=RCAR_GEN3_GPIO0_BASE, .pwr_size=0x3050,         .pwr_vdd_offset=RCAR_GEN3_GPIO_OUTDT, .pwr_if_offset=0x3000+RCAR_GEN3_GPIO_OUTDT, .pwr_vdd_shift=4,  .pwr_if_shift=15, .pfc_base=RCAR_GEN3_PFC_BASE, .pfc_offset=RCAR_GEN3_PFC_POCCTRL0, .pfc_mask=0x3F, .pfc_shift=6 },
            { 0 },
            { 0 },
        };
...

    {
        ...
        tag->hwversion.name = (_Uint16t)add_string("e3");            
    }
