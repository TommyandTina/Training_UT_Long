...
#define CS2000_I2C_SLAVE_ADDR           0x4F    /* schematic says 0x9F */
...
#define CS2000_FUNC_CFG2                0x17
#define CS2000_FUNC_CFG3                0x18
...
void cs2000_register_dump( void )
{
    ...
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_DEVICE_CONTROL, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_DEVICE_CONTROL 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_DEVICE_CFG1, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_DEVICE_CFG1 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_DEVICE_CFG2, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_DEVICE_CFG2 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_GLOBAL_CFG, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_GLOBAL_CFG 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_RATIO_0_0, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_RATIO_0_0 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_RATIO_0_1, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_RATIO_0_1 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_RATIO_0_2, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_RATIO_0_2 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_RATIO_0_3, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_RATIO_0_3 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_FUNC_CFG1, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_FUNC_CFG1 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_FUNC_CFG2, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_FUNC_CFG2 0x%x", data);
    }
    if(EOK == i2c_read(CS2000_I2C_SLAVE_ADDR, CS2000_FUNC_CFG3, &data)) {
        ado_debug (DB_LVL_DRIVER, "rcar: CS2000_FUNC_CFG3 0x%x", data);
    }
}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/deva/ctrl/rcar/nto/aarch64/dll.le.cs2000/cs2000.c $ $Rev: 895184 $")
#endif
