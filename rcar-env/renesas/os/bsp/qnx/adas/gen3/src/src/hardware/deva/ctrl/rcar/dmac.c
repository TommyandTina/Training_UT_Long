...
uint8_t AUDIO_DMAC_MIDRID[AUDIO_PERIPHERAL_NUM][2] =
{
    ...
    { 0x3F, 0x40 }, // AUDIO_PERIPHERAL_SSI_BUSIF_0_4
    { 0x43, 0x44 }, // AUDIO_PERIPHERAL_SSI_BUSIF_0_5
    { 0x4F, 0x50 }, // AUDIO_PERIPHERAL_SSI_BUSIF_0_6
    { 0x53, 0x54 }, // AUDIO_PERIPHERAL_SSI_BUSIF_0_7
    ...
    { 0x5F, 0x60 }, // AUDIO_PERIPHERAL_SSI_BUSIF_1_4
    { 0xC3, 0xC4 }, // AUDIO_PERIPHERAL_SSI_BUSIF_1_5
    { 0xC7, 0xC8 }, // AUDIO_PERIPHERAL_SSI_BUSIF_1_6
    { 0xCB, 0xCC }, // AUDIO_PERIPHERAL_SSI_BUSIF_1_7
    ...
    { 0xCF, 0xCE }, // AUDIO_PERIPHERAL_SSI_BUSIF_2_4
    { 0xEB, 0xEC }, // AUDIO_PERIPHERAL_SSI_BUSIF_2_5
    { 0xED, 0xEE }, // AUDIO_PERIPHERAL_SSI_BUSIF_2_6
    { 0xEF, 0xF0 }, // AUDIO_PERIPHERAL_SSI_BUSIF_2_7
    { 0x6F, 0x70 }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_0
    { 0x21, 0x22 }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_1
    { 0x23, 0x24 }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_2
    { 0x25, 0x26 }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_3
    { 0x27, 0x28 }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_4
    { 0x29, 0x2A }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_5
    { 0x2B, 0x2C }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_6
    { 0x2D, 0x2E }, // AUDIO_PERIPHERAL_SSI_BUSIF_3_7
    { 0x71, 0x72 }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_0
    { 0x17, 0x18 }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_1
    { 0x19, 0x1A }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_2
    { 0x1B, 0x1C }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_3
    { 0x1D, 0x1E }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_4
    { 0x1F, 0x20 }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_5
    { 0x31, 0x32 }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_6
    { 0x33, 0x34 }, // AUDIO_PERIPHERAL_SSI_BUSIF_4_7
    ...
    { 0xA3, 0xA4 }, // AUDIO_PERIPHERAL_SSI_BUSIF_9_4
    { 0xA5, 0xA6 }, // AUDIO_PERIPHERAL_SSI_BUSIF_9_5
    { 0xA7, 0xA8 }, // AUDIO_PERIPHERAL_SSI_BUSIF_9_6
    { 0xA9, 0xAA }, // AUDIO_PERIPHERAL_SSI_BUSIF_9_7
...
#define AUDIO_DMAC_ADDR_SSI_SIZE (AUDIO_PERIPHERAL_SSI_NUM << 6)
...
#define AUDIO_DMAC_ADDR_SSI_BUSIF(idx, sub_idx) ( sub_idx < 4 ? \
                                                  AUDIO_DMAC_ADDR_SSI_BUSIF_BASE + (idx<<12) + (sub_idx<<10) : \
                                                  ( idx < 5 ? \
                                                    AUDIO_DMAC_ADDR_SSI_BUSIF_BASE + 0xA000 + (idx<<12) + ((sub_idx-4)<<10) : \
                                                    AUDIO_DMAC_ADDR_SSI_BUSIF_BASE + 0xF000 + ((sub_idx-4)<<10) ) )

#define AUDIO_DMAC_ADDR_SCUSRC_RX_BASE 0xEC004000 /* SCUSRCOx registers */
#define AUDIO_DMAC_ADDR_SCUSRC_RX_SIZE (AUDIO_PERIPHERAL_SCUSRC_NUM << 10)
...
int audio_dmac_mp_get_config(audio_peripheral_t dst, audio_dmac_config_t* dmac_config)
{
    ...
    if( dst >= AUDIO_PERIPHERAL_SSI_BUSIF_0_0 && dst <= AUDIO_PERIPHERAL_SSI_BUSIF_9_7 ) {
        if( dst >= AUDIO_PERIPHERAL_SSI_BUSIF_9_0 ) {
            idx = 9;
            sub_idx = dst - AUDIO_PERIPHERAL_SSI_BUSIF_9_0;
        } else if( dst <= AUDIO_PERIPHERAL_SSI_BUSIF_4_7 ) {
            ...
            idx = 5 + dst - AUDIO_PERIPHERAL_SSI_BUSIF_5;
            sub_idx = 0;
        }
...
int audio_dmac_pm_get_config(audio_peripheral_t src, audio_dmac_config_t* dmac_config)
{
    ...
    if( src >= AUDIO_PERIPHERAL_SSI_BUSIF_0_0 && src <= AUDIO_PERIPHERAL_SSI_BUSIF_9_7 ) {
        if( src >= AUDIO_PERIPHERAL_SSI_BUSIF_9_0 ) {
            idx = 9;
            sub_idx = src - AUDIO_PERIPHERAL_SSI_BUSIF_9_0;
        } else if( src <= AUDIO_PERIPHERAL_SSI_BUSIF_4_7 ) {
            ...
            idx = 5 + src - AUDIO_PERIPHERAL_SSI_BUSIF_5;
            sub_idx = 0;
        }
...
#define AUDIO_DMAC_PP_RS_SSI(idx, sub_idx) ( idx < 3 ? idx * 4 + sub_idx : ( idx < 9 ? 0xC + idx - 3 : 0x12 + sub_idx ) )
...
/* values for source and destination request source as used in the PDMACHCRE register */
#define AUDIO_DMAC_PP_RS_SSI_EXT(idx, sub_idx) ( idx < 3 ? \
                                                 ( sub_idx < 4 ? idx * 4 + sub_idx : 0x39 + idx * 4 + sub_idx - 4 ) : \
                                                 ( idx < 5 ? \
                                                   ( sub_idx == 0 ? 0xC + idx - 3 : 0x45 + (idx - 3) * 7 + sub_idx - 1 ) : \
                                                   ( idx < 9 ? 0xC + idx - 3 : ( sub_idx < 4 ? 0x12 + sub_idx : 0x53 + sub_idx - 4 ) ) ) )

#define AUDIO_DMAC_PP_RS_SCUSRC_EXT(idx) AUDIO_DMAC_PP_RS_SCUSRC(idx)

#define AUDIO_DMAC_PP_RS_CMD_EXT(idx) AUDIO_DMAC_PP_RS_CMD(idx)

#define AUDIO_DMAC_PP_RS_DTCPPP_EXT(idx) AUDIO_DMAC_PP_RS_DTCPPP(idx)

#define AUDIO_DMAC_PP_RS_DTCPCP_EXT(idx) AUDIO_DMAC_PP_RS_DTCPCP(idx)

#define AUDIO_DMAC_PP_RS_MLM_EXT(idx) AUDIO_DMAC_PP_RS_MLM(idx)

/* values for source and destination addresses for PP DMA transfers */
#define AUDIO_DMAC_PP_ADDR_SSI_BASE 0xEC400000
#define AUDIO_DMAC_PP_ADDR_SSI(idx, sub_idx) ( sub_idx < 4 ? \
                                               AUDIO_DMAC_PP_ADDR_SSI_BASE + (idx<<12) + (sub_idx<<10) : \
                                               ( idx < 5 ? \
                                                 AUDIO_DMAC_PP_ADDR_SSI_BASE + 0xA000 + (idx<<12) + ((sub_idx-4)<<10) : \
                                                 AUDIO_DMAC_PP_ADDR_SSI_BASE + 0xF000 + ((sub_idx-4)<<10) ) )
...
int audio_dmac_pp_get_config(audio_peripheral_t src, audio_peripheral_t dst, audio_dmac_pp_config_t* dmac_pp_config)
{
    ...
    if( src_addr == 0 || dst_addr == 0 ) {
        ado_error_fmt( "Failed to compute src and dest addr: src=%x, dst=%x", src_addr, dst_addr );
        return EINVAL;
    }
...
static int audio_dmac_funcs_init()
{
    ...
    switch(rcar_version_get()) {
        ...
        case RCAR_VERSION_D3:
            strlcpy(ver_opt, "ver=d3", sizeof(ver_opt));
            break;
        case RCAR_VERSION_E3:
            strlcpy(ver_opt, "ver=e3", sizeof(ver_opt));
            break;
        case RCAR_VERSION_W2H:
            strlcpy(ver_opt, "ver=w2h", sizeof(ver_opt));
            break;
        default:
            ado_error_fmt( "invalid rcar version" );
            return EINVAL;
    }
    ...
    audiodmafuncs.init(ver_opt);

    /*
     * Audio PP DMAC
     */
    if (get_audioppdmafuncs (&audiodmappfuncs, sizeof (dma_functions_t)) == -1) {
        ado_error_fmt( "failed to get audio DMA pp lib functions" );
        return EPROCUNAVAIL;
    }

    audiodmappfuncs.init(ver_opt);
...
{
    if (ado_smmu_mapping_add (rcar->card, AUDIO_DMAC_ADDR_SSI_BASE, AUDIO_DMAC_ADDR_SSI_SIZE) != EOK) {
        ado_error_fmt ("Failed adding SMMU mapping for addr 0x%x, size %d",
            AUDIO_DMAC_ADDR_SSI_BASE, AUDIO_DMAC_ADDR_SSI_SIZE);
        return (EINVAL);
    }
    ...
    if (rcar->use_scu_summary) {
        if (ado_smmu_mapping_add (rcar->card, AUDIO_DMAC_ADDR_SCUSRC_RX_BASE, AUDIO_DMAC_ADDR_SCUSRC_RX_SIZE) != EOK) {
            ado_error_fmt ("Failed adding SMMU mapping for addr 0x%x, size %d",
                AUDIO_DMAC_ADDR_SCUSRC_RX_BASE, AUDIO_DMAC_ADDR_SCUSRC_RX_SIZE);
            return (EINVAL);
        }

        if (ado_smmu_mapping_add (rcar->card, AUDIO_DMAC_ADDR_SCUSRC_TX_BASE, AUDIO_DMAC_ADDR_SCUSRC_TX_SIZE) != EOK) {
            ado_error_fmt ("Failed adding SMMU mapping for addr 0x%x, size %d",
                AUDIO_DMAC_ADDR_SCUSRC_TX_BASE, AUDIO_DMAC_ADDR_SCUSRC_TX_SIZE);
            return (EINVAL);
        }

        if (ado_smmu_mapping_add (rcar->card, AUDIO_DMAC_ADDR_SCUCMD_BASE, AUDIO_DMAC_ADDR_SCUCMD_SIZE) != EOK) {
            ado_error_fmt ("Failed adding SMMU mapping for addr 0x%x, size %d",
                AUDIO_DMAC_ADDR_SCUCMD_BASE, AUDIO_DMAC_ADDR_SCUCMD_SIZE);
            return (EINVAL);
        }
    }

#ifdef RCAR_DTCP_SUPPORT
    if (rcar->use_dtcp_summary) {
        if (ado_smmu_mapping_add (rcar->card, AUDIO_DMAC_ADDR_DTCPPP_BASE, AUDIO_DMAC_ADDR_DTCPPP_SIZE) != EOK) {
            ado_error_fmt ("Failed adding SMMU mapping for addr 0x%x, size %d",
                AUDIO_DMAC_ADDR_DTCPPP_BASE, AUDIO_DMAC_ADDR_DTCPPP_SIZE);
            return (EINVAL);
        }

        if (ado_smmu_mapping_add (rcar->card, AUDIO_DMAC_ADDR_DTCPCP_BASE, AUDIO_DMAC_ADDR_DTCPCP_SIZE) != EOK) {
            ado_error_fmt ("Failed adding SMMU mapping for addr 0x%x, size %d",
                AUDIO_DMAC_ADDR_DTCPCP_BASE, AUDIO_DMAC_ADDR_DTCPCP_SIZE);
            return (EINVAL);
        }
    }
#endif
...
#ifdef RCAR_MLP_SUPPORT
    if (rcar->use_mlp_summary) {
        if (ado_smmu_mapping_add (rcar->card, AUDIO_DMAC_ADDR_MLM_BASE, AUDIO_DMAC_ADDR_MLM_SIZE) != EOK) {
            ado_error_fmt ("Failed adding SMMU mapping for addr 0x%x, size %d",
                AUDIO_DMAC_ADDR_MLM_BASE, AUDIO_DMAC_ADDR_MLM_SIZE);
            return (EINVAL);
        }
    }
#endif
...
{
    ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_SSI_BASE, AUDIO_DMAC_ADDR_SSI_SIZE);
    ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_SSI_BUSIF_BASE, AUDIO_DMAC_ADDR_SSI_BUSIF_SIZE);
    if (rcar->use_scu_summary) {
        ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_SCUSRC_RX_BASE, AUDIO_DMAC_ADDR_SCUSRC_RX_SIZE);
        ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_SCUSRC_TX_BASE, AUDIO_DMAC_ADDR_SCUSRC_TX_SIZE);
        ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_SCUCMD_BASE, AUDIO_DMAC_ADDR_SCUCMD_SIZE);
    }
#ifdef RCAR_DTCP_SUPPORT
    if (rcar->use_dtcp_summary) {
        ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_DTCPPP_BASE, AUDIO_DMAC_ADDR_DTCPPP_SIZE);
        ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_DTCPCP_BASE, AUDIO_DMAC_ADDR_DTCPCP_SIZE);
    }
#endif
#ifdef RCAR_MLP_SUPPORT
    if (rcar->use_mlp_summary) {
        ado_smmu_mapping_remove (rcar->card, AUDIO_DMAC_ADDR_MLM_BASE, AUDIO_DMAC_ADDR_MLM_SIZE);
    }
#endif
    return EOK;
}
...
int audio_dmac_init(HW_CONTEXT_T* rcar)
{
     ...
     */
    strlcpy ( attach_opt, "dma=audio,desc=2,cae_intr=1,", sizeof(attach_opt) );
    if ( rcar->debug ) {
...
#ifdef HAVE_SMMU_H
            audio_chan->dma_context.audiodma_chn =
                audiodmafuncs.channel_attach_smmu ( attach_opt, NULL, NULL, 0,
...
#endif
            if ( !audio_chan->dma_context.audiodma_chn ) {
                ado_error_fmt ( "unable to attach to audio DMA channel" );
                ret = EAGAIN;
                goto dmac_init_fail;
            }

            audiodmafuncs.query_channel ( audio_chan->dma_context.audiodma_chn, &chinfo );
            audio_chan->dma_context.audiodma_irq = chinfo.irq;
        }
    }
     ...
     * Audio PP DMAC
     */
    strlcpy(attach_opt, ver_opt, sizeof(attach_opt));
    if( rcar->debug ) {
        strlcat(attach_opt, ",debug=1", sizeof(attach_opt));
    }

    /* Audio DMA PP channel */
    for ( uint32_t i = 0; i < RCAR_MAX_DEVICES; i++ ) {
        for ( uint32_t chan = ADO_PCM_CHANNEL_PLAYBACK; chan < ADO_PCM_CHANNEL_MAX; chan++ ) {
            audio_chan = &rcar->devices[i].audio_channels[chan];
            if ( audio_chan->ssi_chan == SSI_CHANNEL_NUM ) {
            ...
            audio_chan->dma_context.audiodma_pp_chn =
                audiodmappfuncs.channel_attach(attach_opt, NULL, NULL, 0, DMA_ATTACH_ANY_CHANNEL);

            if( !audio_chan->dma_context.audiodma_pp_chn ) {
                ado_error_fmt( "unable to attach to audio pp DMA channel" );
                ret = EAGAIN;
                goto dmac_init_fail;
            }
        }
...
void audio_dmac_init_cleanup (HW_CONTEXT_T* rcar)
{
    ...
    for ( uint32_t i = 0; i < RCAR_MAX_DEVICES; i++ ) {
        for ( uint32_t chan = ADO_PCM_CHANNEL_PLAYBACK; chan < ADO_PCM_CHANNEL_MAX; chan++ ) {
            ...
            if ( audio_chan->dma_context.audiodma_chn ) {
                audiodmafuncs.channel_release ( audio_chan->dma_context.audiodma_chn );
                audio_chan->dma_context.audiodma_chn = NULL;
            }
            if ( audio_chan->dma_context.audiodma_pp_chn ) {
                audiodmappfuncs.channel_release ( audio_chan->dma_context.audiodma_pp_chn );
                audio_chan->dma_context.audiodma_pp_chn = NULL;
            }
        }
    }
...
void audio_dmac_deinit (HW_CONTEXT_T* rcar)
{
    ...
    for ( uint32_t i = 0; i < RCAR_MAX_DEVICES; i++ ) {
        for ( uint32_t chan = ADO_PCM_CHANNEL_PLAYBACK; chan < ADO_PCM_CHANNEL_MAX; chan++ ) {
            ...
            if ( audio_chan->dma_context.audiodma_chn ) {
                audio_dmac_stop ( audio_chan->dma_context.audiodma_chn );
            }
            if ( audio_chan->dma_context.audiodma_pp_chn ) {
                audio_dmac_pp_stop( audio_chan->dma_context.audiodma_pp_chn );
            }
        }
    }
...
int audio_dmac_mp_setup(void *audiodma_chn, audio_peripheral_t dst,  off64_t mem_addr, int len)
{
    ...
    if( audio_dmac_mp_get_config(dst, &audio_dmac_config) != EOK ) {
        ado_error_fmt( "failed getting the DMAC MP config for dst %d", dst );
        return EINVAL;
    }
...
inline int audio_dmac_cleanup(void * audiodma_chn)
{
    ...
    return (audiodmafuncs.xfer_complete(audiodma_chn));
}

inline int
audio_dmac_alloc_buf( void * audiodma_chn, dma_addr_t *addr, unsigned size, unsigned flags )
{
    if( !audiodma_chn ) {
        return EINVAL;
    }

    return(audiodmafuncs.alloc_buffer(audiodma_chn, addr, size, flags));
}

inline int
audio_dmac_free_buf( void * audiodma_chn, dma_addr_t *addr )
{
    if( !audiodma_chn ) {
        return EINVAL;
    }

    audiodmafuncs.free_buffer(audiodma_chn, addr);
    return EOK;
}
...
int audio_dmac_pp_setup(void *audiodma_pp_chn, audio_peripheral_t src, audio_peripheral_t dst)
{
    ...
    if( audio_dmac_pp_get_config( src, dst, &dmac_pp_config) != EOK ) {
        ado_error_fmt( "failed getting the DMAC PP config for src %d dst %d", src, dst );
        return EINVAL;
    }

    memset(&tinfo, 0, sizeof(tinfo));

    /* Setup peripheral-peripheral DMA transfer from src to dst */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/deva/ctrl/rcar/dmac.c $ $Rev: 911285 $")
#endif
