...
#ifndef __RCAR_SOC_BOARD_H3_H_INCLUDED
#define __RCAR_SOC_BOARD_H3_H_INCLUDED
#define     USE_CANFD
...
rcar_config h3_ws11_config[] = {
    ...
    [DEV_SCIF] = {
        ...
        .pinmux = (rcar_pinmux[])
        {
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(5),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 12,  .ipsr.val = 0 }, /* RX1_A */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(6),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 16,  .ipsr.val = 0 }, /* TX1_A */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(7),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 20,  .ipsr.val = 0 }, /* CTS1# */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(8),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 24,  .ipsr.val = 0 }, /* RTS1# */
            { { 0 } }
        }
#endif
    },
    [DEV_HSCIF] = {
...
#else
            { .clk.val = DISABLE, .clk.reg = SMSTPCR(5), .clk.bits = BIT(19) }, /* HSCIF1 */
#endif
        ...
        .pinmux = (rcar_pinmux[])
        {
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(5),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 12,  .ipsr.val = 1 }, /* RX1_A/HRX1_A */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(6),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 16,  .ipsr.val = 1 }, /* TX1_A/HTX1_A */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(7),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 20,  .ipsr.val = 1 }, /* CTS1#/HCTS1#_A */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(8),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 24,  .ipsr.val = 1 }, /* RTS1#/HRTS1#_A */
            { { 0 } }
        }
#endif
    },
    ...
    [DEV_USBH] = {
        .mod = (rcar_module[])
        {
            ...
            { .clk.val = ENABLE,  .clk.reg = SMSTPCR(7), .clk.bits = BIT(1), .base = RCAR_GEN3_USB2_BASE }, /* EHCI0/OHCI2 */
            { { 0 } }
        },
    ...
    [DEV_MSIOF] = {
        ...
        .pinmux = (rcar_pinmux[])
        {
            ...
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(7),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 16, .ipsr.val = 2 }, /* MSIOF1_TXD_A/SDATA3 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(8),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 20, .ipsr.val = 2 }, /* MSIOF1_SCK_A/SSI_SCK4 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(9),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 24, .ipsr.val = 2 }, /* MSIOF1_SYNC_A/SSI_WS4 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(10), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 28, .ipsr.val = 2 }, /* MSIOF1_RXD_A/SSI_SDATA4 */
#elif defined USE_MSIOF1C
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(17), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 12, .ipsr.val = 2 }, /* MSIOF1_SCK_C/SSI_SCK78 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(18), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 16, .ipsr.val = 2 }, /* MSIOF1_SYNC_C/SSI_WS78 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(19), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 20, .ipsr.val = 2 }, /* MSIOF1_RXD_C/SSI_SDATA7 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(20), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 24, .ipsr.val = 2 }, /* MSIOF1_TXD_C/SSI_SDATA8 */
#endif
            { { 0 } }
        },
        .settings = (rcar_pin[])
    ...
    [DEV_I2C] = {
        .mod = (rcar_module[])
        {
            ...
            { .clk.val = DISABLE, .clk.reg = SMSTPCR(9), .clk.bits = BIT(18) }, /* I2C-IF6 */
            { .clk.val = ENABLE,  .clk.reg = SMSTPCR(9), .clk.bits = BIT(26) }, /* IIC */
            { { 0 } }
        },
        .pinmux = (rcar_pinmux[])
        {
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(0), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(10), .ipsr.bits = 24, .ipsr.val = 4 }, /* SDA2_A/SCK0 */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(4), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 8,  .ipsr.val = 4 }, /* SCL2_A/RTS0#/TANS */
            { { 0 } }
        },
        .settings = (rcar_pin[])
        {
            { .reg = MODSEL(0), .bits = BIT(19), .val = 0 }, /* SEL_I2C2 */
            { 0 }
        }
    },
    [DEV_AUDIO] = {
        ...
        .pinmux = (rcar_pinmux[])
        {
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(12), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(12), .ipsr.bits = 8,  .ipsr.val = 3 }, /* AUDIO_CLKB_A/HSCK0 */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(18), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(12), .ipsr.bits = 28, .ipsr.val = 8 }, /* AUDIO_CLKOUT_A/MSIOF0_SYNC */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(19), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(13), .ipsr.bits = 0,  .ipsr.val = 8 }, /* AUDIO_CLKOUT3_A/MSIOF0_SS1 */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(21), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(13), .ipsr.bits = 4,  .ipsr.val = 3 }, /* AUDIO_CLKC_A/MSIOF0_SS2 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(22), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(16), .ipsr.bits = 0,  .ipsr.val = 0 }, /* AUDIO_CLKA_A */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(0),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(13), .ipsr.bits = 20, .ipsr.val = 0 }, /* SSI_SCK0129 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(1),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(13), .ipsr.bits = 24, .ipsr.val = 0 }, /* SSI_WS0129 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(2),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(13), .ipsr.bits = 28, .ipsr.val = 0 }, /* SSI_SDATA0 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(3),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 0,  .ipsr.val = 0 }, /* SSI_SDATA1_A */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(8),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 20, .ipsr.val = 0 }, /* SSI_SCK4 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(9),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 24, .ipsr.val = 0 }, /* SSI_WS4 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(10), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(14), .ipsr.bits = 28, .ipsr.val = 0 }, /* SSI_SDATA4 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(17), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 12, .ipsr.val = 0 }, /* SSI_SCK78 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(18), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 16, .ipsr.val = 0 }, /* SSI_WS78 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(19), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 20, .ipsr.val = 0 }, /* SSI_SDATA7 */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(20), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(15), .ipsr.bits = 24, .ipsr.val = 0 }, /* SSI_SDATA8 */
            { { 0 } }
        },
        .settings = (rcar_pin[])
        {
            { .reg = MODSEL(0), .bits = BITS(1,2), .val = 0 }, /* SEL_ADGA */
    ...
    [DEV_SDHI] = {
        ...
        .pinmux = (rcar_pinmux[])
        {
            ...
            { .gpsr.reg = GPSR(3), .gpsr.bits = BIT(12), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(10), .ipsr.bits = 8,  .ipsr.val = 0 }, /* SD0_CD */
            { .gpsr.reg = GPSR(3), .gpsr.bits = BIT(13), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(10), .ipsr.bits = 12, .ipsr.val = 0 }, /* SD0_WP */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(1),  .gpsr.val = GPSR_IO, .gpio.reg = GPIO(5),  .gpio.type = GPIO_OUT, .gpio.val = 1 }, /* SD0_PWR */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(2),  .gpsr.val = GPSR_IO, .gpio.reg = GPIO(5),  .gpio.type = GPIO_OUT, .gpio.val = 1 }, /* SD0_SIG_PWR */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(7),  .gpsr.val = GPSR_PF }, /* SD3_CLK */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(8),  .gpsr.val = GPSR_PF }, /* SD3_CMD */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(9),  .gpsr.val = GPSR_PF }, /* SD3_DAT0 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(10), .gpsr.val = GPSR_PF }, /* SD3_DAT1 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(11), .gpsr.val = GPSR_PF }, /* SD3_DAT2 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(12), .gpsr.val = GPSR_PF }, /* SD3_DAT3 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(15), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(10), .ipsr.bits = 0,  .ipsr.val = 1 }, /* SD3_CD/SD3_DAT6 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(16), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(10), .ipsr.bits = 4,  .ipsr.val = 1 }, /* SD3_WP/SD3_DAT7 */
            { .gpsr.reg = GPSR(3), .gpsr.bits = BIT(14), .gpsr.val = GPSR_IO, .gpio.reg = GPIO(3),  .gpio.type = GPIO_OUT, .gpio.val = 1 }, /* SD3_PWR */
            { .gpsr.reg = GPSR(3), .gpsr.bits = BIT(15), .gpsr.val = GPSR_IO, .gpio.reg = GPIO(3),  .gpio.type = GPIO_OUT, .gpio.val = 1 }, /* SD3_SIG_PWR */
            { { 0 } }
        },
        .settings = (rcar_pin[])
        {
            ...
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_2_8, 20) }, /* SD0_CLK */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_2_8, 16) }, /* SD0_CMD */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_2_8, 12) }, /* SD0_DAT0 */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_2_8, 8)  }, /* SD0_DAT1 */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_2_8, 4)  }, /* SD0_DAT2 */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_2_8, 0)  }, /* SD0_DAT3 */
            { .reg = DRVCTRL(17), .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_2_8, 28) }, /* SD0_CD */
            { .reg = DRVCTRL(17), .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_2_8, 24) }, /* SD0_WP */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_2_8, 8)  }, /* SD3_CLK */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_2_8, 4)  }, /* SD3_CMD */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_2_8, 0)  }, /* SD3_DAT0 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_2_8, 28) }, /* SD3_DAT1 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_2_8, 24) }, /* SD3_DAT2 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_2_8, 20) }, /* SD3_DAT3 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_2_8, 8)  }, /* SD3_CD */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_2_8, 4)  }, /* SD3_WP */
            { 0 }
        },
    },
    [DEV_MMCIF] = {
        ...
        .cpg = (rcar_pin[])
        {
            { .reg = RCAR_GEN3_CPG_SD1CKCR, .bits = 0xFFFFFFFF, .val = 4 }, /* SD1 clk */
            { .reg = RCAR_GEN3_CPG_SD2CKCR, .bits = 0xFFFFFFFF, .val = 4 }, /* SD2 clk */
            { 0 }
        },
        .pinmux = (rcar_pinmux[])
        {
            ...
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(1),  .gpsr.val = GPSR_PF },                                                      /* SD2_CMD */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(2),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(9), .ipsr.bits = 4,  .ipsr.val = 0 }, /* SD2_DAT0 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(3),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(9), .ipsr.bits = 8,  .ipsr.val = 0 }, /* SD2_DAT1 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(4),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(9), .ipsr.bits = 12, .ipsr.val = 0 }, /* SD2_DAT2 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(5),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(9), .ipsr.bits = 16, .ipsr.val = 0 }, /* SD2_DAT3 */
            { .gpsr.reg = GPSR(4), .gpsr.bits = BIT(6),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(9), .ipsr.bits = 20, .ipsr.val = 0 }, /* SD2_DS */
            { { 0 } }
        },
        .settings = (rcar_pin[])
        {
            { .reg = PUEN(3), .bits = BITS(18,28), .val = PUEN_DISABLE },               /* Disable all SD1, SD2 Pins Pull-up/down */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_2_8, 0)  }, /* SD2_CMD */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_2_8, 4)  }, /* SD2_CLK */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_2_8, 8)  }, /* SD1_DAT3 */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_2_8, 12) }, /* SD1_DAT2 */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_2_8, 16) }, /* SD1_DAT1 */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_2_8, 20) }, /* SD1_DAT0 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_2_8, 28) }, /* SD2_DAT0 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_2_8, 24) }, /* SD2_DAT1 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_2_8, 20) }, /* SD2_DAT2 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_2_8, 16) }, /* SD2_DAT3 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_2_8, 12) }, /* SD2_DS */
            { .reg = POCCTRL(0), .bits = BITS(6,18), .val = POC_1_8V },                 /* Set SD1, SD2 POCCTRL to 1.8V */
            { .reg = TDSELCTRL(0), .bits = BITS(2,5), .val = TDSEL(TDSEL_40PF, 2)|TDSEL(TDSEL_40PF, 4) }, /* Set SD1, SD2 TDSEL to 40 pF */
            { 0 }
        }
    },
    [DEV_DMAC] = {
    ...
    [DEV_SATA] = {
        .mod = (rcar_module[])
        {
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(8), .clk.bits = BIT(15) }, /* SATA-IF */
            { {0} }
        }
    },
    [DEV_PCI] = {
    ...
    [DEV_CAN] = {
        ...
        {
#if defined USE_CANFD
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(22), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(4), .ipsr.bits = 20, .ipsr.val = 9 }, /* BS#/CAN1_TX */
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(23), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(4), .ipsr.bits = 24, .ipsr.val = 9 }, /* RD#/CAN0_TX_A */
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(24), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(4), .ipsr.bits = 28, .ipsr.val = 9 }, /* RDWR#/CAN0_RX_A */
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(26), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(5), .ipsr.bits = 4,  .ipsr.val = 9 }, /* WE1#/CAN1_RX */
#else
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(22), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(4), .ipsr.bits = 20, .ipsr.val = 8 }, /* BS#/CAN1_TX */
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(23), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(4), .ipsr.bits = 24, .ipsr.val = 8 }, /* RD#/CAN0_TX_A */
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(24), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(4), .ipsr.bits = 28, .ipsr.val = 8 }, /* RDWR#/CAN0_RX_A */
            { .gpsr.reg = GPSR(1), .gpsr.bits = BIT(26), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(5), .ipsr.bits = 4,  .ipsr.val = 8 }, /* WE1#/CAN1_RX */
#endif
            { { 0 } }
        },
        .settings = (rcar_pin[])
        {
#if defined USE_CANFD
            { .reg = MODSEL(0), .bits = BIT(5), .val = 0 }, /* SEL_CANFD0 = CANFD0_RX0_A/CANFD0_TX_A */
#else
            { .reg = MODSEL(1), .bits = BIT(6), .val = 0 }, /* SEL_RCAN0 = CAN0_RX0_A/CAN0_TX_A */
#endif
            { 0 }
        }
    },
    ...
    [DEV_DISPLAY] = {
        ...
        .mod = (rcar_module[])
        {
            ...
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(7), .clk.bits = BIT(28) }, /* HDMI-IF1 */
            ...
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(7), .clk.bits = BIT(21) }, /* DU3 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(31) }, /* VSPI0 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(30) }, /* VSPI1 */
            ...
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(14) }, /* FCPF1 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(11) }, /* FCPVI0 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(10) }, /* FCPVI1 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(7)  }, /* FCPVB0 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(6), .clk.bits = BIT(6)  }, /* FCPVB1 */
        ...
        .pinmux = (rcar_pinmux[])
        {
            ...
            { .gpsr.reg = GPSR(7), .gpsr.bits = BIT(3),  .gpsr.val = GPSR_PF }, /* HDMI1_CEC */
            { { 0 } }
        },
        .settings = (rcar_pin[])
        {
    ...
    [DEV_VIN] = {
        .mod = (rcar_module[])
        {
            ...
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(7), .clk.bits = BIT(14) }, /* CSI20 */
...
rcar_config h3_config[] = {
    ...
    [DEV_SCIF] = {
        ...
        .pinmux = (rcar_pinmux[])
        {
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(5),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(12), .ipsr.bits = 12,  .ipsr.val = 0 }, /* RX1_A */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(6),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(12), .ipsr.bits = 16,  .ipsr.val = 0 }, /* TX1_A */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(7),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(12), .ipsr.bits = 20,  .ipsr.val = 0 }, /* CTS1# */
            { .gpsr.reg = GPSR(5), .gpsr.bits = BIT(8),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(12), .ipsr.bits = 24,  .ipsr.val = 0 }, /* RTS1# */
            { { 0 } }
        }
#endif
    },
    ...
    [DEV_USBH] = {
        .mod = (rcar_module[])
        {
            ...
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(7), .clk.bits = BIT(2), .base = RCAR_GEN3_USB1_BASE }, /* EHCI0/OHCI1 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(7), .clk.bits = BIT(1), .base = RCAR_GEN3_USB2_BASE }, /* EHCI0/OHCI2 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(7), .clk.bits = BIT(0), .base = RCAR_GEN3_USB3_BASE }, /* EHCI0/OHCI3 */
            { .clk.val = ENABLE, .clk.reg = SMSTPCR(9), .clk.bits = BIT(6) },                              /* GPIO6 */
            { { 0 } }
        },
        .pinmux = (rcar_pinmux[])
        {
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(25), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(17), .ipsr.bits = 12,       .ipsr.val = 0 }, /* USB0_OVC */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(24), .gpsr.val = GPSR_IO, .gpio.reg = GPIO(6),  .gpio.type = GPIO_OUT, .gpio.val = 1 }, /* USB0_PWEN */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(26), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(17), .ipsr.bits = 16,       .ipsr.val = 0 }, /* USB1_PWEN */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(27), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(17), .ipsr.bits = 20,       .ipsr.val = 0 }, /* USB1_OVC */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(14), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(16), .ipsr.bits = 0,        .ipsr.val = 1 }, /* SSI_SCK6/USB2_PWEN */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(15), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(16), .ipsr.bits = 4,        .ipsr.val = 1 }, /* SSI_WS6/USB2_OVC */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(30), .gpsr.val = GPSR_IO, .gpio.reg = GPIO(6),  .gpio.type = GPIO_OUT, .gpio.val = 1 }, /* USB3_PWEN */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(31), .gpsr.val = GPSR_IO, .gpio.reg = GPIO(6),  .gpio.type = GPIO_IN,  .gpio.val = 0 }, /* USB3_OVC */
            { { 0 } }
        },
        .blk_config = config_usbh,
    },
    [DEV_USBD] = {
        .mod = (rcar_module[])
        {
            ...
            { .clk.val = ENABLE,  .clk.reg = SMSTPCR(3), .clk.bits = BIT(30) },                               /* USB_DMAC0-0 */
            { .clk.val = ENABLE,  .clk.reg = SMSTPCR(3), .clk.bits = BIT(31) },                               /* USB_DMAC0-1 */
            { .clk.val = DISABLE, .clk.reg = SMSTPCR(7), .clk.bits = BIT(5), .base = RCAR_GEN3_HSUSB3_BASE }, /* HS-USB-IF3  */
            { .clk.val = DISABLE, .clk.reg = SMSTPCR(3), .clk.bits = BIT(26) },                               /* USB-DMAC3-0 */
            { .clk.val = DISABLE, .clk.reg = SMSTPCR(3), .clk.bits = BIT(29) },                               /* USB-DMAC3-1 */
    ...
    [DEV_USB3H] = {
        ...
        .pinmux = (rcar_pinmux[])
        {
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(28), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(17), .ipsr.bits = 24, .ipsr.val = 0  }, /* USB3.0_PWEN */
            { .gpsr.reg = GPSR(6), .gpsr.bits = BIT(29), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(17), .ipsr.bits = 28, .ipsr.val = 0  }, /* USB3.0_OVC */
            { { 0 } }
        },
        .blk_config = config_usb3h,
    },
    ...
    [DEV_SDHI] = {
        ...
        .pinmux = (rcar_pinmux[])
        {
            ...
            { .gpsr.reg = GPSR(3), .gpsr.bits = BIT(4),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(8),  .ipsr.bits = 0,  .ipsr.val = 0 }, /* SD0_DAT2 */
            { .gpsr.reg = GPSR(3), .gpsr.bits = BIT(5),  .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(8),  .ipsr.bits = 4,  .ipsr.val = 0 }, /* SD0_DAT3 */
            { .gpsr.reg = GPSR(3), .gpsr.bits = BIT(12), .gpsr.val = GPSR_IP, .ipsr.reg = IPSR(11), .ipsr.bits = 8,  .ipsr.val = 0 }, /* SD0_CD */
        ...
        .settings = (rcar_pin[])
        {
            { .reg = PUEN(3), .bits = BITS(10,15)|BITS(29,31),       .val = PUEN_DISABLE },
            { .reg = PUEN(4), .bits = BITS(0,2)|BITS(5,6)|BITS(8,9), .val = PUEN_DISABLE },
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_3_8, 20) }, /* SD0_CLK */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_3_8, 16) }, /* SD0_CMD */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_3_8, 12) }, /* SD0_DAT0 */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_3_8, 8)  }, /* SD0_DAT1 */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_3_8, 4)  }, /* SD0_DAT2 */
            { .reg = DRVCTRL(13), .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_3_8, 0)  }, /* SD0_DAT3 */
            { .reg = DRVCTRL(17), .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_3_8, 28) }, /* SD0_CD */
            { .reg = DRVCTRL(17), .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_3_8, 24) }, /* SD0_WP */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_3_8, 8)  }, /* SD3_CLK */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_3_8, 4)  }, /* SD3_CMD */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_3_8, 0)  }, /* SD3_DAT0 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_3_8, 28) }, /* SD3_DAT1 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_3_8, 24) }, /* SD3_DAT2 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_3_8, 20) }, /* SD3_DAT3 */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_3_8, 8)  }, /* SD3_CD */
            { .reg = DRVCTRL(16), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_3_8, 4)  }, /* SD3_WP */
            { 0 }
        },
    },
    [DEV_MMCIF] = {
        ...
        {
            { .reg = PUEN(3), .bits = BITS(18,28), .val = PUEN_DISABLE },               /* Disable all SD1, SD2 Pins Pull-up/down */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 0),  .val = DRVCAP(DRV3_6_8, 0)  }, /* SD2_CMD */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 4),  .val = DRVCAP(DRV3_6_8, 4)  }, /* SD2_CLK */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 8),  .val = DRVCAP(DRV3_6_8, 8)  }, /* SD1_DAT3 */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_6_8, 12) }, /* SD1_DAT2 */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_6_8, 16) }, /* SD1_DAT1 */
            { .reg = DRVCTRL(14), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_6_8, 20) }, /* SD1_DAT0 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 28), .val = DRVCAP(DRV3_6_8, 28) }, /* SD2_DAT0 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 24), .val = DRVCAP(DRV3_6_8, 24) }, /* SD2_DAT1 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 20), .val = DRVCAP(DRV3_6_8, 20) }, /* SD2_DAT2 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 16), .val = DRVCAP(DRV3_6_8, 16) }, /* SD2_DAT3 */
            { .reg = DRVCTRL(15), .bits = DRV(DRV3, 12), .val = DRVCAP(DRV3_6_8, 12) }, /* SD2_DS */
            { .reg = POCCTRL(0), .bits = BITS(6,18), .val = POC_1_8V },                 /* Set SD1, SD2 POCCTRL to 1.8V */
            { .reg = TDSELCTRL(0), .bits = BITS(2,5), .val = TDSEL(TDSEL_40PF, 2)|TDSEL(TDSEL_40PF, 4) }, /* Set SD1, SD2 TDSEL to 40 pF */
            { 0 }
        }
...
#endif //__RCAR_SOC_BOARD_H3_H_INCLUDED
