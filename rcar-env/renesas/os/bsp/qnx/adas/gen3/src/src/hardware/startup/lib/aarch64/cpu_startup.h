...
#define CPU_COMMON_OPTIONS_STRING	"E:X:"
...
extern uintptr_t			gic_lpi_cfg_vaddr;
extern unsigned				gic_gicr_shift;
extern void					gic_v3_init(paddr_t gicd, paddr_t gicr, paddr_t gicc, unsigned nlpi, int use_mm);
extern int					gic_v3_num_spis(void);
extern void					gic_v3_set_intr_trig_mode(int irq, int edge);
...
/* 2020/01/23 temp definition until new <aarch64/syspage.h> has propagated */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/aarch64/cpu_startup.h $ $Rev: 912447 $")
#endif
