...
#define RCAR_RPC_DRENR_DRDB(x)        (((x) & 0x3) << 16)
 #define RCAR_RPC_DRENR_DRDB_1BIT     RCAR_RPC_DRENR_DRDB(0)
 #define RCAR_RPC_DRENR_DRDB_4BIT     RCAR_RPC_DRENR_DRDB(2)
#define RCAR_RPC_DRENR_OPDP(x)        (((x) & 0x3) << 20)
 #define RCAR_RPC_DRENR_OPDP_1BIT     RCAR_RPC_DRENR_OPDP(0)
 #define RCAR_RPC_DRENR_OPDP_4BIT     RCAR_RPC_DRENR_OPDP(2)
#define RCAR_RPC_DRENR_ADB(x)         (((x) & 0x3) << 24)
 #define RCAR_RPC_DRENR_ADB_1BIT      RCAR_RPC_DRENR_ADB(0)
 #define RCAR_RPC_DRENR_ADB_4BIT      RCAR_RPC_DRENR_ADB(2)
#define RCAR_RPC_DRENR_OCDB(x)        (((x) & 0x3) << 28)
 #define RCAR_RPC_DRENR_OCDB_1BIT     RCAR_RPC_DRENR_OCDB(0)
 #define RCAR_RPC_DRENR_OCDB_4BIT     RCAR_RPC_DRENR_OCDB(2)
#define RCAR_RPC_DRENR_CDB(x)         (((x) & 0x3) << 30)
 #define RCAR_RPC_DRENR_CDB_1BIT      RCAR_RPC_DRENR_CDB(0)
 #define RCAR_RPC_DRENR_CDB_4BIT      RCAR_RPC_DRENR_CDB(2)
...
#define RCAR_RPC_PHYCNT_STRTIM(x)     (((x) & 0x3) << 16)
