...
/*****************************************************************************/
static int eide_xlat_status(EIDE_TARGET *tgt, int rtype,
...
/*****************************************************************************/
static int eide_ata_pthru_cbf(EIDE_TARGET *tgt, uint8_t timeo)
{
...
/*****************************************************************************/
static int eide_ata_pthru(EIDE_TARGET *tgt, CCB_SCSIIO *ccb)
{
    SIM_EIDE_PDATA      *pdata;
    ATA_PASS_THRU       *pt;
    ATA_TASKFILE        tf;
...
/*****************************************************************************/
static int eide_mp_control_pata(EIDE_TARGET *tgt,
...
/*****************************************************************************/
static int eide_log_sense(EIDE_TARGET *tgt, CCB_SCSIIO *ccb)
{
    int                 status;
...
/*****************************************************************************/
static int eide_log_select(EIDE_TARGET *tgt, CCB_SCSIIO *ccb)
{
    int                 status;
...
/*****************************************************************************/
static int eide_mode_sense(EIDE_TARGET *tgt, CCB_SCSIIO *ccb)
{
    MODE_SENSE              *ms;
...
/*****************************************************************************/
static int eide_mode_select(EIDE_TARGET *tgt, CCB_SCSIIO *ccb)
{
    MPAGE_CONTROL_PATA      *mp;
    MODE_PARM_HEADER10      *mph;
    int                     status;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/rcarsata/sim_satl.c $ $Rev: 896546 $")
#endif
