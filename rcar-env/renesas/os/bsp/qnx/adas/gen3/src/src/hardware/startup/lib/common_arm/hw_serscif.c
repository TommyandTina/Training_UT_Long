...
void init_scif(unsigned channel, const char *init, const char *defaults)
{
	...
	baud = extclk = n = 0;
	dbg_device[channel].base = RCAR_GEN3_SCIF0_BASE;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/common_arm/hw_serscif.c $ $Rev: 807382 $")
#endif
