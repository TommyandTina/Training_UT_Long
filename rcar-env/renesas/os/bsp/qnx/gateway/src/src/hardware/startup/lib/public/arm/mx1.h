...
#define MX1_UCR4_CTSTL			(1<<10)		/* CTS Trigger Level (0-32) */
...
/* __SRCVERSION("mx1.h $Rev: 870901 $"); */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx1.h $ $Rev: 870901 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx1.h $ $Rev: 870901 $" )
#endif
#endif
