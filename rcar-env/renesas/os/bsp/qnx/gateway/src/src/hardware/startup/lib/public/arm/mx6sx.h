 ...
 */
#define MX6SX_PL310_BASE                         0x00A02000
...
/* Registers offset */
#define MX6SX_QSPI_MCR_OFFSET             0x00   /**< Module Configuration Register */
#define MX6SX_QSPI_IPCR_OFFSET            0x08   /**< IP Configuration Register */
#define MX6SX_QSPI_FLSHCR_OFFSET          0x0C   /**< Flash Configuration Register */
#define MX6SX_QSPI_BUF0CR_OFFSET          0x10   /**< Buffer0 Configuration Register */
#define MX6SX_QSPI_BUF1CR_OFFSET          0x14   /**< Buffer1 Configuration Register */
#define MX6SX_QSPI_BUF2CR_OFFSET          0x18   /**< Buffer2 Configuration Register */
#define MX6SX_QSPI_BUF3CR_OFFSET          0x1C   /**< Buffer3 Configuration Register */
#define MX6SX_QSPI_BFGENCR_OFFSET         0x20   /**< Buffer Generic Configuration Register */
#define MX6SX_QSPI_BUF0IND_OFFSET         0x30   /**< Buffer0 Top Index Register */
#define MX6SX_QSPI_BUF1IND_OFFSET         0x34   /**< Buffer1 Top Index Register */
#define MX6SX_QSPI_BUF2IND_OFFSET         0x38   /**< Buffer2 Top Index Register */
#define MX6SX_QSPI_SFAR_OFFSET            0x100  /**< Serial Flash Address Register */
#define MX6SX_QSPI_SMPR_OFFSET            0x108  /**< Sampling Register */
#define MX6SX_QSPI_RBSR_OFFSET            0x10C  /**< RX Buffer Status Register */
#define MX6SX_QSPI_RBCT_OFFSET            0x110  /**< RX Buffer Control Register */
#define MX6SX_QSPI_TBSR_OFFSET            0x150  /**< TX Buffer Status Register */
#define MX6SX_QSPI_TBDR_OFFSET            0x154  /**< TX Buffer Data Register */
#define MX6SX_QSPI_SR_OFFSET              0x15C  /**< Status Register */
#define MX6SX_QSPI_FR_OFFSET              0x160  /**< Flag Register */
#define MX6SX_QSPI_RSER_OFFSET            0x164  /**< Interrupt and DMA Request Select and Enable Register */
#define MX6SX_QSPI_SPNDST_OFFSET          0x168  /**< Sequence Suspend Status Register */
#define MX6SX_QSPI_SPTRCLR_OFFSET         0x16C  /**< Sequence Pointer Clear Register */
#define MX6SX_QSPI_SFA1AD_OFFSET          0x180  /**< Serial Flash A1Top Address */
#define MX6SX_QSPI_SFA2AD_OFFSET          0x184  /**< Serial Flash A2Top Address */
#define MX6SX_QSPI_SFB1AD_OFFSET          0x188  /**< Serial Flash B1Top Address */
#define MX6SX_QSPI_SFB2AD_OFFSET          0x18C  /**< Serial Flash B2Top Address */
#define MX6SX_QSPI_RBDR0_OFFSET           0x200  /**< RX Buffer Data Register 0 */
#define MX6SX_QSPI_RBDRn_OFFSET(index)    (MX6SX_QSPI_RBDR0_OFFSET + (index * 4)) /**< RX Buffer Data Register n */
#define MX6SX_QSPI_LUTKEY_OFFSET          0x300  /**< LUT Key Register */
#define MX6SX_QSPI_LCKCR_OFFSET           0x304  /**< LUT Lock Configuration Register */
#define MX6SX_QSPI_LUT0_OFFSET            0x310  /**< Look-up Table register 0 */
#define MX6SX_QSPI_LUT1_OFFSET            0x314  /**< Look-up Table register 1 */
#define MX6SX_QSPI_LUT2_OFFSET            0x318  /**< Look-up Table register 2 */
#define MX6SX_QSPI_LUT3_OFFSET            0x31C  /**< Look-up Table register 3 */
#define MX6SX_QSPI_LUTn_OFFSET(index)     (MX6SX_QSPI_LUT0_OFFSET + (index * 4)) /**< Look-up Table register n */

/* Registers mask */

/* Module Configuration Register */
#define MX6SX_QSPI_MCR_RESERVED_MASK      0xF0000 /**< This reserved field must be always programmed to 0xF! */
#define MX6SX_QSPI_MCR_MDIS_MASK          0x4000  /**< Module Disable */
#define MX6SX_QSPI_MCR_CLR_TXF_MASK       0x800   /**< Clear TX FIFO/Buffer */
#define MX6SX_QSPI_MCR_CLR_RXF_MASK       0x400   /**< Clear RX FIFO/Buffer */
#define MX6SX_QSPI_MCR_DDR_EN_MASK        0x80    /**< SDR and DDR instructions are supported */
#define MX6SX_QSPI_MCR_DQS_EN_MASK        0x40    /**< DQS_EN signal */
#define MX6SX_QSPI_MCR_END_CFG_MASK       0xC     /**< Endian configuration */
#define MX6SX_QSPI_MCR_SWRSTHD_MASK       0x2     /**< Software reset for QSPI AHB domain */
#define MX6SX_QSPI_MCR_SWRSTSD_MASK       0x1     /**< Software reset for Serial Flash domain */

/* IP Configuration Register */
#define MX6SX_QSPI_IPCR_SEQID_MASK        0x7800000 /**< Points to a sequence in the Look-up-table. A write triggers a transaction. */
#define MX6SX_QSPI_IPCR_SEQID_SHIFT       24

/* Flash Configuration Register */
#define MX6SX_QSPI_TCSS_MASK              0xF    /**< Serial flash CS setup time */
#define MX6SX_QSPI_TCSH_MASK              0xF00  /**< Serial flash CS hold time */

/* RX Buffer Status Register */
#define MX6SX_QSPI_RBSR_RDBFL_MASK        0x3F00 /**< RX Buffer Fill Level (4 bytes) entries count */
#define MX6SX_QSPI_RBSR_RDBFL_SHIFT       8

/* Status Register */
#define MX6SX_QSPI_SR_TXFULL_MASK         0x8000000       /**< TX Buffer Full. Asserted when no more data can be stored. */
#define MX6SX_QSPI_SR_AHB_ACC_MASK        0x4             /**< AHB Access: Asserted when transaction currently executed was initiated by AHB bus. */
#define MX6SX_QSPI_SR_IP_ACC_MASK         0x2             /**< IP Access: Asserted when transaction currently executed was initiated by IP bus. */
#define MX6SX_QSPI_SR_BUSY_MASK           0x1             /**< Module Busy: Module is handling a transaction to an external flash device. */
#define MX6SX_QSPI_SR_TXEDA_MASK          0x1000000       /**< TX buffer has Enough Data for a transaction */

/* RX Buffer Control Register */
#define MX6SX_QSPI_RBCT_RXBRD_MASK        0x100   /**< RX Buffer Readout: 1: RBDR0 to RBDRn */

/* Sequence Pointer Clear Register */
#define MX6SX_QSPI_SPTRCLR_IPPTRC_MASK    0x100   /**< 1: Clears the sequence pointer for IP accesses as defined in IPCR. */
#define MX6SX_QSPI_SPTRCLR_BFPTRC_MASK    0x1     /**< 1: Clears the sequence pointer for AHB accesses as defined in BFGENCR. */

/* RSER */
/* RX Buffer Drain Interrupt Enable */
#define MX6SX_QSPI_RSER_RBDIE_SHIFT       16
#define MX6SX_QSPI_RSER_RBDIE_MASK        (1 << MX6SX_QSPI_RSER_RBDIE_SHIFT)

/* TX Buffer Fill Interrupt Enable */
#define MX6SX_QSPI_RSER_TBFIE_SHIFT       27
#define MX6SX_QSPI_RSER_TBFIE_MASK        (1 << MX6SX_QSPI_RSER_TBFIE_SHIFT)

/* Transaction Finished Interrupt Enable */
#define MX6SX_QSPI_RSER_TFIE_SHIFT        0
#define MX6SX_QSPI_RSER_TFIE_MASK         (1 << MX6SX_QSPI_RSER_TFIE_SHIFT)

/* TX buffer Fill flag TBFF */
#define MX6SX_QSPI_FR_TBFF_SHIFT          27
#define MX6SX_QSPI_FR_TBFF_MASK           (1 << MX6SX_QSPI_FR_TBFF_SHIFT)

/** QSPI external memory mapping */
#define MX6SX_QSPI_AMBA_BASE_ADDRESS      0x60000000U

/** @name FIFO parameters */
#define MX6SX_QSPI_FIFO_WIDTH             4           //!< FIFO width: 4 bytes
#define MX6SX_QSPI_FIFO_DEPTH             32          //!< FIFO depth: 32 entries

#define MX6SX_QSPI_MAX_BURST_RX      (MX6SX_QSPI_FIFO_DEPTH * MX6SX_QSPI_FIFO_WIDTH)
#define MX6SX_QSPI_MAX_BURST_TX      (MX6SX_QSPI_FIFO_DEPTH * MX6SX_QSPI_FIFO_WIDTH)
/** @} */

/** @name LUT commands */
#define MX6SX_QSPI_PAD_1                  0x00        //!< Communication on 1 pad only
#define MX6SX_QSPI_PAD_2                  0x01        //!< Communication on 2 pads
#define MX6SX_QSPI_PAD_4                  0x02        //!< Communication on 4 pads

#define ADDR_MODE_3BYTE                   24          //!< 24 bit address
#define ADDR_MODE_4BYTE                   32          //!< 32 bit address

#define MX6SX_QSPI_INSTR_CMD              1           //!< FC command
#define MX6SX_QSPI_INSTR_ADDR             2           //!< FC address
#define MX6SX_QSPI_INSTR_DUMMY            3           //!< FC dummy operation
#define MX6SX_QSPI_INSTR_MODE             4           //!< FC dummy operation
#define MX6SX_QSPI_INSTR_READ             7           //!< FC read
#define MX6SX_QSPI_INSTR_WRITE            8           //!< FC write
#define MX6SX_QSPI_INSTR_JMP_ON_CS        9           //!< FC jump on cs
#define MX6SX_QSPI_INSTR_ADDR_DDR         10          //!< FC ddr address
#define MX6SX_QSPI_INSTR_MODE_DDR         11          //!< FC DDR 8 mode bits
#define MX6SX_QSPI_INSTR_READ_DDR         14          //!< FC ddr read
#define MX6SX_QSPI_INSTR_STOP             0           //!< FC stop

#define MX6SX_QSPI_LUT_KEY                0x5AF05AF0U //!< LUT key
#define MX6SX_QSPI_LUT_LOCK               0x1         //!< LUT content lock
#define MX6SX_QSPI_LUT_UNLOCK             0x2         //!< LUT content unlock
...
#define MX6SX_CCM_CDCDR                          0x30
    #define MX6SX_CCM_CDCDR_AUDIO_CLK_SEL_OFFSET        (7)
    #define MX6SX_CCM_CDCDR_AUDIO_CLK_SEL_MASK          (0x3 << MX6SX_CCM_CDCDR_AUDIO_CLK_SEL_OFFSET)
    #define MX6SX_CCM_CDCDR_AUDIO_CLK_PODF_OFFSET       (9)
    #define MX6SX_CCM_CDCDR_AUDIO_CLK_PODF_MASK         (0x7 << MX6SX_CCM_CDCDR_AUDIO_CLK_PODF_OFFSET)
    #define MX6SX_CCM_CDCDR_AUDIO_CLK_PRED_OFFSET       (12)
    #define MX6SX_CCM_CDCDR_AUDIO_CLK_PRED_MASK         (0x7 << MX6SX_CCM_CDCDR_AUDIO_CLK_PRED_OFFSET)
...
/* Bits */
#define SET_MX6SX_EPIT_CLKSRC_PCLK   (1)
#define SET_MX6SX_EPIT_LR       (0x0FF00000)

#define  MX6SX_EPIT_CR_CLKSRC(x) (x << 24 )
#define  MX6SX_EPIT_CR_IOVW      (1 << 17 )
#define  MX6SX_EPIT_CR_RLD       (1 << 3 )
#define  MX6SX_EPIT_CR_OCIEN     (1 << 2 )
#define  MX6SX_EPIT_CR_ENMOD     (1 << 1 )
#define  MX6SX_EPIT_CR_EN        (1 << 0 )
...
#define MX6SX_QSPI1_IRQ     139
#define MX6SX_QSPI2_IRQ     141

#define MX6SX_QSPI_SIZE     0x4000
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx6sx.h $ $Rev: 872290 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx6sx.h $ $Rev: 872290 $" )
#endif
#endif
