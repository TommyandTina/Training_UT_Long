...
#define DEV_CAP_WR_REL			(1 << 21)	// Reliable Write supported
#define DEV_CAP_WR_REL_ENH		(1 << 22)	// Enhanced Reliable Write supported
	_Uint64t			caps;
...
#define	HC_CAP_HS400ES				(1LL << 34)	// hs400 enhanced strobe supported
#define HC_CAP_CD_WP				(1LL << 35)	// card detect write protect supported
	_Uint64t		caps;
	_Uint32t		version;
	_Uint32t		sg_max;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/devb/sdmmc/sdiodi/include/sdiodi.h $ $Rev: 956072 $")
#endif
