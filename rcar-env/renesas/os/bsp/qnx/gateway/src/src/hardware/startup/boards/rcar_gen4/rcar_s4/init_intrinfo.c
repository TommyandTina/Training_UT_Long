...
const static struct startup_intrinfo gpio_intrs[] =
{
    ...
    {   992,                            // vector base
        ...
        RCAR_S4_INTCSYS_PFCSOC0_PORT_0,       // cascade vector
        0,                              // CPU vector base
        0,                              // CPU vector stride
        0,                              // flags
    ...
    {   992 + 32,                       // vector base
        32,                             // number of vectors
        RCAR_S4_INTCSYS_PFCSOC0_PORT_1,       // cascade vector
        0,                              // CPU vector base
        0,                              // CPU vector stride
        0,                              // flags
        { 0, 0, &interrupt_id_rcar_gpio},
    ...
    {   992 + 32*2,                     // vector base
        32,                             // number of vectors
        RCAR_S4_INTCSYS_PFCSOC0_PORT_2,       // cascade vector
        0,                              // CPU vector base
        0,                              // CPU vector stride
        0,                              // flags
        { 0, 0, &interrupt_id_rcar_gpio},
    ...
    {   992 + 32*3,                     // vector base
        32,                             // number of vectors
        RCAR_S4_INTCSYS_PFCSOC0_PORT_3,       // cascade vector
        0,                              // CPU vector base
        0,                              // CPU vector stride
        0,                              // flags
        { 0, 0, &interrupt_id_rcar_gpio},
