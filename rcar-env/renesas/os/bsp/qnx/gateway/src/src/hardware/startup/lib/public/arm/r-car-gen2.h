/*
 * $QNXLicenseC:
 * Copyright 2015, 2017, 2020 QNX Software Systems.
 *
 ...
 * Gen2 shared definitions: H2, M2, E2, W2H, E2X
...
#define RCAR_GEN2_PFC_BASE               0xE6060000
 ...
 #define RCAR_GEN2_PFC_GPSR6             0x1C
 #define RCAR_GEN2_PFC_GPSR7             0x74
 ...
 #define RCAR_GEN2_PFC_MODSEL1           0x90
 #define RCAR_GEN2_PFC_MODSEL2           0x94
 #define RCAR_GEN2_PFC_MODSEL3           0x98
 #define RCAR_GEN2_PFC_MODSEL4           0x9C
 ...
 #define RCAR_GEN2_PFC_PUPR7             0x11C
 #define RCAR_GEN2_PFC_IOCTL0            0x60
 #define RCAR_GEN2_PFC_IOCTL1            0x64
 #define RCAR_GEN2_PFC_IOCTL2            0x68
 #define RCAR_GEN2_PFC_IOCTL3            0x6C
...
#define RCAR_GEN2_CPG_SIZE               0x1000
 ...
 #define RCAR_GEN2_CPG_SD3CKCR           0x26C       // SDHI 3 Clock Frequency Control Register
 ...
 */
#define RCAR_GEN2_APMU_BASE              0xE6150000
#define RCAR_GEN2_APMU_SIZE              0x4000

 #define RCAR_GEN2_APMU_CA7WUPCR         0x1010      // CA7 CPU wake up control register
 #define RCAR_GEN2_APMU_CA15WUPCR        0x2010      // CA15 CPU wake up control register

 #define RCAR_GEN2_APMU_CA7DBGRCR        0x1180      // CA7 Debug Resource Reset Control Register
 #define RCAR_GEN2_APMU_CA15DBGRCR       0x2180      // CA15 Debug Resource Reset Control Register

/*
 * Reset registers
 */
#define RCAR_GEN2_RESET_BASE             0xE6160000
 #define RCAR_GEN2_CA15RESCNT            0x40        // CA15 reset control register
 #define RCAR_GEN2_CA7RESCNT             0x44        // CA7 reset control register
 #define RCAR_GEN2_RESCNT                0x50        // Reset control register
 #define RCAR_GEN2_WDTRSTCR              0x54        // Watchdog reset control register
 #define RCAR_GEN2_CA7BAR                0x30        // CA7 boot address register
 #define RCAR_GEN2_CA15BAR               0x20        // CA15 boot address register
...
#define RCAR_GEN2_SYSC_BASE              0xE6180000
 ...
 #define RCAR_GEN3_SYSC_WUPMSKCA15       0x14        // CA15 Wake Up Mask Register
 #define RCAR_GEN3_SYSC_WUPMSKCA7        0x18        // CA7 Wake Up Mask Register
 ...
 #define RCAR_GEN2_SYSC_PWRSR0           0x40        // Power status register 0
 #define RCAR_GEN2_SYSC_PWROFFSR0        0x48        // Power shutoff status register 0
 #define RCAR_GEN2_SYSC_PWRONSR0         0x50        // Power resume status register 0
 #define RCAR_GEN2_SYSC_PWRER0           0x54        // Power shutoff/resume error register 0

 #define RCAR_GEN2_SYSC_PWRSR1           0x80        // Power Status Register 1
 #define RCAR_GEN2_SYSC_PWROFFCR1        0x84        // Power Shutoff Control Register 1
 #define RCAR_GEN2_SYSC_PWROFFSR1        0x88        // Power Shutoff Status Register 1
 #define RCAR_GEN2_SYSC_PWRONCR1         0x8C        // Power Resume Control Register 1
 #define RCAR_GEN2_SYSC_PWRONSR1         0x90        // Power Resume Status Register 1
 #define RCAR_GEN2_SYSC_PWRER1           0x94        // Power shutoff/resume Error Register 1
 ...
 #define RCAR_GEN2_SYSC_PWRSR3           0x100       // Power Status Register 3
 #define RCAR_GEN2_SYSC_PWROFFCR3        0x104       // Power Shutoff Control Register 3
 #define RCAR_GEN2_SYSC_PWROFFSR3        0x108       // Power Shutoff Status Register 3
 #define RCAR_GEN2_SYSC_PWRONCR3         0x10C       // Power Resume Control Register 3
 #define RCAR_GEN2_SYSC_PWRONSR3         0x110       // Power Resume Status Register 3
 #define RCAR_GEN2_SYSC_PWRER3           0x114       // Power shutoff/resume Error Register 3

 #define RCAR_GEN2_SYSC_PWRSR4           0x140       // Power Status Register 4
 #define RCAR_GEN2_SYSC_PWROFFCR4        0x144       // Power Shutoff Control Register 4
 #define RCAR_GEN2_SYSC_PWROFFSR4        0x148       // Power Shutoff Status Register 4
 #define RCAR_GEN2_SYSC_PWRONCR4         0x14C       // Power Resume Control Register 4
 #define RCAR_GEN2_SYSC_PWRONSR4         0x150       // Power Resume Status Register 4
 #define RCAR_GEN2_SYSC_PWRER4           0x154       // Power shutoff/resume Error Register 4

 #define RCAR_GEN2_SYSC_PWRSR5           0x180       // Power Status Register 5
 #define RCAR_GEN2_SYSC_PWROFFCR5        0x184       // Power Shutoff Control Register 5
 #define RCAR_GEN2_SYSC_PWROFFSR5        0x188       // Power Shutoff Status Register 5
 #define RCAR_GEN2_SYSC_PWRONCR5         0x18C       // Power Resume Control Register 5
 #define RCAR_GEN2_SYSC_PWRONSR5         0x190       // Power Resume Status Register 5
 #define RCAR_GEN2_SYSC_PWRER5           0x194       // Power shutoff/resume Error Register 5

 #define RCAR_GEN2_SYSC_PWRSR6           0x1C0       // Power Status Register 6
 #define RCAR_GEN2_SYSC_PWROFFSR6        0x1C8       // Power Shutoff Status Register 6
 #define RCAR_GEN2_SYSC_PWRONSR6         0x1D0       // Power Resume Status Register 6
 #define RCAR_GEN2_SYSC_PWRER6           0x1D4       // Power shutoff/resume Error Register 6

 #define RCAR_GEN2_SYSC_PWRSRx(_x)       (RCAR_GEN2_SYSC_PWRSR0 + ((_x) * 0x40) + 0x00)
 #define RCAR_GEN2_SYSC_PWROFFCRx(_x)    (RCAR_GEN2_SYSC_PWRSR0 + ((_x) * 0x40) + 0x04)
 #define RCAR_GEN2_SYSC_PWROFFSRx(_x)    (RCAR_GEN2_SYSC_PWRSR0 + ((_x) * 0x40) + 0x08)
 #define RCAR_GEN2_SYSC_PWRONCRx(_x)     (RCAR_GEN2_SYSC_PWRSR0 + ((_x) * 0x40) + 0x0C)
 #define RCAR_GEN2_SYSC_PWRONSRx(_x)     (RCAR_GEN2_SYSC_PWRSR0 + ((_x) * 0x40) + 0x10)
 #define RCAR_GEN2_SYSC_PWRERx(_x)       (RCAR_GEN2_SYSC_PWRSR0 + ((_x) * 0x40) + 0x14)
...
#define RCAR_GEN2_OHCI_BASE              0x00000
#define RCAR_GEN2_EHCI_BASE              0x01000
#define RCAR_GEN2_PCI_CONF_AHB           0x10000     // PCI Configuration Registers for AHB-PCI
#define RCAR_GEN2_PCI_CONF_OHCI          0x10000     // PCI Configuration Registers for OHCI
#define RCAR_GEN2_PCI_CONF_EHCI          0x10100     // PCI Configuration Registers for EHCI
#define RCAR_GEN2_USB_AHB                0x10800     // PCI Communication Space for AHB-PCI


#define RCAR_GEN2_PCI_CONF_VID_DID          (0x00)
 #define RCAR_GEN2_PCI_CONF_VID_DID_OHCI     (0x00351033)
 #define RCAR_GEN2_PCI_CONF_VID_DID_EHCI     (0x00E01033)
 #define RCAR_GEN2_PCI_CONF_VID_DID_AHBPIC   (0x00001033)
#define RCAR_GEN2_PCI_CONF_CMND_STS         (0x04)
#define RCAR_GEN2_PCI_CONF_REVID_CC         (0x08)
#define RCAR_GEN2_PCI_CONF_CLS_LT_HT_BIST   (0x0C)
#define RCAR_GEN2_PCI_CONF_BASEAD           (0x10)
#define RCAR_GEN2_PCI_CONF_WIN1_BASEAD      (0x14)
#define RCAR_GEN2_PCI_CONF_WIN2_BASEAD      (0x18)
#define RCAR_GEN2_PCI_CONF_SSVID_SSID       (0x2C)
#define RCAR_GEN2_PCI_CONF_EROM_BASEAD      (0x30)
#define RCAR_GEN2_PCI_CONF_CAPPTR           (0x34)
#define RCAR_GEN2_PCI_CONF_INTR_LINE_PIN    (0x3C)
#define RCAR_GEN2_PCI_CONF_CAPID_NIP_PMCAP  (0x40)
#define RCAR_GEN2_PCI_CONF_PMC_STS_PMCSR    (0x44)
#define RCAR_GEN2_PCI_CONF_EXT1             (0xE0)
#define RCAR_GEN2_PCI_CONF_EXT2             (0xE4)


#define RCAR_GEN2_USB_AHB_PCIAHB_WIN1_CTR   (RCAR_GEN2_USB_AHB + 0x00)
#define RCAR_GEN2_USB_AHB_PCIAHB_WIN2_CTR   (RCAR_GEN2_USB_AHB + 0x04)
#define RCAR_GEN2_USB_AHB_AHBPCI_WIN1_CTR   (RCAR_GEN2_USB_AHB + 0x10)
#define RCAR_GEN2_USB_AHB_AHBPCI_WIN2_CTR   (RCAR_GEN2_USB_AHB + 0x14)
#define RCAR_GEN2_USB_AHB_PCI_INT_ENABLE    (RCAR_GEN2_USB_AHB + 0x20)
#define RCAR_GEN2_USB_AHB_PCI_INT_STATUS    (RCAR_GEN2_USB_AHB + 0x24)
#define RCAR_GEN2_USB_AHB_BUS_CTR           (RCAR_GEN2_USB_AHB + 0x30)
 #define USB_AHB_BUS_CTR_SMODE_READY_CTR        (1 << 17)
 #define USB_AHB_BUS_CTR_MMODE_HBUSREQ          (1 << 7)
 #define USB_AHB_BUS_CTR_MMODE_WR_INCR          (1 << 2)
 #define USB_AHB_BUS_CTR_MMODE_BYTE_BURST       (1 << 1)
 #define USB_AHB_BUS_CTR_MMODE_HTRANS           (1 << 0)
 #define USB_AHB_BUS_CTR_SET                    (USB_AHB_BUS_CTR_MMODE_HTRANS \
                                                | USB_AHB_BUS_CTR_MMODE_BYTE_BURST \
                                                | USB_AHB_BUS_CTR_MMODE_WR_INCR \
                                                | USB_AHB_BUS_CTR_MMODE_HBUSREQ \
                                                | USB_AHB_BUS_CTR_SMODE_READY_CTR)
#define RCAR_GEN2_USB_AHB_USBCTR            (RCAR_GEN2_USB_AHB + 0x34)
 #define USB_AHB_USBCTR_PCI_AHB_WIN1_SIZE       (3 << 10)
  #define USB_AHB_USBCTR_PCI_AHB_WIN1_SIZE_256MB  (0b00 << 10)
  #define USB_AHB_USBCTR_PCI_AHB_WIN1_SIZE_512MB  (0b01 << 10)
  #define USB_AHB_USBCTR_PCI_AHB_WIN1_SIZE_1GB    (0b10 << 10)
  #define USB_AHB_USBCTR_PCI_AHB_WIN1_SIZE_2GB    (0b11 << 10)
 #define USB_AHB_USBCTR_DIRPD                   (1 << 8)
 #define USB_AHB_USBCTR_PLL_RST                 (1 << 2)
 #define USB_AHB_USBCTR_PCICLK_MASK             (1 << 1)
 #define USB_AHB_USBCTR_USBH_RST                (1 << 0)
#define RCAR_GEN2_USB_AHB_PCI_ARBITER_CTR   (RCAR_GEN2_USB_AHB + 0x40)
...
#define RCAR_GEN2_HSUSB_BASE1            0xE6598000
 ...
 #define RCAR_GEN2_HSUSB_UGCTRL2         0x0184
  #define RCAR_GEN2_HSUSB_USB0SEL         (0x3 << 4)
  #define RCAR_GEN2_HSUSB_USB0SEL_EHCI    (1 << 4)
 ...
 */
#define RCAR_GEN2_PRODUCT_REGISTER       0xFF000044
#define RCAR_GEN2_PRODUCT_ID(x)          ((x & 0x7F00) >> 8)
 #define PRODUCT_ID_RCAR_H2              0b1000101
 #define PRODUCT_ID_RCAR_M2W             0b1000111
 #define PRODUCT_ID_RCAR_M2N             0b1001011
 #define PRODUCT_ID_RCAR_V2H             0b1001010
 #define PRODUCT_ID_RCAR_E2              0b1001100
 #define PRODUCT_ID_RCAR_W2H             0b1010011
#define RCAR_GEN2_PRODUCT_REV(x)         (x & 0xFF)
 #define PRODUCT_REV_ES_1_0              0b00000000
 #define PRODUCT_REV_ES_2_0              0b00010000
 #define PRODUCT_REV_ES_3_0              0b00100000
#define RCAR_GEN2_PRODUCT_CA15EN(x)      ((x >> 27) & 0x1F)
#define RCAR_GEN2_PRODUCT_CA7EN(x)       ((x >> 22) & 0x1F)
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/r-car-gen2.h $ $Rev: 922706 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/r-car-gen2.h $ $Rev: 922706 $" )
#endif
#endif
