...
#define MX6UL_ANATOP_PLL1_SYS_SET                0x04
#define MX6UL_ANATOP_PLL1_SYS_CLR                0x08
#define MX6UL_ANATOP_PLL1_SYS_TOG                0x0C
    #define MX6UL_ANATOP_PLL1_SYS_POWERDOWN           (1 << 12)
    #define MX6UL_ANATOP_PLL1_SYS_ENABLE              (1 << 13)
    #define MX6UL_ANATOP_PLL1_SYS_BYPASS              (1 << 16)
    #define MX6UL_ANATOP_PLL1_SYS_LOCK                (1 << 31)
    #define MX6UL_ANATOP_PLL1_SYS_DIV_MASK            (0x7F)
...
#define MX6UL_CCM_CCSR                           0x0C
    #define MX6UL_CCM_CCSR_PLL1_SW_CLK_SEL                (1 << 2)
    #define MX6UL_CCM_CCSR_SECONDARY_CLK_SEL              (1 << 3)
    #define MX6UL_CCM_CCSR_STEP_SEL                       (1 << 8)
#define MX6UL_CCM_CACRR                          0x10
    #define MX6UL_CCM_CACRR_ARM_PODF_MASK                 (0x7)
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx6ul.h $ $Rev: 920131 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx6ul.h $ $Rev: 920131 $" )
#endif
#endif
