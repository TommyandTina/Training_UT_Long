 ...
 */
#define MX6X_PL310_BASE                         0x00A02000
 ...
 * NIC-301 and NoC bus
 */
#define MX6X_GPV0_FAST_2_BASE                   0x00B00000
#define MX6X_GPV0_FAST_2_SIZE                   0x100000
#define MX6X_GPV1_FAST_1_BASE                   0x00C00000
#define MX6X_GPV1_FAST_1_SIZE                   0x100000
...
#define	MX6_UART_RXDATA			0x00		/* Receiver Register */
#define	MX6_UART_TXDATA			0x40		/* Transmitter Register */
#define	MX6_UART_CR1			0x80		/* Control Register 1 */
#define	MX6_UART_CR2			0x84		/* Control Register 2 */
#define	MX6_UART_CR3			0x88		/* Control Register 3 */
#define	MX6_UART_CR4			0x8C		/* Control Register 4 */
#define	MX6_UART_FCR			0x90		/* FIFO Control Register */
#define	MX6_UART_SR1			0x94		/* Status Register 1 */
#define	MX6_UART_SR2			0x98		/* Status Register 2 */
#define	MX6_UART_ESC			0x9C		/* Escape Character Register */
#define	MX6_UART_TIM			0xA0		/* Escape Timer Register */
#define	MX6_UART_BIR			0xA4		/* BRM Incremental Register */
#define	MX6_UART_BMR			0xA8		/* BRM Modulator Register */
#define	MX6_UART_BRC			0xAC		/* Baud Rate Count Register */
#define	MX6_UART_ONEMS			0xB0		/* contain the value of the UART internal frequency divided by 1000*/
#define	MX6_UART_TS			0xB4		/* Test Register */

/*
 * Receiver Register bits
 */
#define MX6_URXD_CHARRDY       (1<<15)     /* Character Ready */
#define MX6_URXD_ERR           (1<<14)     /* Error Detect */
#define MX6_URXD_OVERRUN       (1<<13)     /* Receiver Overrun */
#define MX6_URXD_FRMERR        (1<<12)     /* Frame Error */
#define MX6_URXD_BRK           (1<<11)     /* BREAK detect */
#define MX6_URXD_PRERR         (1<<10)     /* Parity Error */

/*
 * Control Register 1 bits
 */
#define MX6_UCR1_ADEN          (1<<15)     /* Automatic Baud Rate Detection Interrupt Enable */
#define MX6_UCR1_ADBR          (1<<14)     /* Automatic Detection of Baud Rate */
#define MX6_UCR1_TRDYEN        (1<<13)     /* Transmitter Ready Interrupt Enable */
#define MX6_UCR1_IDEN          (1<<12)     /* Idle Condition Detected Interrupt */
#define MX6_UCR1_ICD_MASK      (3<<10)     /* Idle Condition Detect Mask */
#define MX6_UCR1_RRDYEN        (1<<9)      /* Receiver Ready Interrupt Enable */
#define MX6_UCR1_RDMAEN        (1<<8)      /* Receive Ready DMA Enable */
#define MX6_UCR1_IREN          (1<<7)      /* Infrared Interface Enable */
#define MX6_UCR1_TXMPTYEN      (1<<6)      /* Transmitter Empty Interrupt Enable */
#define MX6_UCR1_RTSDEN        (1<<5)      /* RTS Delta Interrupt Enable */
#define MX6_UCR1_SNDBRK        (1<<4)      /* Send BREAK */
#define MX6_UCR1_TDMAEN        (1<<3)      /* Transmitter Ready DMA Enable */
#define MX6_UCR1_UARTCLKEN     (1<<2)      /* UART Clock Enable */
#define MX6_UCR1_ATDMAEN       (1<<2)      /* Aging timer DMA enable */
#define MX6_UCR1_DOZE          (1<<1)      /* UART DOZE State Control */
#define MX6_UCR1_UARTEN        (1<<0)      /* UART Enable */

/*
 * Control Register 2 bits
 */
#define MX6_UCR2_ESCI          (1<<15)     /* Escape Sequence Interrupt Enable */
#define MX6_UCR2_IRTS          (1<<14)     /* Ignore UART RTS pin */
#define MX6_UCR2_CTSC          (1<<13)     /* UART CTS pin Control */
#define MX6_UCR2_CTS           (1<<12)     /* Clear To Send */
#define MX6_UCR2_ESCEN         (1<<11)     /* Escape Enable */
#define MX6_UCR2_RTEC_MASK     (3<<9)      /* Request to Send Edge Control Mask */
#define MX6_UCR2_PREN          (1<<8)      /* Parity Enable */
#define MX6_UCR2_PROE          (1<<7)      /* Parity Odd/Even */
#define MX6_UCR2_STPB          (1<<6)      /* Stop Bit */
#define MX6_UCR2_WS            (1<<5)      /* Word Size */
#define MX6_UCR2_RTSEN         (1<<4)      /* Request to Send Interrupt Enable */
#define MX6_UCR2_ATEN          (1<<3)      /* Aging timer interrupt enable */
#define MX6_UCR2_TXEN          (1<<2)      /* Transmitter Enable */
#define MX6_UCR2_RXEN          (1<<1)      /* Receiver Enable */
#define MX6_UCR2_SRST          (1<<0)      /* Software Reset */

/*
 * Control Register 3 bits
 */
#define MX6_UCR3_DPEC_MASK     (3<<14)     /* DTR Interrupt Edge Control */
#define MX6_UCR3_DTREN         (1<<13)     /* Data Terminal Ready Interrupt Enable */
#define MX6_UCR3_PARERREN      (1<<12)     /* Parity Error Interrupt Enable */
#define MX6_UCR3_FRAERREN      (1<<11)     /* Frame Error Interrupt Enable */
#define MX6_UCR3_DSR           (1<<10)     /* Data Set Ready */
#define MX6_UCR3_DCD           (1<<9)      /* Data Carrier Detect */
#define MX6_UCR3_RI            (1<<8)      /* Ring Indicator */
#define MX6_UCR3_RXDSEN        (1<<6)      /* Receive Status Interrupt Enable */
#define MX6_UCR3_AIRINTEN      (1<<5)      /* Asynchronous IR WAKE Interrupt Enable */
#define MX6_UCR3_AWAKEN        (1<<4)      /* Asynchronous WAKE Interrupt Enable */
#define MX6_UCR3_REF25         (1<<3)      /* Reference Frequency 25 MHz */
#define MX6_UCR3_REF20         (1<<2)      /* Reference Frequency 30 MHz */
#define MX6_UCR3_INVT          (1<<1)      /* Inverted Infrared Transmission */
#define MX6_UCR3_BPEN          (1<<0)      /* Preset Registers Enable */

/*
 * Control Register 4 bits
 */
#define MX6_UCR4_CTSTL_MASK    (0x3F<<10)  /* CTS Trigger Level (0-32)*/
#define MX6_UCR4_INVR          (1<<9)      /* Inverted Infrared Reception */
#define MX6_UCR4_ENIRI         (1<<8)      /* Serial Infrared Interrupt Enable */
#define MX6_UCR4_WKEN          (1<<7)      /* WAKE Interrupt Enable */
#define MX6_UCR4_REF16         (1<<6)      /* Reference Frequency 16 MHz */
#define MX6_UCR4_IRSC          (1<<5)      /* IR Special Case */
#define MX6_UCR4_TCEN          (1<<3)      /* Transmit Complete Interrupt Enable */
#define MX6_UCR4_BKEN          (1<<2)      /* BREAK Condition Detected Interrupt Enable */
#define MX6_UCR4_OREN          (1<<1)      /* Receive Overrun Interrupt Enable */
#define MX6_UCR4_DREN          (1<<0)      /* Receive Data Ready Interrupt Enable */

#define MX6_UFCR_RFDIV_2       (4<<7)      /* Reference freq divider (div 2) */
#define MX6_UFCR_RFDIV_7       (6<<7)      /* Reference freq divider (div 7) */
#define MX6_UFCR_RFDIV_SHIFT   7
#define MX6_UFCR_DCEDTE        (1<<6)
#define MX6_UFCR_RXTL_SHIFT    0
#define MX6_UFCR_RXTL_MASK     (0x3F<<0)   /* Receive Trigger Level Mask */
#define MX6_UFCR_TXTL_SHIFT    10
#define MX6_UFCR_TXTL_MASK     (0x3F<<10)  /* Receive Trigger Level Mask */

/*
 * Status Register 1 bits
 */
#define MX6_USR1_PARITYERR     (1<<15)     /* Parity Error Interrupt Flag */
#define MX6_USR1_RTSS          (1<<14)     /* RTS Pin Status */
#define MX6_USR1_TRDY          (1<<13)     /* Transmitter Ready Interrupt/DMA Flag */
#define MX6_USR1_RTSD          (1<<12)     /* RTS Delta */
#define MX6_USR1_ESCF          (1<<11)     /* Escape Sequence Interrupt Flag */
#define MX6_USR1_FRAMERR       (1<<10)     /* Frame Error Interrupt Flag */
#define MX6_USR1_RRDY          (1<<9)      /* Receiver Ready Interrupt/DMA Flag */
#define MX6_USR1_AGTIM         (1<<8)      /* Ageing Timer Interrupt Flag */
#define MX6_USR1_RXDS          (1<<6)      /* Receiver IDLE Interrupt Flag */
#define MX6_USR1_AIRINT        (1<<5)      /* Asynchronous IR WAKE Interrupt Flag */
#define MX6_USR1_AWAKE         (1<<4)      /* Asynchronous WAKE Interrupt Flag */

/*
 * Status Register 2 bits
 */
#define MX6_USR2_ADET          (1<<15)     /* Automatic Baud Rate Detect Complete */
#define MX6_USR2_TXFE          (1<<14)     /* Transmit Buffer FIFO Empty */
#define MX6_USR2_DTRF          (1<<13)     /* DTR Edge Triggered Interrupt Flag */
#define MX6_USR2_IDLE          (1<<12)     /* IDLE Condition */
#define MX6_USR2_IRINT         (1<<8)      /* Serial Infrared Interrupt Flag */
#define MX6_USR2_WAKE          (1<<7)      /* WAKE */
#define MX6_USR2_DCDDELT       (1<<6)      /* Data Carrier Detect delta */
#define MX6_USR2_DCDIN         (1<<5)      /* Data Carrier Detect input */
#define MX6_USR2_RTSF          (1<<4)      /* RTS Edge Triggered Interrupt Flag */
#define MX6_USR2_TXDC          (1<<3)      /* Transmitter Complete */
#define MX6_USR2_BRCD          (1<<2)      /* BREAK Condition Detected */
#define MX6_USR2_ORE           (1<<1)      /* Overrun Error */
#define MX6_USR2_RDR           (1<<0)      /* Receive Data Ready */

/*
 * BRM Incremental register bits
 */
#define MX6_BIR_INC_AUTO       0x000F

/*
 * Test register bits
 */
#define MX6_UTS_FRCPERR        (1<<13)
#define MX6_UTS_LOOP           (1<<12)
#define MX6_UTS_DBGEN          (1<<11)
#define MX6_UTS_LOOPIR         (1<<10)
#define MX6_UTS_RXDBG          (1<<9)
#define MX6_UTS_TXEMPTY        (1<<6)
#define MX6_UTS_RXEMPTY        (1<<5)
#define MX6_UTS_TXFULL         (1<<4)
#define MX6_UTS_RXFULL         (1<<3)
#define MX6_UTS_SOFTRST        (1<<0)
...
#define MX6X_ANATOP_PLL5_VIDEO_SET              0xA4
#define MX6X_ANATOP_PLL5_VIDEO_CLR              0xA8
...
#define MX6X_ANATOP_PFD_480_TOG                 0xFC
#define MX6X_ANATOP_PFD_528                     0x100
#define MX6X_ANATOP_PFD_528_SET                 0x104
#define MX6X_ANATOP_PFD_528_CLR                 0x108
#define MX6X_ANATOP_PFD_528_TOG                 0x10c
#define MX6X_ANATOP_MISC2                       0x170
#define MX6X_ANATOP_PFD0_OFFSET					0
#define MX6X_ANATOP_PFD0_MASK					(0x3f << MX6X_ANATOP_PFD0_OFFSET)
#define MX6X_ANATOP_PFD1_OFFSET					8
#define MX6X_ANATOP_PFD1_MASK					(0x3f << MX6X_ANATOP_PFD1_OFFSET)
#define MX6X_ANATOP_PFD2_OFFSET					16
#define MX6X_ANATOP_PFD2_MASK					(0x3f << MX6X_ANATOP_PFD2_OFFSET)
#define MX6X_ANATOP_PFD3_OFFSET					24
#define MX6X_ANATOP_PFD3_MASK					(0x3f << MX6X_ANATOP_PFD3_OFFSET)
#define MX6X_ANATOP_PFD0_GATE					7
#define MX6X_ANATOP_PFD1_GATE					15
#define MX6X_ANATOP_PFD2_GATE					23
#define MX6X_ANATOP_PFD3_GATE					31
#define MX6X_ANATOP_PFD_ALL_CLOCK_GATES         0x80808080
...
/* VIDEO PLL (PLL5) offsets */
#define ANATOP_PLL5_LOCK                        (1 << 31)
#define ANATOP_PLL5_BYPASS                      (1 << 16)
#define ANATOP_PLL5_ENABLE                      (1 << 13)
#define ANATOP_PLL5_POWERDOWN                   (1 << 12)
...
#define MX6X_ANADIG_REG_1P1                     0x110
#define MX6X_ANADIG_REG_CORE                    0x140
#define MX6X_ANADIG_MISC1                       0x160
#define MX6X_ANADIG_MISC2                       0x170
...
/* Register offsets */
#define MX6X_ECSPI_RXDATA                       0x00
#define MX6X_ECSPI_TXDATA                       0x04
#define MX6X_ECSPI_CONREG                       0x08
#define MX6X_ECSPI_CONFIGREG                    0x0C
#define MX6X_ECSPI_INTREG                       0x10
#define MX6X_ECSPI_DMAREG                       0x14
#define MX6X_ECSPI_STATREG                      0x18
#define MX6X_ECSPI_PERIODREG                    0x1C
#define MX6X_ECSPI_TESTREG                      0x20
#define MX6X_ECSPI_MSGDATA                      0x40

/*
 * PCIe controller register base address
 */
#define MX6X_PCIE_REG_BASE                      0x1FFC000
...
#define AUDMUX_RXDSEL_PORT3                     (2<<13)
#define AUDMUX_RXDSEL_PORT4                     (3<<13)
#define AUDMUX_RXDSEL_PORT5                     (4<<13)
#define AUDMUX_RXDSEL_PORT6                     (5<<13)
#define AUDMUX_RXDSEL_PORT7                     (6<<13)
...
#define MX6X_CCM_CBCMR                          0x18
	...
	#define MX6X_CCM_CBCMR_GPU3D_AXI_CLK_SEL_MASK       (0x1 << 1)
 	#define MX6X_CCM_CBCMR_GPU3D_AXI_CLK_SEL_OFFSET     (1)
	#define MX6X_CCM_CBCMR_GPU2D_AXI_CLK_SEL_MASK       (0x1 << 0)
	#define MX6X_CCM_CBCMR_GPU2D_AXI_CLK_SEL_OFFSET     (0)
...
/* NOTE BEGIN: iMX6QP processor expanded the size of ENFC_CLK_SEL */
    #define MX6X_CCM_CS2CDR_ENFC_CLK_SEL_MASK        	(0x3 << 16)
    #define MX6X_CCM_CS2CDR_ENFC_CLK_SEL_OFFSET      	(16)
    #define MX6X_CCM_CS2CDR_ENFC_CLK_SEL_MASK_V2_0     	(0x7 << 15)
    #define MX6X_CCM_CS2CDR_ENFC_CLK_SEL_OFFSET_V2_0   	(15)
/* NOTE END */
...
#define MX6X_CCM_CDCDR                          0x30
    #define MX6X_CCM_CDCDR_SPDIF1_CLK_PODF_MASK		(0x7 << 9)
    #define MX6X_CCM_CDCDR_SPDIF1_CLK_PODF_OFFSET	(9)
    #define MX6X_CCM_CDCDR_SPDIF0_CLK_SEL_MASK		(0x3 << 20)
    #define MX6X_CCM_CDCDR_SPDIF0_CLK_SEL_OFFSET	(20)
...
#define MX6X_CCM_CSCDR3                         0x3c
 	// IPU2 registers only available on i.MX6 Dual, i.MX6 Quad
  	#define MX6X_CCM_CSCDR3_IPU2_HSP_PODF_MASK          (0x7 << 16)
 	#define MX6X_CCM_CSCDR3_IPU2_HSP_PODF_OFFSET        (16)
 	#define MX6X_CCM_CSCDR3_IPU2_HSP_CLK_SEL_MASK       (0x3 << 14)
 	#define MX6X_CCM_CSCDR3_IPU2_HSP_CLK_SEL_OFFSET     (14)
  	#define MX6X_CCM_CSCDR3_IPU1_HSP_PODF_MASK          (0x7 << 11)
 	#define MX6X_CCM_CSCDR3_IPU1_HSP_PODF_OFFSET        (11)
 	#define MX6X_CCM_CSCDR3_IPU1_HSP_CLK_SEL_MASK       (0x3 << 9)
 	#define MX6X_CCM_CSCDR3_IPU1_HSP_CLK_SEL_OFFSET     (9)
...
#define MX6X_CCM_CCOSR                          0x60
        #define MX6X_CCM_CCOSR_CLKO2_EN                     (0x1 << 24)
        #define MX6X_CCM_CCOSR_CLKO2_DIV_MASK               (0x7 << 21)
        #define MX6X_CCM_CCOSR_CLKO2_SEL_MASK               (0x1F<< 16)
        #define MX6X_CCM_CCOSR_CLK_OUT_SEL_CLKO1            (0x0 << 8)
        #define MX6X_CCM_CCOSR_CLK_OUT_SEL_CLKO2            (0x1 << 8)
        #define MX6X_CCM_CCOSR_CLK_OUT_SEL_MASK             (0x1 << 8)
        #define MX6X_CCM_CCOSR_CLKO1_EN                     (0x1 << 7)
        #define MX6X_CCM_CCOSR_CLKO1_DIV_MASK               (0x7 << 4)
        #define MX6X_CCM_CCOSR_CLKO1_SEL_CKIL               (0xE)
        #define MX6X_CCM_CCOSR_CLKO1_SEL_MASK               (0xF)
...
/*
 * Note that based on the i.MX6 DQ and SDL Reference Manuals, CSCMR2 register's esai_clk_sel
 * can only be set to 454M_PFD on the i.MX6 D/Q (i.e. the Solo/DualLite chips cannot use this clock source).
 */
#define CSCMR2_ESAI_CLK_SEL_PLL4           (0x0 << MX6X_CCM_CSCMR2_ESAI_CLK_SEL_OFFSET)
#define CSCMR2_ESAI_CLK_SEL_508M_PFD       (0x1 << MX6X_CCM_CSCMR2_ESAI_CLK_SEL_OFFSET)
#define CSCMR2_ESAI_CLK_SEL_454M_PFD_ON_DQ (0x2 << MX6X_CCM_CSCMR2_ESAI_CLK_SEL_OFFSET)
#define CSCMR2_ESAI_CLK_SEL_PLL3           (0x3 << MX6X_CCM_CSCMR2_ESAI_CLK_SEL_OFFSET)

/*
 * Values passed to SSI and ESAI clock divisor macros should be the exact
...
#define ESAI_CLK_DIV_MASK                       ((0x7 << 9) | (0x7 << 25))
#define ESAI_CLK_PRED(x)                        ((x - 1) << 9)
#define ESAI_CLK_PODF(x)                        ((x - 1) << 25)
...
#define MX6X_I2C4_BASE                          0x021F8000	// only available on i.MX6 Solo

#define MX6X_I2C1_IRQ                           68
#define MX6X_I2C2_IRQ                           69
#define MX6X_I2C3_IRQ                           70
#define MX6X_I2C4_IRQ                           67	// only available on i.MX6 Solo
...
/*
 * i.MX6 UltraLite has different IOMUX register offsets
 * than i.MX6 Solo/Dual/Quad/...
 */
...
#define MX6X_TZASC1                            0x021D0000
#define MX6X_TZASC2                            0x021D4000
...
/* Bits */
#define SET_MX6X_EPIT_CLKSRC_PCLK   (1)
#define SET_MX6X_EPIT_LR       (0x0FF00000)

#define  MX6X_EPIT_CR_CLKSRC(x) (x << 24 )
#define  MX6X_EPIT_CR_IOVW      (1 << 17 )
#define  MX6X_EPIT_CR_RLD       (1 << 3 )
#define  MX6X_EPIT_CR_OCIEN     (1 << 2 )
#define  MX6X_EPIT_CR_ENMOD     (1 << 1 )
#define  MX6X_EPIT_CR_EN        (1 << 0 )
...
#define MX6X_SDRAM_UTRA_LITE_BASE               0x80000000
...
#define MX6X_IPU1_BASE                          0x02600000

#define MX6X_IPU1_ERR_IRQ                       37
#define MX6X_IPU1_SYNC_IRQ                      38
#define MX6X_IPU2_BASE                          0x02A00000
 ...
 * GPC
 */
#define MX6X_GPC_BASE                           0x020DC000

#define MX6X_GPC_CNTR                           0x00
#define MX6X_GPC_PGR                            0x04
#define MX6X_GPC_IMR1                           0x08
#define MX6X_GPC_IMR2                           0x0C
#define MX6X_GPC_IMR3                           0x10
#define MX6X_GPC_IMR4                           0x14
#define MX6X_GPC_ISR1                           0x18
#define MX6X_GPC_ISR2                           0x1C
#define MX6X_GPC_ISR3                           0x20
#define MX6X_GPC_ISR4                           0x24
#define MX6X_GPC_GPU_CTRL                       0x260
...
#define MX6X_SRC_GPR10                          0x044
	#define SRC_GPR10_PERSIST_SECONDARY_BOOT (1 << 30)
	#define SRC_GPR10_PERSIST_BLOCK_REWRITE  (1 << 29)
	#define SRC_GPR10_CPU3_ERROR_STATUS      (1 << 27)    /* i.MX6 Quad only */
	#define SRC_GPR10_CPU2_ERROR_STATUS      (1 << 26)    /* i.MX6 Quad only */
	#define SRC_GPR10_CPU1_ERROR_STATUS      (1 << 25)
 ...
 * PWM
 */
#define MX6X_PWM2_REG_BASE                0x2084000

/* registers off set from base */
#define MX6X_PWM2_PWMCR                   0x00 /* PWM2 Control Register */
#define MX6X_PWM2_PWMSAR                  0x0C /* PWM2 Sample Register */
#define MX6X_PWM2_PWMPR                   0x10 /* PWM2 Period Register */

/* bits */
#define MX6X_PWM_DISABLE             0x00
#define MX6X_PWM_ENABLE              0x01
#define MX6X_PWM_CLK                 0x10000
#define MX6X_PWM_PERIOD              0xFF
#define MX6X_PWM_MAX_SETTING         0xFF
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx6x.h $ $Rev: 870901 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/arm/mx6x.h $ $Rev: 870901 $" )
#endif
#endif
