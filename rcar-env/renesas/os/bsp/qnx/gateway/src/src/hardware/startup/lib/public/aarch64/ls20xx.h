...
#define LS20XX_DRAM_REGION1_BASE        0x80000000
#define LS20XX_DRAM_REGION1_SIZE        GIG(2)
#define LS20XX_DRAM_REGION2_BASE        0x8080000000
#define LS20XX_DRAM_REGION2_SIZE        GIG(510)
#define LS20XX_DRAM_SIZE_MAX            (LS20XX_DRAM_REGION1_SIZE + LS20XX_DRAM_REGION2_SIZE)
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/aarch64/ls20xx.h $ $Rev: 939435 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/aarch64/ls20xx.h $ $Rev: 939435 $" )
#endif
#endif
