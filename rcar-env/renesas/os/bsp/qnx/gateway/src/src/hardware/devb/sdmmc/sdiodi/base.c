		...
		switch( opt ) {
			...
			case OPTION_BUS_SMART:		// timing
				...
				while( value != NULL ) {
					...
					else if( !strcmp( value, "ddr" ) )		*cap |= HC_CAP_DDR50 | HC_CAP_HS;
					...
					else if( !strcmp( value, "hs400es" ) )  *cap |= HC_CAP_HS400ES;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/devb/sdmmc/sdiodi/base.c $ $Rev: 956072 $")
#endif
