...
#define DEV_CAP_HS400ES			(1 << 18)	/* high speed 400 enhanced strobe */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/devb/sdmmc/public/hw/dcmd_sim_sdmmc.h $ $Rev: 908543 $")
#endif
