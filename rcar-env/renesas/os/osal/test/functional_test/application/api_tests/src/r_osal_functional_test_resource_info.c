 ...
 *           2.0.1     08.11.2021    Update Interrupt inforamtion
 *           3.0.0     19.04.2021    Update Interrupt inforamtion for eMCOS
 *           3.1.0     19.04.2021    Update include path for eMCOS
 *           3.2.0     11.09.2023    Add definition of V4M
***********************************************************************************************************************/
...
***********************************************************************************************************************/
#ifndef TEST_LINUX
const st_osal_device_pm_config_t g_osal_device_pm_config =
{
    .task_priority =            (uint32_t)OSAL_THREAD_PRIORITY_HIGHEST,
    .timeout_ms =               OSAL_DCFG_PM_TIMEOUT,
    .polling_max_num =          OSAL_DCFG_PM_POLLING_MAX_NUM,
    .loop_num_for_rclk_cycle =  OSAL_DCFG_PM_LOOP_NUM_FOR_RCLK_CYCLE
};
#endif
...
const st_osal_mmngr_region_info_list_t g_osal_memory_region_info_list =
{
    ...
    .p_info = (st_osal_mmngr_region_info_t[])
    {
        ...
        {
            .name = "sysram&below4G",      /* The defult region requires "below 4G area" */
            .offset = 0,
            .range = (512U * 1024U * 1024U)
        },
        /* Memory region 1 */ /* example */
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    {225, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task025",           0x0400,      60000000},
    {226, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task026",           0x0400,      60000000},
    {227, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task027",           0x0400,      60000000},
    {228, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task028",           0x0400,      60000000},
    {229, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task029",           0x0400,      60000000},
    {230, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task030",           0x0400,      60000000},
    {231, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task031",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    {322, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task079",           0x0400,      60000000},
    {324, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task080",           0x0400,      60000000},
    {326, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task081",           0x0400,      60000000},
    {328, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task082",           0x0400,      60000000},
    {330, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task083",           0x0400,      60000000},
    {332, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task084",           0x0400,      60000000},
    {334, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task085",           0x0400,      60000000},
    {336, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task086",           0x0400,      60000000},
    {338, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task087",           0x0400,      60000000},
    {340, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task088",           0x0400,      60000000},
    {342, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task089",           0x0400,      60000000},
    {344, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task090",           0x0400,      60000000},
    {346, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task091",           0x0400,      60000000},
    {348, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task092",           0x0400,      60000000},
    {350, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task093",           0x0400,      60000000},
    {354, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task094",           0x0400,      60000000},
    {356, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task095",           0x0400,      60000000},
    {358, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task096",           0x0400,      60000000},
    {360, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task097",           0x0400,      60000000},
    {362, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task098",           0x0400,      60000000},
    {364, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task099",           0x0400,      60000000},
    {366, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task100",           0x0400,      60000000},
    {368, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task101",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    {125, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task037",           0x1000,      60000000},
    {127, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task038",           0x1000,      60000000},
    {129, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task039",           0x1000,      60000000},
    {131, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task040",           0x1000,      60000000},
    {133, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task041",           0x1000,      60000000},
    {135, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task042",           0x1000,      60000000},
    {137, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task043",           0x1000,      60000000},
    {916, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task044",           0x1000,      60000000},
    {918, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task045",           0x1000,      60000000},
    {920, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task046",           0x1000,      60000000},
    {922, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task047",           0x1000,      60000000},
