...
* Product Name : OSAL
* Device(s) :    R-Car
* Description :  OSAL resource configuration file for Zephyr
***********************************************************************************************************************/
...
#endif /* defined(CONFIG_ADDR_STACK) */
...
const st_osal_rcfg_thread_config_t g_osal_thread_config[] =
{
...
#if defined(ENABLE_RESOURCE_ICCOM)
    {OSAL_THREAD_ICCOM_DEMO_TASK,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom demor task",    OSAL_THREAD_STACK_SIZE_ICCOM_DEMO},      },
    {OSAL_THREAD_ICCOM_MGR_TASK,    {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom manager task",  OSAL_THREAD_STACK_SIZE_ICCOM_MGR},       },
    {OSAL_THREAD_ICCOM_TIMER_TASK,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom timer task",    OSAL_THREAD_STACK_SIZE_ICCOM_TIMER},     },
    {OSAL_THREAD_ICCOM_RCV_TASK0,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task0", OSAL_THREAD_STACK_SIZE_ICCOM_RCV0},      },
    {OSAL_THREAD_ICCOM_RCV_TASK1,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task1", OSAL_THREAD_STACK_SIZE_ICCOM_RCV1},      },
    {OSAL_THREAD_ICCOM_RCV_TASK2,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task2", OSAL_THREAD_STACK_SIZE_ICCOM_RCV2},      },
    {OSAL_THREAD_ICCOM_RCV_TASK3,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task3", OSAL_THREAD_STACK_SIZE_ICCOM_RCV3},      },
    {OSAL_THREAD_ICCOM_RCV_TASK4,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task4", OSAL_THREAD_STACK_SIZE_ICCOM_RCV4},      },
    {OSAL_THREAD_ICCOM_RCV_TASK5,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task5", OSAL_THREAD_STACK_SIZE_ICCOM_RCV5},      },
    {OSAL_THREAD_ICCOM_RCV_TASK6,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task6", OSAL_THREAD_STACK_SIZE_ICCOM_RCV6},      },
    {OSAL_THREAD_ICCOM_RCV_TASK7,   {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom receive task7", OSAL_THREAD_STACK_SIZE_ICCOM_RCV7},      },
    {OSAL_THREAD_ICCOM_READ_TASK0,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task0",    OSAL_THREAD_STACK_SIZE_ICCOM_READ0},     },
    {OSAL_THREAD_ICCOM_READ_TASK1,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task1",    OSAL_THREAD_STACK_SIZE_ICCOM_READ1},     },
    {OSAL_THREAD_ICCOM_READ_TASK2,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task2",    OSAL_THREAD_STACK_SIZE_ICCOM_READ2},     },
    {OSAL_THREAD_ICCOM_READ_TASK3,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task3",    OSAL_THREAD_STACK_SIZE_ICCOM_READ3},     },
    {OSAL_THREAD_ICCOM_READ_TASK4,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task4",    OSAL_THREAD_STACK_SIZE_ICCOM_READ4},     },
    {OSAL_THREAD_ICCOM_READ_TASK5,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task5",    OSAL_THREAD_STACK_SIZE_ICCOM_READ5},     },
    {OSAL_THREAD_ICCOM_READ_TASK6,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task6",    OSAL_THREAD_STACK_SIZE_ICCOM_READ6},     },
    {OSAL_THREAD_ICCOM_READ_TASK7,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom read task7",    OSAL_THREAD_STACK_SIZE_ICCOM_READ7},     },
    {OSAL_THREAD_ICCOM_SEND_TASK0,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task0",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND0},     },
    {OSAL_THREAD_ICCOM_SEND_TASK1,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task1",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND1},     },
    {OSAL_THREAD_ICCOM_SEND_TASK2,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task2",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND2},     },
    {OSAL_THREAD_ICCOM_SEND_TASK3,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task3",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND3},     },
    {OSAL_THREAD_ICCOM_SEND_TASK4,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task4",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND4},     },
    {OSAL_THREAD_ICCOM_SEND_TASK5,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task5",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND5},     },
    {OSAL_THREAD_ICCOM_SEND_TASK6,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task6",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND6},     },
    {OSAL_THREAD_ICCOM_SEND_TASK7,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "iccom send task7",    OSAL_THREAD_STACK_SIZE_ICCOM_SEND7},     },
#endif /* defined(ENABLE_RESOURCE_ICCOM) */
#if defined(ENABLE_RESOURCE_IMP)
    {OSAL_THREAD_IMP_RTT_DRV,       {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "imp rtt drv task",    OSAL_THREAD_STACK_SIZE_IMP_RTT_DRV},     },
    {OSAL_THREAD_IMP_DRV,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "imp drv task",        OSAL_THREAD_STACK_SIZE_IMP_DRV},         },
    ...
    {OSAL_THREAD_IMPFW_APP_TASK00,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "impfw_app_task00",    OSAL_THREAD_STACK_SIZE_IMPFW_APP0},      },
    {OSAL_THREAD_IMPFW_APP_TASK01,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "impfw_app_task01",    OSAL_THREAD_STACK_SIZE_IMPFW_APP1},      },
    {OSAL_THREAD_IMPFW_APP_TASK02,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "impfw_app_task02",    OSAL_THREAD_STACK_SIZE_IMPFW_APP2},      },
    {OSAL_THREAD_IMPFW_APP_TASK03,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "impfw_app_task03",    OSAL_THREAD_STACK_SIZE_IMPFW_APP3},      },
    {OSAL_THREAD_IMPFW_APP_TASK04,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "impfw_app_task04",    OSAL_THREAD_STACK_SIZE_IMPFW_APP4},      },
    {OSAL_THREAD_IMPFW_APP_TASK05,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "impfw_app_task05",    OSAL_THREAD_STACK_SIZE_IMPFW_APP5},      },
    {OSAL_THREAD_IMPFW_APP_TASK06,  {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE10, "impfw_app_task06",    OSAL_THREAD_STACK_SIZE_IMPFW_APP6},      },
#endif /* defined(ENABLE_RESOURCE_IMP) */
#if defined(ENABLE_RESOURCE_RTT)
...
#if defined(ENABLE_RESOURCE_OSAL)
    {OSAL_THREAD_OSAL_00,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE14, "osal_task01",         OSAL_THREAD_STACK_SIZE_OSAL00},          },
...
const st_osal_mq_rcfg_config_t g_osal_mq_config[] =
{
    ...
    {OSAL_MQ_OSAL_04,                        {10, 4}  },
    {OSAL_MQ_OSAL_05,                        {10, 4}  },
    {OSAL_MQ_OSAL_06,                        {10, 4}  },
    {OSAL_MQ_OSAL_07,                        {10, 4}  },
    {OSAL_MQ_OSAL_08,                        {10, 4}  },
    {OSAL_MQ_OSAL_09,                        {1, 4}  },
    {OSAL_MQ_OSAL_10,                        { 1,  4}  },
