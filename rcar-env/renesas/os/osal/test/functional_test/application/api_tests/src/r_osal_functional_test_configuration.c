 ...
 *           3.1.0     21.11.2022    Update for Linux configurator
 *           3.2.0     20.01.2023    Update resource information of interrupt thread for ICCOM
 *           3.3.0     23.01.2023    Update for QNX configurator
 *           3.4.0     21.02.2023    Add definition of S4N
 *           3.5.0     11.09.2023    Add definition of V4M
***********************************************************************************************************************/
...
#elif defined(RCAR_V4H) || defined(OSAL_SOC_V4M)     /* V4H */
/* PRQA S 1531 1 # It must be external linkage separately from the referenced file because of the object to be exposed to the user. */
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    /* irq, device_id               interrupt priority            task_name,              stack_size,  interrupt_timeout */
