...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name :    io_perf_device_definition_v4h.h
* Version :      3.0.0
* Product Name : OSAL
* Device(s) :    R-Car
* Description :  Header IO Device definition on v4h
***********************************************************************************************************************/
/***********************************************************************************************************************
 * History   Version   DD.MM.YYYY    Description
 *           3.0.0     13.06.2023    Create New
***********************************************************************************************************************/
#ifndef OSAL_PERF_IO_DEVICE_DEFINITION_V4H_H_
#define OSAL_PERF_IO_DEVICE_DEFINITION_V4H_H_
...
#define TEST_AXI_BUS_NAME                 "vc_00-02_04-06_08-09"
#define TEST_NUM_OF_AXI_ID                8U
