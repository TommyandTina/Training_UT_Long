...
#elif defined(OSAL_SOC_V4H) || defined(OSAL_SOC_V3U) || defined(OSAL_SOC_V3H1) || defined(OSAL_SOC_V3H2) || defined(OSAL_SOC_V3M2) || defined(OSAL_SOC_V4M) /* R-Car V3x, V4H, V4M */
