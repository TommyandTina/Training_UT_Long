...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name :    r_osal_dev_cfg_v3m.h
* Version :      0.1.0
* Product Name : OSAL
* Device(s) :    R-Car V3M
* Description :  OSAL device configuration file for R-Car V3M
***********************************************************************************************************************/
#ifndef OSAL_DEV_CFG_V3M_H
#define OSAL_DEV_CFG_V3M_H
...
***********************************************************************************************************************/
static st_osal_interrupt_info_t gs_int_isp_cisp[1][1] =
{
    {
        {26}
    }
 ...
 * osal device configuration : ISP interrupt
***********************************************************************************************************************/
static st_osal_interrupt_info_t gs_int_isp_tisp[1][1] =
{
    {
        {25}
    }
...
st_osal_device_info_t gs_osal_device_info[] =
{
    ...
    /* IMR */
    {"ims_00",                "ims",               0xFE860000U, 0x00002000U, gs_int_ims[0],           1U, R_PMA_HWA_ID_IMR_LX4_CH0,   OSAL_PM_POLICY_CG,       "vi0",         NULL},
    {"ims_01",                "ims",               0xFE870000U, 0x00002000U, gs_int_ims[1],           1U, R_PMA_HWA_ID_IMR_LX4_CH1,   OSAL_PM_POLICY_CG,       "vi0",         NULL},
    {"ims_02",                "ims",               0xFE880000U, 0x00002000U, gs_int_ims[2],           1U, R_PMA_HWA_ID_IMR_LX4_CH2,   OSAL_PM_POLICY_CG,       "vi0",         NULL},
    {"ims_03",                "ims",               0xFE890000U, 0x00002000U, gs_int_ims[3],           1U, R_PMA_HWA_ID_IMR_LX4_CH3,   OSAL_PM_POLICY_CG,       "vi0",         NULL},
    ...
    {"imp_spmi_00",           "imp_spmi",          0xED000000U, 0x000E0000U, NULL,                    0U, R_PMA_HWA_ID_IMP_SPMI0_00,  OSAL_PM_POLICY_CG,       "ir",          NULL},

    /* ISP */
    {"cisp_00",               "cisp",              0xFEC00000U, 0x00100000U, gs_int_isp_cisp[0],      1U, R_PMA_HWA_ID_ISP_CORE0,     OSAL_PM_POLICY_CG,       "vi0",         NULL},
    {"tisp_00",               "tisp",              0xFED00000U, 0x00020000U, gs_int_isp_tisp[0],      1U, R_PMA_HWA_ID_ISP_TISP0,     OSAL_PM_POLICY_CG,       "vi0",         NULL},

    /* FieldBIST */
    {"fbc_00",                "fbc",               0xFF830000U, 0x00002000U, gs_int_fbc,              2U, R_PMA_HWA_ID_FBC,           OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"fba_ims_00",            "fba_ims",           0xFFF80000U, 0x00001000U, NULL,                    0U, R_PMA_HWA_ID_FBA_IMS0,      OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"fba_ims_01",            "fba_ims",           0xFFF90000U, 0x00001000U, NULL,                    0U, R_PMA_HWA_ID_FBA_IMS1,      OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    ...
    {"fba_imp_dp_00",         "fba_imp_dp",        0xFFF60000U, 0x00001000U, NULL,                    0U, R_PMA_HWA_ID_FBA_DP0,       OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"fba_imp_cnn_00",        "fba_imp_cnn",       0xFFF70000U, 0x00001000U, NULL,                    0U, R_PMA_HWA_ID_FBA_CNN0,      OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
/* TODO: Unnecessary?
...
*/
    ...
    /* RTT */
    {"rfso_000",              "rfso",              0xFFE80000U, 0x00001000U, gs_int_rtt[0],           1U, R_PMA_HWA_ID_RFSO0,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_001",              "rfso",              0xFFE81000U, 0x00001000U, gs_int_rtt[1],           1U, R_PMA_HWA_ID_RFSO1,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_002",              "rfso",              0xFFE82000U, 0x00001000U, gs_int_rtt[2],           1U, R_PMA_HWA_ID_RFSO2,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_003",              "rfso",              0xFFE83000U, 0x00001000U, gs_int_rtt[3],           1U, R_PMA_HWA_ID_RFSO3,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_004",              "rfso",              0xFFE84000U, 0x00001000U, gs_int_rtt[4],           1U, R_PMA_HWA_ID_RFSO4,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_005",              "rfso",              0xFFE85000U, 0x00001000U, gs_int_rtt[5],           1U, R_PMA_HWA_ID_RFSO5,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_006",              "rfso",              0xFFE86000U, 0x00001000U, gs_int_rtt[6],           1U, R_PMA_HWA_ID_RFSO6,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_007",              "rfso",              0xFFE87000U, 0x00001000U, gs_int_rtt[7],           1U, R_PMA_HWA_ID_RFSO7,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_008",              "rfso",              0xFFE88000U, 0x00001000U, gs_int_rtt[8],           1U, R_PMA_HWA_ID_RFSO8,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_009",              "rfso",              0xFFE89000U, 0x00001000U, gs_int_rtt[9],           1U, R_PMA_HWA_ID_RFSO9,         OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"rfso_010",              "rfso",              0xFFE8A000U, 0x00001000U, gs_int_rtt[10],          1U, R_PMA_HWA_ID_RFSO10,        OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
