...
***********************************************************************************************************************/
static st_osal_interrupt_info_t gs_int_ims[3][1] =
{
    {
        {192}
    },
...
st_osal_device_info_t gs_osal_device_info[] =
{
    ...
    /* VISIONIP */
    {"dof_00",                "dof",               0xE7A10000U, 0x00010000U, gs_int_dof[0],           2U, R_PMA_HWA_ID_VIP_UMFL0,     OSAL_PM_POLICY_CG,       "vip1",        NULL},
    ...
    {"imp_dma_00",            "imp_dma",           0xFFA10000U, 0x00004000U, NULL,                    0U, R_PMA_HWA_ID_IMP_DMAC0,     OSAL_PM_POLICY_CG,       "ir",          NULL},
    {"imp_dma_01",            "imp_dma",           0xFFA14000U, 0x00004000U, NULL,                    0U, R_PMA_HWA_ID_IMP_DMAC1,     OSAL_PM_POLICY_CG,       "ir",          NULL},
    {"imp_dma_slim_00",       "imp_dma_slim",      0xFFA18000U, 0x00004000U, NULL,                    0U, R_PMA_HWA_ID_IMP_DMAC_SLIM0, OSAL_PM_POLICY_CG,      "ir",          NULL},
    ...
    {"fba_ims_01",            "fba_ims",           0xFFF92000U, 0x00001000U, NULL,                    0U, R_PMA_HWA_ID_FBA_IMS1,      OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
    {"fba_ims_02",            "fba_ims",           0xFFF93000U, 0x00001000U, NULL,                    0U, R_PMA_HWA_ID_FBA_IMS2,      OSAL_PM_POLICY_CG,       "mm(ipa)",     NULL},
