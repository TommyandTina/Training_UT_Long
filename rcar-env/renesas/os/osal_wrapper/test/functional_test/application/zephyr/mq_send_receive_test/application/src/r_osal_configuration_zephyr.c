...
const st_osal_rcfg_thread_config_t g_osal_thread_config[] =
{
...
#endif /* defined(ENABLE_RESOURCE_RTT) */
#if defined(ENABLE_RESOURCE_IMR)
    {OSAL_THREAD_IMR_TASK00,        {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE1, "imr_task00",          OSAL_THREAD_STACK_SIZE_IMR00},           },
    {OSAL_THREAD_IMR_TASK01,        {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE7, "imr_task01",          OSAL_THREAD_STACK_SIZE_IMR01},           },
    {OSAL_THREAD_IMR_TASK02,        {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE3, "imr_task02",          OSAL_THREAD_STACK_SIZE_IMR02},           },
    ...
    {OSAL_THREAD_OSAL_01,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE7,  "osal_task02",         OSAL_THREAD_STACK_SIZE_OSAL01},          },
    {OSAL_THREAD_OSAL_02,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE3,  "osal_task03",         OSAL_THREAD_STACK_SIZE_OSAL02},          },
    {OSAL_THREAD_OSAL_03,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE14, "osal_task04",         OSAL_THREAD_STACK_SIZE_OSAL03},          },
    {OSAL_THREAD_OSAL_04,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE7,  "osal_task05",         OSAL_THREAD_STACK_SIZE_OSAL04},          },
    {OSAL_THREAD_OSAL_05,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE3,  "osal_task06",         OSAL_THREAD_STACK_SIZE_OSAL05},          },
    {OSAL_THREAD_OSAL_06,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE14, "osal_task07",         OSAL_THREAD_STACK_SIZE_OSAL06},          },
    {OSAL_THREAD_OSAL_07,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE7,  "osal_task08",         OSAL_THREAD_STACK_SIZE_OSAL07},          },
    {OSAL_THREAD_OSAL_08,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE3,  "osal_task09",         OSAL_THREAD_STACK_SIZE_OSAL08},          },
    {OSAL_THREAD_OSAL_09,           {NULL, NULL, OSAL_THREAD_PRIORITY_TYPE14, "osal_task10",         OSAL_THREAD_STACK_SIZE_OSAL09},          },
#endif /* defined(ENABLE_RESOURCE_OSAL) */
