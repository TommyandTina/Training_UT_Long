...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    */
    ...
    /* irq_number is in the device information structure, ID is in the device structure but ID of the same element doesn't match. */
    {195, "imr_00",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task003",           0x0400,      60000000},
    {254, "ims_03",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task004",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    */
    ...
    /* irq_number is in the device information structure, ID is in the device structure but ID of the same element doesn't match. */
    {194, "imr_00",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task002",           0x0400,      60000000},
    {254, "ims_02",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task003",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    */
    ...
    /* irq_number is in the device information structure, ID is in the device structure but ID of the same element doesn't match. */
    {195, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task003",           0x0400,      60000000},
    {224, "ims_03",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task024",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    */
    ...
    /* irq_number is in the device information structure, ID is in the device structure but ID of the same element doesn't match. */
    {580, "imr_00",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task001",           0x0400,      60000000},
    {581, "ims_01",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task002",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    */
    ...
    /* irq_number is in the device information structure, ID is in the device structure but ID of the same element doesn't match. */
    {580, "imr_00",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task580",           0x0400,      60000000},
    {581, "ims_01",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task581",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    */
    ...
    /* irq_number is in the device information structure, ID is in the device structure but ID of the same element doesn't match. */
    {947, "rtdmac_control0_00",     OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task007",           0x0400,      60000000},
    { 30, "caiplite_07",            OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task008",           0x0400,      60000000},
