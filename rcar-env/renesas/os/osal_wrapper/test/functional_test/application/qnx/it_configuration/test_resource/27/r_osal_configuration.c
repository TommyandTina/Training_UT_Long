...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is not in the device info structure, ID is in the device information structure. */
    {999, "dof_00",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task006",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is not in the device info structure, ID is in the device information structure. */
    {999, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task024",           0x0400,      60000000},

  /*{254, "iccom_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task024",           0x0400,      60000000},*/
    {225, "iccom_01",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task225",           0x0400,      60000000},
    {226, "iccom_02",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task226",           0x0400,      60000000},
    {227, "iccom_03",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task227",           0x0400,      60000000},
    {228, "iccom_04",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task228",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is not in the device info structure, ID is in the device information structure. */
    {999, "imp_top_00",             OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task005",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is not in the device info structure, ID is in the device information structure. */
    {999, "imp_top_00",             OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task565",           0x2000,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is not in the device info structure, ID is in the device information structure. */
    {999, "ships_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task072",           0x0400,      60000000},
