...
#define OSAL_MAX_MEMORY_LIMIT   (512 * 1024 * 1024)
...
#if IT_DEBUG_ON
    printf("***  09_016: R_OSAL_MmngrDebugMmngrPrint         ***\n");
    printf("***  09_017: R_OSAL_MmngrDebugBufferPrint        ***\n");
#endif
...
#if IT_DEBUG_ON
/* 09_016: R_OSAL_MmngrDebugMmngrPrint */
static void osal_test_R_OSAL_MmngrDebugMmngrPrint()
{
    e_osal_return_t              osal_ret;
    st_osal_mmngr_config_t       config;
...
/* 09_017: R_OSAL_MmngrDebugBufferPrint */
static void osal_test_R_OSAL_MmngrDebugBufferPrint()
{
    e_osal_return_t              osal_ret;
    st_osal_mmngr_config_t       config;
