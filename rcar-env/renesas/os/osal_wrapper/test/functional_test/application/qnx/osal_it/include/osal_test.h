...
#define OSAL_TEST_DELIMITER "_"
#define OSAL_TEST_DECIMAL		(10)
#define OSAL_TEST_ID_PERIOD		(6)
#define OSAL_TEST_ID_MAX		(10)
...
typedef enum
{
	...
	OSAL_TEST_PARENT_MAX      = OSAL_TEST_MEMORY,
} OSAL_TEST_PARENT_ID;
...
/* OSAL Synchronization Manager */
	OSAL_TEST_THREADSYNCMUTEXCREATE = 1,
	...
	OSAL_TEST_THREADCODNTIMEWAIT_ONLY,
...
/* Maximum ID of Manager */
	...
	OSAL_TEST_THREADSYNC_MAX = OSAL_TEST_THREADSYNCCONDSIGNAL,
	...
	OSAL_TEST_IO_MAX         = OSAL_TEST_IOBLOCKWRITE64,
//	OSAL_TEST_PM_MAX         = OSAL_TEST_PMGETRESETSTATE,
	OSAL_TEST_PM_MAX         = OSAL_TEST_PM_OSAL_PM_API_INIT,
#if IT_DEBUG_ON
	OSAL_TEST_MMNGR_MAX      = OSAL_TEST_MMNGRDEBUGBUFFERPRINT,
#else
	OSAL_TEST_MMNGR_MAX      = OSAL_TEST_MMNGRCHECKBUFFER,
#endif
	OSAL_TEST_COMMON_MAX	 = OSAL_TEST_COMMON_DEINIT,
} OSAL_TEST_API_ID;
