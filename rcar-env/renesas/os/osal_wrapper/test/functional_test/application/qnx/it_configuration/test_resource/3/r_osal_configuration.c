...
const st_osal_rcfg_thread_config_t g_osal_thread_config[] =
{
    ...
    /* Set non-NULL to the Func and Userarg, and NULL to the task name. */
    {OSAL_THREAD_IMP_RTT_DRV,       {dummy_func, &dummy_userarg, OSAL_THREAD_PRIORITY_TYPE10, NULL,  0x2000} },
