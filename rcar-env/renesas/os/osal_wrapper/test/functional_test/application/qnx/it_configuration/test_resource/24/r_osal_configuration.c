...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* Set "" to task_name. */
    {243, "dof_00",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "",                      0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is the ID of the same element in the device information structure. */
    /* Set "" to task_name. */
    {225, "iccom_01",               OSAL_INTERRUPT_PRIORITY_TYPE0, "",                      0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is the ID of the same element in the device information structure. */
    /* Set "" to task_name. */
    {566, "imp_top_00",             OSAL_INTERRUPT_PRIORITY_TYPE0, "",                      0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is the ID of the same element in the device information structure. */
    /* Set "" to task_name. */
    {566, "imp_top_00",             OSAL_INTERRUPT_PRIORITY_TYPE0, "",                      0x2000,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is the ID of the same element in the device information structure. */
    /* Set "" to task_name. */
    {949, "ships_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "",                      0x0400,      60000000},
