...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is not in the device information structure. */
    {254, "dummy_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task004",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is not in the device information structure. */
    {254, "dummy_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task003",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is not in the device information structure. */
    {224, "dummy_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task024",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is not in the device information structure. */
    {581, "dummy_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task002",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is not in the device information structure. */
    {581, "dummy_00",               OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task581",           0x0400,      60000000},
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* irq_number is in the device information structure, ID is not in the device information structure. */
    { 30, "dummy0_00",              OSAL_INTERRUPT_PRIORITY_TYPE0, "int_task008",           0x0400,      60000000},
