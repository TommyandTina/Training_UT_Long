...
#define O_ANON		01000000 /* Anonymous shared-memory/semaphore objects */
#define O_PERMCHECK	02000000 /* Open is really just doing access(), ignore some errors, and auto-close the fd*/
#define O_DIRECTORY 04000000 /* Open a directory */
#define O_DIRFD     010000000 /* Path is relative to an open directory */
...
#define F_ALLOCSP   110     /*  Allocate space (posix_fallocate semantics) */
#define F_FREESP    111     /*  Shrink/Deallocate space */
#define F_GETLK     114     /*  Get record locking info */
#define F_GROWSP    109     /*  Grow space (ftruncate semantics) */
#elif __OFF_BITS__ == 32
#define F_SETLK     6       /*  Set record locking info */
#define F_SETLKW    7       /*  Set record locking info;    */
#define F_ALLOCSP   10      /*  Allocate space (posix_fallocate semantics) */
#define F_FREESP    11      /*  Shrink/Deallocate space */
#define F_GETLK     14      /*  Get record locking info */
#define F_GROWSP    9       /*  Grow space (ftruncate semantics) */
#else
...
#define F_FLOCK  0x80       /* flock() rules rather than fcntl() */
#endif
...
extern int creat64(const char *__path, mode_t __mode) __ALIASOFF("creat");
...
// extern int creat(const char *__path, mode_t __mode) __ALIAS64("creat64");
...
#if defined(__EXT_POSIX1_200809)
extern int openat(int __fd, const char *__path, int __oflag, ...);
#endif
...
/* _ctrl_flags permitted to caller of _connect_*() */
#define _CONNECT_CTRL_CANCELLATION_POINT			0x80000000
...
extern int open_ext(const char *__name, int __oflag, int __mode, int __coflag);
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/fcntl.h $ $Rev: 916291 $")
#endif
