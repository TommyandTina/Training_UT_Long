...
{
        /* All of number in g_osal_thread_priority_matrix[] is less than OSAL_INTERRUPT_PRIORITY_TYPE0 */
        /* Set 1 to OSAL_THREAD_PRIORITY_TYPE0 */
...
const int32_t g_osal_interrupt_thread_priority_matrix[15] =
{
        ...
        /* Set 255 to OSAL_INTERRUPT_PRIORITY_TYPE14 */
...
/*
    ...
    {OSAL_THREAD_ICCOM_TIMER_TASK,      0x0U  },
...
*/
#endif
    /* There is no configuration of thread affinity. */
