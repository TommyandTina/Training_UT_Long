...
#define SIGEV_SEM_32			9	/* notify, coid */
...
#define SIGEV_SEM_64 			(SIGEV_64BIT|SIGEV_SEM_32)
...
# define SIGEV_SEM_INIT(__e, __s)					\
	((__e)->sigev_notify = SIGEV_SEM,				\
	 (__e)->sigev_coid = ((__s)->__u.__fd))
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/siginfo.h $ $Rev: 911450 $")
#endif
