...
/* Dummy thread id */
#define    OSAL_THREAD_DUMMY_ID                      (RESORCE_ID_OSAL  + 10U)
...
const int32_t g_osal_thread_priority_matrix[15] =
{
        ...
        /* Set 240 to OSAL_THREAD_PRIORITY_TYPE14 */
        240         /* OSAL_THREAD_PRIORITY_TYPE14 */
};
...
{
        /* All of number in g_osal_interrupt_thread_priority_matrix[] is more than OSAL_THREAD_PRIORITY_TYPE14 */
        241,        /* OSAL_INTERRUPT_PRIORITY_TYPE0  */
        242,        /* OSAL_INTERRUPT_PRIORITY_TYPE1  */
        243,        /* OSAL_INTERRUPT_PRIORITY_TYPE2  */
        244,        /* OSAL_INTERRUPT_PRIORITY_TYPE3  */
        245,        /* OSAL_INTERRUPT_PRIORITY_TYPE4  */
        246,        /* OSAL_INTERRUPT_PRIORITY_TYPE5  */
        247,        /* OSAL_INTERRUPT_PRIORITY_TYPE6  */
        248,        /* OSAL_INTERRUPT_PRIORITY_TYPE7  */
        249,        /* OSAL_INTERRUPT_PRIORITY_TYPE8  */
        250,        /* OSAL_INTERRUPT_PRIORITY_TYPE9  */
        251,        /* OSAL_INTERRUPT_PRIORITY_TYPE10 */
        252,        /* OSAL_INTERRUPT_PRIORITY_TYPE11 */
        253,        /* OSAL_INTERRUPT_PRIORITY_TYPE12 */
        254,        /* OSAL_INTERRUPT_PRIORITY_TYPE13 */
        255         /* OSAL_INTERRUPT_PRIORITY_TYPE14 */
};
...
/* Test function */
static int64_t dummy_func(void* p_arg)
{
    return 0;
}

/* Test userarg */
static int64_t dummy_userarg = 10;
...
const st_osal_rcfg_thread_config_t g_osal_thread_config[] =
{
    ...
    /* Set 16 characters to task name */
    {OSAL_THREAD_ICCOM_MGR_TASK,    {dummy_func, &dummy_userarg, OSAL_THREAD_PRIORITY_TYPE10, "1234567890123456", 0x1000} },

    /* Set 15 characters to task name */
    {OSAL_THREAD_ICCOM_TIMER_TASK,  {dummy_func, &dummy_userarg, OSAL_THREAD_PRIORITY_TYPE10, "abcdefghijklmno",  0x1000} },
/*
...
const st_osal_thread_affinity_t g_osal_thread_affinity[] =
{
    ...
    {OSAL_THREAD_ICCOM_DEMO_TASK,       0x0U  },

    /* Don't set thread id that exists in g_osal_thread_config */
/*
    {OSAL_THREAD_ICCOM_MGR_TASK,        0x0U  },
*/
    /* Set thread id that don't exist in g_osal_thread_config */
    /* Set 0x2 to CPU Affinity */
    {OSAL_THREAD_DUMMY_ID,              0x2U  },

    /* Set thread id that exists in g_osal_thread_config */
    /* Set 0x2 to CPU Affinity */
    {OSAL_THREAD_ICCOM_TIMER_TASK,      0x2U  },

    {OSAL_THREAD_ICCOM_RCV_TASK0,       0x0U  },
    {OSAL_THREAD_ICCOM_RCV_TASK1,       0x0U  },
    {OSAL_THREAD_ICCOM_RCV_TASK2,       0x0U  },
    {OSAL_THREAD_ICCOM_RCV_TASK3,       0x0U  },
    {OSAL_THREAD_ICCOM_RCV_TASK4,       0x0U  },
    {OSAL_THREAD_ICCOM_RCV_TASK5,       0x0U  },
    {OSAL_THREAD_ICCOM_RCV_TASK6,       0x0U  },
    {OSAL_THREAD_ICCOM_RCV_TASK7,       0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK0,      0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK1,      0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK2,      0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK3,      0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK4,      0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK5,      0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK6,      0x0U  },
    {OSAL_THREAD_ICCOM_READ_TASK7,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK0,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK1,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK2,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK3,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK4,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK5,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK6,      0x0U  },
    {OSAL_THREAD_ICCOM_SEND_TASK7,      0x0U  },
    {OSAL_THREAD_IMP_RTT_DRV,           0x0U  },
    {OSAL_THREAD_IMP_DRV,               0x0U  },
    {OSAL_THREAD_IMPFW_TASK00,          0x0U  },
    {OSAL_THREAD_IMPFW_TASK01,          0x0U  },
    {OSAL_THREAD_IMPFW_TASK02,          0x0U  },
    {OSAL_THREAD_IMPFW_TASK03,          0x0U  },
    {OSAL_THREAD_IMPFW_TASK04,          0x0U  },
    {OSAL_THREAD_IMPFW_TASK05,          0x0U  },
    {OSAL_THREAD_IMPFW_TASK06,          0x0U  },
    {OSAL_THREAD_IMPFW_APP_TASK00,      0x0U  },
    {OSAL_THREAD_IMPFW_APP_TASK01,      0x0U  },
    {OSAL_THREAD_IMPFW_APP_TASK02,      0x0U  },
    {OSAL_THREAD_IMPFW_APP_TASK03,      0x0U  },
    {OSAL_THREAD_IMPFW_APP_TASK04,      0x0U  },
    {OSAL_THREAD_IMPFW_APP_TASK05,      0x0U  },
    {OSAL_THREAD_IMPFW_APP_TASK06,      0x0U  },
    {OSAL_THREAD_LDE_CAPUTRE_TASK,      0x0U  },
    {OSAL_THREAD_LDE_OUTPUT_TASK,       0x0U  },
    {OSAL_THREAD_LDE_CTX_TASK,          0x0U  },
    {OSAL_THREAD_CODEC_ENC_CAP_TASK,    0x0U  },
    {OSAL_THREAD_CODEC_ENC_OUT_TASK,    0x0U  },
    {OSAL_THREAD_CODEC_ENC_CTX_TASK,    0x0U  },
    {OSAL_THREAD_CODEC_DEC_TASK,        0x0U  },
    {OSAL_THREAD_CODEC_OUT_TASK,        0x0U  },
    {OSAL_THREAD_CPURTT_CB_TASK,        0x0U  },
    {OSAL_THREAD_CPURTT_FBIST_TASK,     0x0U  },
    {OSAL_THREAD_CPURTT_A1_TASK,        0x0U  },
    {OSAL_THREAD_CPURTT_A21_TASK,       0x0U  },
    {OSAL_THREAD_CPURTT_A22_TASK,       0x0U  },
    {OSAL_THREAD_CPURTT_A23_TASK,       0x0U  },
    {OSAL_THREAD_CPURTT_A24_TASK,       0x0U  },
    {OSAL_THREAD_CPURTT_TP_TASK1,       0x0U  },
    {OSAL_THREAD_CPURTT_TP_TASK2,       0x0U  },
    {OSAL_THREAD_FBIST_TP_TASK1,        0x0U  },
    {OSAL_THREAD_FBIST_TP_TASK2,        0x0U  },
    {OSAL_THREAD_RFSO_TP_TASK1,         0x0U  },
    {OSAL_THREAD_RFSO_TP_TASK2,         0x0U  },
    {OSAL_THREAD_IMR_TASK00,            0x0U  },
    {OSAL_THREAD_IMR_TASK01,            0x0U  },
    {OSAL_THREAD_IMR_TASK02,            0x0U  },
    {OSAL_THREAD_IMR_TASK03,            0x0U  },
    {OSAL_THREAD_IMR_TASK04,            0x0U  },
    {OSAL_THREAD_IMR_TASK05,            0x0U  },
    {OSAL_THREAD_VIP_TASK00,            0x0U  },
    {OSAL_THREAD_VIP_TASK01,            0x0U  },
    {OSAL_THREAD_VIP_TASK02,            0x0U  },
    {OSAL_THREAD_VIP_TASK03,            0x0U  },
    {OSAL_THREAD_VIP_TASK04,            0x0U  },
    {OSAL_THREAD_ISP_TASK00,            0x0U  },
    {OSAL_THREAD_ISP_TASK01,            0x0U  },
    {OSAL_THREAD_ISP_TASK02,            0x0U  },
    {OSAL_THREAD_ISP_TASK03,            0x0U  },
    {OSAL_THREAD_PAP_TASK00,            0x0U  },

    {OSAL_THREAD_OSAL_00,               0x0U  },
    {OSAL_THREAD_OSAL_01,               0x0U  },
    {OSAL_THREAD_OSAL_02,               0x0U  },
    {OSAL_THREAD_OSAL_03,               0x0U  },
    {OSAL_THREAD_OSAL_04,               0x0U  },
    {OSAL_THREAD_OSAL_05,               0x0U  },
    {OSAL_THREAD_OSAL_06,               0x0U  },
    {OSAL_THREAD_OSAL_07,               0x0U  },
    {OSAL_THREAD_OSAL_08,               0x0U  },
    {OSAL_THREAD_OSAL_09,               0x0U  },
#elif defined(RCAR_S4)
    /* thread id,                     CPU Affinity */
    {OSAL_THREAD_ICCOM_DEMO_TASK,       0x0U  },
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* Set 16 characters to task name */
    {193, "ims_01",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "1234567890123456",      0x0400,      60000000},

    /* Set 15 characters to task name */
    {194, "ims_02",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "abcdefghijklmno",       0x0400,      60000000},
/*
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* Set 16 characters to task name */
    {580, "ims_01",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "1234567890123456",      0x0400,      60000000},

    /* Set 15 characters to task name */
    {581, "imr_00",                 OSAL_INTERRUPT_PRIORITY_TYPE0, "abcdefghijklmno",       0x0400,      60000000},
/*
...
const st_osal_interrupt_thread_config_t  g_osal_interrupt_thread_config[] =
{
    ...
    /* Set 16 characters to task name */
    {935, "caiplite_01",            OSAL_INTERRUPT_PRIORITY_TYPE0, "1234567890123456",      0x0400,      60000000},

    /* Set 15 characters to task name */
    {937, "caiplite_02",            OSAL_INTERRUPT_PRIORITY_TYPE0, "abcdefghijklmno",       0x0400,      60000000},
/*
...
const st_osal_interrupt_thread_affinity_t  g_osal_interrupt_thread_affinity[] =
{
    ...
    /* Don't set irq number that exists in g_osal_interrupt_thread_config */
/*
    {193,   0x0U  },
*/
    /* Set irq number that don't exist in g_osal_interrupt_thread_config */
    /* Set 0x2 to CPU Affinity */
    {999,   0x2U  },

    /* Set irq number that exists in g_osal_interrupt_thread_config */
    /* Set 0x2 to CPU Affinity */
    {194,   0x2U  },
