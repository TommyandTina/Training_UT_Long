...
// #define LINE_MAX    		2048	/* Maximum length, in bytes, of a utility's input line */
// #define COLL_WEIGHTS_MAX	2	/* Maximum number of weights that can be assigned to an entry of the LC_COLLATE order keyword in the locale definition file */
// #define RE_DUP_MAX  		255	/* Maximum number of repeated occurrences of a regular expression permitted when using the interval notation \{m,n\} */
// #endif

// #if defined(__EXT_XOPEN_EX) || defined(__EXT_POSIX1_200112)
// #define CHARCLASS_NAME_MAX	14	/* Maximum number of bytes in a character class name. */
// #endif
...
// #else
// # error Unable to determine ssize_t limits
// #endif
// #endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/limits.h $ $Rev: 912243 $")
#endif
