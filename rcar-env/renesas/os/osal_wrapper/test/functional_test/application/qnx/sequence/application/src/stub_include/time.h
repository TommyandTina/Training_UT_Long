...
static inline _Uint64t __timespec2nsec(const struct timespec *const __ts)
{
	return ((_Uint64t)(__ts)->tv_sec*(_Uint64t)1000000000+(_Uint64t)(_Int64t)(__ts)->tv_nsec);
}
# define timespec2nsec(__ts) __timespec2nsec((__ts))
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/time.h $ $Rev: 872578 $")
#endif
