...
#define _CS_POSIXLY_CORRECT	12		/* Enable POSIX behaviour */
...
#define _CS_GRAPHICS		205		/* graphics redirection */
#define _CS_PAMCONF			206		/* PAM configuration path */
#define _CS_PAMLIB			207		/* PAM library path */
#define _CS_CONFIG_PATH		208		/* System config path, behaves like LD_LIBRARY_PATH */
...
#define _CS_SET_GRAPHICS	(_CS_SET+_CS_GRAPHICS)	/* Set the graphics redirection for this node */
...
#define _CS_V6_ENV				129
#endif

#if defined(__EXT_POSIX1_200809)
#define _CS_POSIX_V7_ILP32_OFF32_CFLAGS		116
#define _CS_POSIX_V7_ILP32_OFF32_LDFLAGS	117
#define _CS_POSIX_V7_ILP32_OFF32_LIBS		118
#define _CS_POSIX_V7_ILP32_OFFBIG_CFLAGS	119
#define _CS_POSIX_V7_ILP32_OFFBIG_LDFLAGS	120
#define _CS_POSIX_V7_ILP32_OFFBIG_LIBS		121
#define _CS_POSIX_V7_LP64_OFF64_CFLAGS		122
#define _CS_POSIX_V7_LP64_OFF64_LDFLAGS		123
#define _CS_POSIX_V7_LP64_OFF64_LIBS		124
#define _CS_POSIX_V7_LPBIG_OFFBIG_CFLAGS	125
#define _CS_POSIX_V7_LPBIG_OFFBIG_LDFLAGS	126
#define _CS_POSIX_V7_LPBIG_OFFBIG_LIBS		127
#define _CS_V7_ENV				129
#define _CS_POSIX_V7_WIDTH_RESTRICTED_ENVS	130
#define _CS_POSIX_V7_THREADS_CFLAGS		131
#define _CS_POSIX_V7_THREADS_LDFLAGS		132
#endif
...
#if defined(__EXT_POSIX1_200809)
#define _SC_V7_ILP32_OFF32					176
#define _SC_V7_ILP32_OFFBIG					177
#define _SC_V7_LP64_OFF64					178
#define _SC_V7_LPBIG_OFFBIG					179
...
#define _PC_IMAGE_VADDR			11 /* Deprecated */
#endif
...
#if defined(__EXT_QNX)
#define _PC_CASE_SENSITIVE		26
#define _PC_CASE_PRESERVING		27
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/confname.h $ $Rev: 867384 $")
#endif
