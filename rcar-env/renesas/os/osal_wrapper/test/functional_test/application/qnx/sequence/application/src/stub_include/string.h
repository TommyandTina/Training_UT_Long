...
extern void *memcpy(void *__dst, const void *__src, unsigned long __nbytes);
extern void *memmove(void *__s1, const void *__s2, unsigned long __n);
...
extern unsigned long strxfrm(char *__s1, const char *__s2, unsigned long __n);
extern char *strcpy(char *__s1, const char *__s2);
extern unsigned long strcspn(const char *__s1, const char *__s2);
extern char *strerror(int __errnum);
extern unsigned long strlen(const char *__s);
extern unsigned long strnlen(const char *__str, unsigned long __maxlen);
extern char *strncat(char *__s1, const char *__s2, unsigned long __n);
extern int strncmp(const char *__s1, const char *__s2, unsigned long __n);
extern char *strncpy(char *__s1, const char *__s2, unsigned long __n);
extern unsigned long strspn(const char *__s1, const char *__s2);
...
extern int	strerror_r(int __errnum, char * __buf, unsigned long __len);
#endif

#if defined(__EXT_POSIX1_200112) || defined(__EXT_XOPEN_EX)
extern void *memccpy(void * __restrict __s1, const void * __restrict __s2, int __c, unsigned long __n);
...
extern char    *stpncpy(char * __restrict __dst , const char * __restrict __src, unsigned long __num);
extern char    *strndup(const char *__src, unsigned long __size);
#endif
...
extern size_t memcpyv(const struct iovec *__dst, int __dparts, size_t __doff, const struct iovec *__src, int __sparts, unsigned long __soff);
extern int memicmp(const void *__s1, const void *__s2, unsigned long __n);
extern int _memicmp(const void *__s1, const void *__s2, unsigned long __n);
...
extern int _strnicmp(const char *__s1, const char *__s2, unsigned long __n);
...
extern int straddstr(const char *__str, int __len, char **__pbuf, unsigned long *__pmaxbuf);
...
extern int  __memcmp_isr(const void *__s1, const void *__s2, size_t __n);
...
#define memcmp_isr __memcmp_isr
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/string.h $ $Rev: 888915 $")
#endif
