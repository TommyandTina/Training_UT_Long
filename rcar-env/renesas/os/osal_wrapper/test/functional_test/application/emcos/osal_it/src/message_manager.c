...
static void osal_test_R_OSAL_MqCreate()
{
	...
	Test03_001_008(mq_config, 40, mq_handle);
...
//	Test03_001_006(mq_config, OSAL_MQ_RESOURCE_NUM        , mq_handle);
	...
	Test03_001_009(mq_config, 40, mq_handle);
}
...
/* ------------------------Initialize------------------------ */
	...
	Test03_002_001(mq_config, 5, mq_handle);
	Test03_002_002(mq_config, 5, NULL);
	Test03_002_003(mq_config, 5, mq_handle);
	Test03_002_004(mq_config, 5, mq_handle);
	Test03_002_005(mq_config, 5, mq_handle);
	//Test03_002_006();//using stubb
	Test03_002_007(mq_config, 5, mq_handle);
...
static void osal_test_R_OSAL_MqSendUntilTimeStamp()
{
    ...
    osal_ret = R_OSAL_MqCreate(&mq_config, 5, &mq_handle);
	if (osal_ret != OSAL_RETURN_OK)
	{
		OSAL_TEST_ERR("R_OSAL_MqCreate() error.",
				OSAL_TEST_MESSAGE, OSAL_TEST_MQSENDUNTILTIMESTAMP, 0);
    ...
    osal_ret = R_OSAL_MqCreate(&mq_config, 1, &g_mq_handle);
	if (osal_ret != OSAL_RETURN_OK)
	{
		OSAL_TEST_ERR("R_OSAL_MqCreate() error.",
				OSAL_TEST_MESSAGE, OSAL_TEST_MQSENDUNTILTIMESTAMP, 0);
