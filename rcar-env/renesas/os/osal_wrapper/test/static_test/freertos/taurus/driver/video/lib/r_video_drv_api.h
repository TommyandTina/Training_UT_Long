...
/**@defgroup group1 Taurus VIDEO server public library API
 *
 * @brief This Cortex-R7 Taurus VIDEO server is a part of the Taurus firmware.
 *
...
#ifndef R_VIDEO_DRV_API_H
#define R_VIDEO_DRV_API_H
...
/*******************************************************************************
 * Function Name: R_VIDEO_DRV_Open
 */
/**
 * @brief Opens the VIDEO server
 *
...
/*******************************************************************************
 * Function Name: R_VIDEO_DRV_Close
 */
/**
 * @brief Closes the VIDEO server
 *
 * @param[in] Guest       - Guest ID
 * @param[in] Cmd         - Pointer to the command to process
 *
...
/*******************************************************************************
 * Function Name: R_VIDEO_DRV_Read
 */
/**
 * @brief Read request to the VIDEO server
 *
 * @param[in] Guest       - Guest ID
 * @param[in] Cmd         - Pointer to the command to process
 *
...
/*******************************************************************************
 * Function Name: R_VIDEO_DRV_Write
 */
/**
 * @brief Write request to the VIDEO server
 *
 * @param[in] Guest       - Guest ID
 * @param[in] Cmd         - Pointer to the command to process
 *
...
/*******************************************************************************
 * Function Name: R_VIDEO_DRV_IoCtl
 */
/**
 * @brief Request an IOCTL command to the VIDEO server
 *
 * @param[in] Guest       - Guest ID
 * @param[in] Cmd         - Pointer to the command to process
 *
...
/*******************************************************************************
 * Function Name: R_VIDEO_DRV_Status
 */
/**
 * @brief Query status of the VIDEO server. Currently implemented empty.
 *
 * @param[in] Guest       - Guest ID
 * @param[in] Cmd         - Pointer to the command to process
 *
...
/*******************************************************************************
 * Function Name: R_VIDEO_DRV_SetSendSignalImpl
 */
/**
