...
#Note: if this parameter is not provided, the rcar platform default configuration file will be used
CUSTOM_CCF=${ROOT_DIR}/.ci/static_test_qac/config/arm_compiler_armclang_v6.6.3-c.cct
#######################################################################################################################
...
QAC_OUTPUT_DIR=${ROOT_DIR}/build/static_test/osal_wrapper
#QAC project input folder (path to SW sources in scope of the analysis)
QAC_INPUT_DIR=${ROOT_DIR}/renesas/os/osal_wrapper
