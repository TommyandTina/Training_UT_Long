...
#if defined(USE_STUB)
#define pm_device_runtime_get       pm_device_runtime_get_stub
#define pm_device_runtime_put       pm_device_runtime_put_stub
#define pm_device_runtime_enable    pm_device_runtime_enable_stub
#endif
