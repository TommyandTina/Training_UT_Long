...
#if defined(USE_STUB)
#define clock_control_on            clock_control_on_stub
#define clock_control_off           clock_control_off_stub
#define clock_control_get_status    clock_control_get_status_stub
#define clock_control_set_rate      clock_control_set_rate_stub
#endif
 ...
 */
#if defined(USE_STUB)
extern int clock_control_on(const struct device *dev, clock_control_subsys_t sys);
#else
 ...
 */
#if defined(USE_STUB)
extern int clock_control_off(const struct device *dev, clock_control_subsys_t sys);
#else
 ...
 */
#if defined(USE_STUB)
extern enum clock_control_status clock_control_get_status(const struct device *dev, clock_control_subsys_t sys);
#else
 ...
 */
#if defined(USE_STUB)
extern int clock_control_set_rate(const struct device *dev, clock_control_subsys_t sys, clock_control_subsys_rate_t rate);
#else
