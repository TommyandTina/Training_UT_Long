...
#if defined(USE_STUB)
#define irq_connect_dynamic irq_connect_dynamic_stub
#define irq_lock            irq_lock_stub
#define irq_unlock          irq_unlock_stub
#endif
 ...
 */
#if defined(USE_STUB)
extern int irq_connect_dynamic(unsigned int irq, unsigned int priority, void (*routine)(const void *parameter), const void *parameter, uint32_t flags);
#else
static inline int
