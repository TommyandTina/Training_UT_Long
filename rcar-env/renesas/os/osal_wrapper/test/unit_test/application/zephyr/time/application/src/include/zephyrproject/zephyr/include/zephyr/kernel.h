...
#if defined(USE_STUB)
#define k_cycle_get_32              k_cycle_get_32_stub
#define k_is_in_isr                 k_is_in_isr_stub
#define k_thread_cpu_mask_clear     k_thread_cpu_mask_clear_stub
#define k_thread_cpu_mask_enable    k_thread_cpu_mask_enable_stub
#define k_yield                     k_yield_stub
#define k_thread_suspend            k_thread_suspend_stub
#define k_thread_resume             k_thread_resume_stub
#endif
