...
#if defined(USE_STUB)
#define pthread_attr_init           pthread_attr_init_stub
#define pthread_attr_destroy        pthread_attr_destroy_stub
#define pthread_attr_setschedparam  pthread_attr_setschedparam_stub
#define pthread_attr_setschedpolicy pthread_attr_setschedpolicy_stub
#define pthread_attr_setstack       pthread_attr_setstack_stub
#define pthread_create              pthread_create_stub
#define pthread_self                pthread_self_stub
#define pthread_equal               pthread_equal_stub
#define pthread_detach              pthread_detach_stub
#define pthread_mutexattr_init      pthread_mutexattr_init_stub
#define pthread_mutexattr_destroy   pthread_mutexattr_destroy_stub
#define pthread_mutexattr_settype   pthread_mutexattr_settype_stub
#define pthread_mutex_init          pthread_mutex_init_stub
#define pthread_mutex_destroy       pthread_mutex_destroy_stub
#define pthread_mutex_lock          pthread_mutex_lock_stub
#define pthread_mutex_trylock       pthread_mutex_trylock_stub
#define pthread_mutex_timedlock     pthread_mutex_timedlock_stub
#define pthread_mutex_unlock        pthread_mutex_unlock_stub
#define pthread_cond_init           pthread_cond_init_stub
#define pthread_cond_destroy        pthread_cond_destroy_stub
#define pthread_cond_wait           pthread_cond_wait_stub
#define pthread_cond_timedwait      pthread_cond_timedwait_stub
#define pthread_cond_signal         pthread_cond_signal_stub
#define pthread_cond_broadcast      pthread_cond_broadcast_stub
#define pthread_setname_np          pthread_setname_np_stub
#endif
