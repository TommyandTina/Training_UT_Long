...
// // typedef	_Uintptr32t				uintptr32_t;
// // typedef	_Uintptr64t				uintptr64_t;
...
// #if defined(__EXT_QNX)
// #if __PTR_BITS__ == 32
// #define SIZE_C(__x)             UINT32_C(__x)
// #define SSIZE_C(__x)            INT32_C(__x)
// #elif  __PTR_BITS__ == 64
// #define SIZE_C(__x)             UINT64_C(__x)
// #define SSIZE_C(__x)            INT64_C(__x)
// #else
// #error __PTR_BITS__ Not valid
// #endif
// #endif /* __EXT_QNX */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/stdint.h $ $Rev: 898046 $")
#endif
