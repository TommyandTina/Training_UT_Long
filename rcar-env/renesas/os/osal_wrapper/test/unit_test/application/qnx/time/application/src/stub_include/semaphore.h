...
struct timespec;
extern int sem_timedwait_monotonic(sem_t *__sem, const struct timespec *__abs_timeout);
extern int sem_timedwait_np(sem_t *const __sem, const struct timespec *const __abs_timeout, clockid_t __clk);

#define SEM_ANON		((char *)-1)
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/semaphore.h $ $Rev: 911450 $")
#endif
