...
***********************************************************************************************************************
***********************************************************************************************************************
* File Name    : osal_wrapper_ut.py(OSAL QNX)
* Version      : 1.0.0
...
def GetCommandlineArguments():
    ...
    parser.add_argument('-soc', '--soc_name', required=False,
                        help='SoC name')
...
class ut_param:
    ...
    cp2_path       = "cp2/osal_ut_cp2/osal_ut_cp2.vproj"
...
if __name__ == "__main__":
    ...
    if ("s4" == soc_name):
        commands.append("-mp")
        commands.append("{}/{}".format(project_path, "s4"))
    else:
        commands.append("-mp")
