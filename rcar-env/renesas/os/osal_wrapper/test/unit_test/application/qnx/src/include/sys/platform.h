...
#include _NTO_HDR_(sys/ntohdr.h)
#else
#include <sys/ntohdr.h>
#endif
#else
...
// #if (__STDC_VERSION__-0 >= 201112) || (__cplusplus-0 >= 201703L)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/platform.h $ $Rev: 916375 $")
#endif
