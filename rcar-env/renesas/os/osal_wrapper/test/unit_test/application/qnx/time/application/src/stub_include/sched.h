...
#define _PRIO_LIMIT_DEFAULT		0x00000u
#define _PRIO_LIMIT_SATURATE	0x10000u
#define _PRIO_LIMIT_ERROR		0x20000u
#define _PRIO_LIMIT_ILLEGAL		0x30000u
#define _PRIO_LIMIT_MASK		0x30000u

#define SCHED_PRIO_LIMIT_SATURATE(p)	((int)((unsigned)(p)|_PRIO_LIMIT_SATURATE))
#define SCHED_PRIO_LIMIT_ERROR(p)		((int)((unsigned)(p)|_PRIO_LIMIT_ERROR))
#define SCHED_PRIO_EXTRACT(p)			((_Int16t)(p))
...
struct sched_config {
	_Int32t			low_latency_priority;
	_Int32t			migrate_priority;
	_Uint64t		reserved[5];
};
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sched.h $ $Rev: 835827 $")
#endif
