/*
 * 
 * STUB header copied from QNX SDP 7.1
 * 
 * $QNXLicenseC:
...
/*
 *  System log codes for the slogger utility
 *
 */
...
#define _SLOGC_FS            3
 ...
 #define _SLOGC_FS_NT        __C(_SLOGC_FS, 1100)
 #define _SLOGC_FS_MAC       __C(_SLOGC_FS, 1200)
 #define _SLOGC_FS_EVENTS    __C(_SLOGC_FS, 1300)
 #define _SLOGC_FS_RCFS      __C(_SLOGC_FS, 1400)
 #define _SLOGC_FS_EXFAT	 __C(_SLOGC_FS, 1500)

#define _SLOGC_BLOCK         4
 #define _SLOGC_BLOCK_IOBLK  __C(_SLOGC_BLOCK,   0)
 #define _SLOGC_BLOCK_QCRYPT __C(_SLOGC_BLOCK, 100)
 #define _SLOGC_BLOCK_SWAPFS __C(_SLOGC_BLOCK, 200)
...
#define	_SLOGC_SIM			 19
 ...
 #define _SLOGC_SIM_MMC      __C(_SLOGC_SIM, 1800)
...
#define _SLOGC_HB				28	/* Heartbeat lib */
 #define _SLOGC_HB_SERVER		__C(_SLOGC_HB,  0)
 #define _SLOGC_HB_CLIENT		__C(_SLOGC_HB,  100)

#define _SLOGC_PPS              29

#define _SLOGC_ASR              30

#define _SLOGC_GN		31
 #define _SLOGC_GN_SERVER		__C(_SLOGC_GN, 0)
 #define _SLOGC_GN_CLIENT		__C(_SLOGC_GN, 100)

#define _SLOGC_CORESERV			32

#define _SLOGC_SENSOR			33
 #define _SLOGC_SENSOR_ACCEL	__C(_SLOGC_SENSOR, 0)

#define _SLOGC_IPOD			34
 #define _SLOGC_IPOD_SERVER		__C(_SLOGC_IPOD, 0)
 #define _SLOGC_IPOD_CLIENT		__C(_SLOGC_IPOD, 100)

#define _SLOGC_CAMERA           35

#define _SLOGC_RESARB           36

#define _SLOGC_NPAPM		37

#define _SLOGC_IOAP             38

#define _SLOGC_MMSYNC		39

#define _SLOGC_DLNA		40
#define _SLOGC_DLNA_DMR		__C(_SLOGC_DLNA, 0)
#define _SLOGC_DLNA_DMS		__C(_SLOGC_DLNA, 100)
#define _SLOGC_DLNA_DMSC	__C(_SLOGC_DLNA, 200)
#define _SLOGC_DLNA_DMC		__C(_SLOGC_DLNA, 300)
#define _SLOGC_DLNA_DMCC	__C(_SLOGC_DLNA, 400)

#define _SLOGC_SECURITY_PLATFORM    41
 #define _SLOGC_SEC_AUTHMAN          __C(_SLOGC_SECURITY_PLATFORM,   0)
 #define _SLOGC_SEC_LAUNCHER         __C(_SLOGC_SECURITY_PLATFORM, 100)
 #define _SLOGC_SEC_PERIMETER_MGR    __C(_SLOGC_SECURITY_PLATFORM, 200)
 #define _SLOGC_SEC_OTHER            __C(_SLOGC_SECURITY_PLATFORM, 300)
 #define _SLOGC_SEC_CERTMGR_CLIENT   __C(_SLOGC_SECURITY_PLATFORM, 400)
 #define _SLOGC_SEC_CERTMGR_SERVER   __C(_SLOGC_SECURITY_PLATFORM, 500)
 #define _SLOGC_SEC_CERTMGR_PPS      __C(_SLOGC_SECURITY_PLATFORM, 600)
 #define _SLOGC_SEC_RANDOM           __C(_SLOGC_SECURITY_PLATFORM, 700)

#define	_SLOGC_SDIO			 42
 #define _SLOGC_SDIO_WLAN     __C(_SLOGC_SDIO,   0)

#define _SLOGC_HID              43
 #define _SLOGC_HID_GEN         __C(_SLOGC_HID,   0)

#define _SLOGC_ENUM_DEVICES     44

/*
** Slog codes for the QNX Application Framework:
**   - AF System Information Service (AFSIS)
**   - AF System Installer Service (AFIS)
**   - AF System Catalog Service (AFCS)
**   - AF System Launch Service (AFLS)
**   - AF Manager (AFMgr)
**   - AF Utility libraries
**   - AF Tools and sample programs
**   - AF Tests
*/
#define _SLOGC_AF               45
 #define _SLOGC_AF_AFSIS        __C(_SLOGC_AF,   0)
 #define _SLOGC_AF_AFIS         __C(_SLOGC_AF,   100)
 #define _SLOGC_AF_AFCS         __C(_SLOGC_AF,   200)
 #define _SLOGC_AF_AFLS         __C(_SLOGC_AF,   300)
 #define _SLOGC_AF_AFMGR        __C(_SLOGC_AF,   400)
 #define _SLOGC_AF_UTILS        __C(_SLOGC_AF,   500)
 #define _SLOGC_AF_TOOLS        __C(_SLOGC_AF,   600)
 #define _SLOGC_AF_TESTS        __C(_SLOGC_AF,   700)
 #define _SLOGC_AF_AFSUS        __C(_SLOGC_AF,   800)

/*
** Slog code for BlackBerry IoT Platform Agent (bipd)
*/
#define _SLOGC_BIPD             46

/*
** Slog codes for the QNX GPIO Framework
*/
#define _SLOGC_GPIO             47
 #define _SLOGC_GPIO_SERVICE    __C(_SLOGC_GPIO,   0)
 #define _SLOGC_GPIO_DEVGP      __C(_SLOGC_GPIO,   100)

// #define _SLOGC_QNX_FREE_TÒ_USE                                                                    48

/*
 * Codes for qkeystore library/service/utility
 */
#ifndef _SLOGC_QKEYSTORE
#define _SLOGC_QKEYSTORE        49
 #define _SLOGC_QKEYSTORE_DEFAULT       __C(_SLOGC_QKEYSTORE, 0)
 #define _SLOGC_QKEYMASTER_DEFAULT      __C(_SLOGC_QKEYSTORE, 1)
 #define _SLOGC_QKEYWRAP_DEFAULT        __C(_SLOGC_QKEYSTORE, 2)
 #define _SLOGC_QKEYSTORAGE_DEFAULT     __C(_SLOGC_QKEYSTORE, 3)
 #define _SLOGC_QKEYRESOLVER_DEFAULT    __C(_SLOGC_QKEYSTORE, 4)
 #define _SLOGC_QKEYCTL_DEFAULT         __C(_SLOGC_QKEYSTORE, 5)
 #define _SLOGC_QKEYSTORED_DEFAULT      __C(_SLOGC_QKEYSTORE, 6)
#endif

/*
 * Codes for devcrypto service
 */
#ifndef _SLOGC_DEVCRYPTO
#define _SLOGC_DEVCRYPTO        50
 #define _SLOGC_DEVCRYPTO_DEFAULT       __C(_SLOGC_DEVCRYPTO, 0)
#endif

/* Add the next MAJOR code here.
#define _SLOGC_NEXT_QNX         51
*/
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/slogger/public/sys/slogcodes.h $ $Rev: 877231 $")
#endif
