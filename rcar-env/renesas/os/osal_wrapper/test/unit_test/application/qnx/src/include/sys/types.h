...
typedef _Size32t                size32_t;
typedef _Size64t                size64_t;
typedef _Ssize32t               ssize32_t;
typedef _Ssize64t               ssize64_t;

#define SIZEOF32(x) 	(_Uint32t)(sizeof(x))
#endif /* __EXT_QNX */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/types.h $ $Rev: 806926 $")
#endif
