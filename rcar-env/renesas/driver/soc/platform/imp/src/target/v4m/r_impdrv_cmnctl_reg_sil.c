...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_impdrv_cmnctl_reg_sil.c
* Version      : 3.19.0
...
/**
 * @file r_impdrv_cmnctl_reg_sil.c
 */
...
***********************************************************************************************************************/
#define IMPDRV_HWRSC_SPM_PSET_TBL_MAX   (5U)        /** Maximum index number of the preset table    */
/*******************************************************************************************************************//**
...
const st_impdrv_hwrsc_def_t     s_hwrsc_def_table[IMPDRV_HWRSC_TABLE_NUM] =
{
    ...
    { "imp_spmi_00"     ,   0xED200000U ,   0x00200000U ,   false   ,   false       },
    ...
    { "imp_spmc_01"     ,   0xED600000U ,   0x00080000U ,   false   ,   false       },
...
)
{
    ...
    struct {
        ...
        {   "imp_reg_spmi_00"   ,   0x0868U ,   0x00030000U ,   false   },  /** Register(SPMI0) SDMAC hang-up W.A. */
        {   "imp_reg_spmi_00"   ,   0x1028U ,   0x00030000U ,   false   },  /** Register(SPMI0) SDMAC hang-up W.A. */
