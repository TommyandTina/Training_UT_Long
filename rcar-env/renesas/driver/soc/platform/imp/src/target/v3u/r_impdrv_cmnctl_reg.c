...
const st_impdrv_hwrsc_def_t     s_hwrsc_def_table[IMPDRV_HWRSC_TABLE_NUM] =
{
    ...
    { "imp_top_00"      ,   0xFF900000U ,   0x00004000U ,   true    ,   false       },
    { "imp_spmi_00"     ,   0xED300000U ,   0x00100000U ,   false   ,   false       },
    { "imp_spmi_01"     ,   0xEDA00000U ,   0x00100000U ,   false   ,   false       },
    { "imp_spmc_00"     ,   0xED600000U ,   0x00200000U ,   false   ,   false       },
    { "imp_spmc_01"     ,   0xED800000U ,   0x00200000U ,   false   ,   false       },
    { "imp_spmc_02"     ,   0xED400000U ,   0x00200000U ,   false   ,   false       },
    { "imp_reg_spmi_00" ,   0xFFA8C000U ,   0x00004000U ,   true    ,   false       },
    { "imp_reg_spmi_01" ,   0xFFB8C000U ,   0x00004000U ,   true    ,   false       },
    { "imp_reg_spmc_00" ,   0xFFAB0000U ,   0x00004000U ,   true    ,   false       },
    { "imp_reg_spmc_01" ,   0xFFBD0000U ,   0x00004000U ,   true    ,   false       },
    { "imp_reg_spmc_02" ,   0xFFAD0000U ,   0x00004000U ,   true    ,   false       },
...
const uint32_t s_impdrv_used_instance[IMPDRV_INSTANCETABLE_NUM] =
{
    ...
    0x00000020U,    /**< IMPDRV_INSTANCE_5 */
    0x00000040U     /**< IMPDRV_INSTANCE_6 */
};
...
)
{
    ...
    struct {
        ...
        {   "imp_reg_spmi_01"   ,   0x2000U ,   0x0000000CU ,   true    },  /** PRESET Register(SPMI1)          */
        {   "imp_reg_spmc_00"   ,   0x2000U ,   0x00000009U ,   true    },  /** PRESET Register(SPMC0)          */
        {   "imp_reg_spmc_02"   ,   0x2000U ,   0x0000000AU ,   true    },  /** PRESET Register(SPMC2)          */
        {   "imp_reg_spmc_01"   ,   0x2000U ,   0x0000000CU ,   true    },  /** PRESET Register(SPMC1)          */
        {   "imp_reg_spmc_01"   ,   0x21A0U ,   0x00000044U ,   true    },  /** Master Bus ConTRoL001(SPMC1)    */
        {   "imp_reg_spmc_01"   ,   0x21A4U ,   0x00000044U ,   true    },  /** Master Bus ConTRoL011(SPMC1)    */
        {   "imp_reg_spmc_01"   ,   0x21A8U ,   0x00000044U ,   true    },  /** Master Bus ConTRoL021(SPMC1)    */
        {   "imp_reg_spmc_01"   ,   0x21ACU ,   0x00000044U ,   true    }   /** Master Bus ConTRoL031(SPMC1)    */
    };
    const uint32_t  num_procedures = (uint32_t)(sizeof(procedure)/sizeof(procedure[0]));
    ...
    count = 0U;
    while ((IMPDRV_EC_OK == ercd) && (num_procedures > count))
    {
...
)
{
    ...
    const char* p_check_devices_id[3U] =
    {
        "imp_spmc_00",
        "imp_spmc_01",
        "imp_spmc_02"
...
)
{
    ...
    struct {
        ...
        { "imp_reg_spmi_01"     ,   0x2300U ,   0x80000000U ,   false   },  /** SPMI1 SPMCTRLX0 */
        { "imp_reg_spmc_00"     ,   0x2300U ,   0x80000000U ,   false   },  /** SPMC0 SPMCTRLX0 */
        { "imp_reg_spmc_01"     ,   0x2300U ,   0x80000000U ,   false   },  /** SPMC1 SPMCTRLX0 */
        { "imp_reg_spmc_02"     ,   0x2300U ,   0x80000000U ,   false   }   /** SPMC2 SPMCTRLX0 */
    };
    const uint32_t  num_procedures = (uint32_t)(sizeof(procedure)/sizeof(procedure[0]));
    uint32_t        index[num_procedures];
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_cmnctl_reg_spm_ena_access(index[0], true);        /** SPMI0 access enable */
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_cmnctl_reg_spm_ena_access(index[1], true);    /** SPMI1 access enable */
        }
    }
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_cmnctl_reg_spm_ena_access(index[0], false);       /** SPMI0 access disable */
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_cmnctl_reg_spm_ena_access(index[1], false);   /** SPMI1 access disable */
        }
    }
