...
***********************************************************************************************************************/
#define IMPDRV_OCV_CORENUM_VAL      (4U)                /**< Maximum number of cores for OCV. */
/*******************************************************************************************************************//**
 * @def IMPDRV_OCV_EXEPARAM_CLBRK
 * Index value of extend parameter for CL break address.
***********************************************************************************************************************/
#define IMPDRV_OCV_EXEPARAM_CLBRK   (0U)                /**< Index value of extend parameter for CL break address.  */
/*******************************************************************************************************************//**
 * @def IMPDRV_OCV_EXEPARAM_GOSUB
 * Index value of extend parameter for conditional GOSUB instruction.
***********************************************************************************************************************/
#define IMPDRV_OCV_EXEPARAM_GOSUB   (1U)                /**< Index value of extend parameter for conditional GOSUB. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_OCV_CLBRKADDRR
 * Offset address of CLBRKADDRR register for OCV.
***********************************************************************************************************************/
#define IMPDRV_REG_OCV_CLBRKADDRR   (0x03F4U)           /**< Offset address of CLBRKADDRR register for OCV. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_OCV_CLCNDGSBR
 * Offset address of CLCNDGSBR register for OCV.
***********************************************************************************************************************/
#define IMPDRV_REG_OCV_CLCNDGSBR    (0x03FCU)           /**< Offset address of CLCNDGSBR register for OCV. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_OCV_VCR              (0x00000007U)       /**< Hardware version value for OCV. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_OCV_CLCNDGSBR_MASK
 * Bit mask for Condition for conditional GOSUB instruction.
***********************************************************************************************************************/
#define IMPDRV_OCV_CLCNDGSBR_MASK   (0x00000001U)       /**< Bit mask for Condition for conditional GOSUB. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
IMPDRV_STATIC
e_impdrv_errorcode_t impdrv_ocvctl_set_extend_config(
    const st_impdrv_corectl_t   *const p_corectl
);
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        p_corectl->param[IMPDRV_OCV_EXEPARAM_CLBRK] = IMPDRV_CLBRK_ADDR_INVALID;
        p_corectl->param[IMPDRV_OCV_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_INVALID;
    }
...
/***********************************************************************************************************************
* Start of function impdrv_ocvctl_set_cl_brk_addr()
* CD_PD_02_04_2055
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        p_corectl->param[IMPDRV_OCV_EXEPARAM_CLBRK] = cl_brk_addr;
    }
...
/***********************************************************************************************************************
* End of function impdrv_ocvctl_set_cl_brk_addr()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_ocvctl_set_cond_gosub()
* CD_PD_02_04_2058
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        {
            p_corectl->param[IMPDRV_OCV_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_OFF;
        }
        else
        {
            p_corectl->param[IMPDRV_OCV_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_ON;
        }
    }
...
/***********************************************************************************************************************
* End of function impdrv_ocvctl_set_cond_gosub()
***********************************************************************************************************************/
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_ocvctl_set_extend_config(p_corectl);
        }
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        {
            /** Write the Interrupt Mask Register(IMR1) */
            ercd = impdrv_osdep_write_reg(&p_corectl->device_io, IMPDRV_REG_OCV_IMR1, reg_val, false, 0U);
        }
    }
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        /** Clear interrupt status of INT and CLBRK status */
        if ((IMPDRV_EC_OK == ercd) && (0U != ((IMPDRV_OCV_SR1_INT | IMPDRV_OCV_SR1_CLBRK) & stat_sr1)))
        {
            /** Write the Status Clear Register(SCR1) */
            reg_val = (IMPDRV_OCV_SR1_INT | IMPDRV_OCV_SR1_CLBRK);
...
/***********************************************************************************************************************
* Start of function impdrv_ocvctl_set_extend_config()
* CD_PD_02_04_2056
...
)
{
    ...
    {
        exeparam_clbrk = p_corectl->param[IMPDRV_OCV_EXEPARAM_CLBRK];
        exeparam_gosub = p_corectl->param[IMPDRV_OCV_EXEPARAM_GOSUB];
    }
    ...
    if ((IMPDRV_EC_OK == ercd) && (IMPDRV_CLBRK_ADDR_INVALID != exeparam_clbrk))
    {
        ...
        ercd = impdrv_osdep_write_reg(&p_corectl->device_io, IMPDRV_REG_OCV_CLBRKADDRR,
                                                                reg_val, true, reg_val);
    }
    ...
    if ((IMPDRV_EC_OK == ercd) && (IMPDRV_EXEPARAM_INVALID != exeparam_gosub))
    {
        ...
        {
            reg_val |= IMPDRV_OCV_CLCNDGSBR_MASK;
        }
        ercd = impdrv_osdep_write_reg(&p_corectl->device_io, IMPDRV_REG_OCV_CLCNDGSBR,
                                                                    reg_val, true, reg_val);
    }
...
/***********************************************************************************************************************
* End of function impdrv_ocvctl_set_extend_config()
***********************************************************************************************************************/
...
)
{
    ...
    if (NULL != p_corectl)
    {
        ...
        clbrk_val = p_corectl->param[IMPDRV_OCV_EXEPARAM_CLBRK];
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        if (0U != (IMPDRV_OCV_SR1_CLBRK & stat_sr1))
        {
            /** When the CLBRK bit of SR1 register is not 0. */
            l_cb_ercd[l_cb_ercd_num] = IMPDRV_CB_RET_CLBRK;
            l_cb_ercd_num++;
            if (IMPDRV_STATE_EXEC == *p_state)
            {
                *p_state = IMPDRV_STATE_INT;
