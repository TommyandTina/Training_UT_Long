...
***********************************************************************************************************************/
#define IMPDRV_IMP_CORENUM_VAL      (2U)                /**< Maximum number of cores for IMP. */
/*******************************************************************************************************************//**
 * @def IMPDRV_IMP_EXEPARAM_CLBRK
 * Index value of extend parameter for CL break address.
***********************************************************************************************************************/
#define IMPDRV_IMP_EXEPARAM_CLBRK   (0U)                /**< Index value of extend parameter for CL break address.  */
/*******************************************************************************************************************//**
 * @def IMPDRV_IMP_EXEPARAM_GOSUB
 * Index value of extend parameter for conditional GOSUB instruction.
***********************************************************************************************************************/
#define IMPDRV_IMP_EXEPARAM_GOSUB   (1U)                /**< Index value of extend parameter for conditional GOSUB. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_IMP_CLBRKADDRR
 * Offset address of CLBRKADDRR register for IMP.
***********************************************************************************************************************/
#define IMPDRV_REG_IMP_CLBRKADDRR   (0x00C0U)           /**< Offset address of CLBRKADDRR register for IMP. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_IMP_CLCNDGSBR
 * Offset address of CLCNDGSBR register for IMP.
***********************************************************************************************************************/
#define IMPDRV_REG_IMP_CLCNDGSBR    (0x00C4U)           /**< Offset address of CLCNDGSBR register for IMP. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_IMP_VCR              (0x00900000U)       /**< Hardware version value for IMP. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_IMP_CLCNDGSBR_MASK
 * Bit mask for Condition for conditional GOSUB instruction.
***********************************************************************************************************************/
#define IMPDRV_IMP_CLCNDGSBR_MASK   (0x00000001U)       /**< Bit mask for Condition for conditional GOSUB. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_IMP_INTSTS_CLBRK
 *  CLBRK interrupt enable registration.
***********************************************************************************************************************/
#define IMPDRV_IMP_INTSTS_CLBRK     (0x00000400U)       /**< CL break interrupt enable registration. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
IMPDRV_STATIC
e_impdrv_errorcode_t impdrv_impctl_set_extend_config(
    const st_impdrv_corectl_t   *const p_corectl
);
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        p_corectl->param[IMPDRV_IMP_EXEPARAM_CLBRK] = IMPDRV_CLBRK_ADDR_INVALID;
        p_corectl->param[IMPDRV_IMP_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_INVALID;
    }
...
/***********************************************************************************************************************
* Start of function impdrv_impctl_set_cl_brk_addr()
* CD_PD_02_04_1055
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        p_corectl->param[IMPDRV_IMP_EXEPARAM_CLBRK] = cl_brk_addr;
    }
...
/***********************************************************************************************************************
* End of function impdrv_impctl_set_cl_brk_addr()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_impctl_set_cond_gosub()
* CD_PD_02_04_1058
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        {
            p_corectl->param[IMPDRV_IMP_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_OFF;
        }
        else
        {
            p_corectl->param[IMPDRV_IMP_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_ON;
        }
    }
...
/***********************************************************************************************************************
* End of function impdrv_impctl_set_cond_gosub()
***********************************************************************************************************************/
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_impctl_set_extend_config(p_corectl);
        }
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        /** Write the Interrupt Status Register(INTSTS) */
        ercd = impdrv_osdep_write_reg(&p_corectl->device_io, IMPDRV_REG_IMP_INTSTS,
                                                    (IMPDRV_IMP_INTSTS_INT | IMPDRV_IMP_INTSTS_CLBRK), false, 0U);
...
/***********************************************************************************************************************
* Start of function impdrv_impctl_set_extend_config()
* CD_PD_02_04_1056
...
)
{
    ...
    {
        exeparam_clbrk = p_corectl->param[IMPDRV_IMP_EXEPARAM_CLBRK];
        exeparam_gosub = p_corectl->param[IMPDRV_IMP_EXEPARAM_GOSUB];
    }
    ...
    if ((IMPDRV_EC_OK == ercd) && (IMPDRV_CLBRK_ADDR_INVALID != exeparam_clbrk))
    {
        ...
        ercd = impdrv_osdep_write_reg(&p_corectl->device_io, IMPDRV_REG_IMP_CLBRKADDRR,
    ...
    if ((IMPDRV_EC_OK == ercd) && (IMPDRV_EXEPARAM_INVALID != exeparam_gosub))
    {
        ...
        {
            reg_val |= IMPDRV_IMP_CLCNDGSBR_MASK;
        }
        ercd = impdrv_osdep_write_reg(&p_corectl->device_io, IMPDRV_REG_IMP_CLCNDGSBR,
                                                                    reg_val, true, reg_val);
    }
...
/***********************************************************************************************************************
* End of function impdrv_impctl_set_extend_config()
***********************************************************************************************************************/
...
)
{
    ...
    if (NULL != p_corectl)
    {
        ...
        clbrk_val = p_corectl->param[IMPDRV_IMP_EXEPARAM_CLBRK];
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        *p_state = IMPDRV_STATE_EXEC;
        ...
        if (0U != (IMPDRV_IMP_INTSTS_CLBRK & stat_val))
        {
