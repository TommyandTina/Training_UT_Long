...
***********************************************************************************************************************/
#define IMPDRV_PSC_SCTLR0_SWRST     (0x80000000U)       /**< SWRST register value for IMP.*/
/*******************************************************************************************************************//**
 * @def IMPDRV_PSC_SCTLR0_CLR
 * CLR register value for PSC.
***********************************************************************************************************************/
#define IMPDRV_PSC_SCTLR0_CLR       (0x00000000U)       /**< CLR register value for IMP.*/
/*******************************************************************************************************************//**
 * @def IMPDRV_PSC_SCTLR1_CLE
 * CLE register value for PSC.
***********************************************************************************************************************/
#define IMPDRV_PSC_SCTLR1_CLE       (0x00000001U)       /**< CLE register value for IMP.*/
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_PSC_REG_MAX_ADRS_CNFCHK
 *  End of offset address for ConfRegCheck of PSC.
***********************************************************************************************************************/
#define IMPDRV_PSC_REG_MAX_ADRS_CNFCHK  (0x0000FFFFU)   /** End of offset address for ConfRegCheck of PSC. */
...
)
{
    ...
    {
        /** Write the Status Clear Register(SCR) */
        ercd = impdrv_osdep_write_reg(&p_corectl->device_io, IMPDRV_REG_PSC_SCR, IMPDRV_PSC_SR_INT, false, 0U);
...
)
{
    ...
    while ((IMPDRV_EC_OK == ercd) && (param_num > index))
    {
        ...
        else if (IMPDRV_PSC_REG_MAX_ADRS_CNFCHK < p_chk_param[index].offset)
        {
            ercd = IMPDRV_EC_NG_NOTSUPPORT;
        }
        else
