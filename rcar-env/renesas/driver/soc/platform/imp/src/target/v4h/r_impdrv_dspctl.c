...
***********************************************************************************************************************/
#define IMPDRV_DSP_CORENUM_VAL          (4U)                /**< Maximum number of cores for IMP. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_REGVAL_VDSP_ERROR        (0x00030000U)       /**< GPIO_OUT register error value for VDSP. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REGVAL_VDSP_VERSION1
 * Hardware version value for VDSP.
***********************************************************************************************************************/
#define IMPDRV_REGVAL_VDSP_VERSION1     (0x20111119U)       /**< Hardware version valuer for VDSP */
/*******************************************************************************************************************//**
 ...
 * SPMI/SPIC address.
***********************************************************************************************************************/
#define IMPDRV_SPMX_ADDR_START          (0xED300000U)       /**< D_ADD3_START register REGION_START value for VDSP */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_VDSP_GPIO_WAIT_LOOP      (5U)       /**< The maximum wait loop count for the GPIO register */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_VDSP_P_PDTC_WAIT_LOOP    (5U)           /**< The maximum wait loop count for the P_PDTC register */
/*******************************************************************************************************************//**
 * @def IMPDRV_VDSP_P_CCOCR_WAIT_LOOP
 * The maximum wait loop count for the P_CCOCR register.
***********************************************************************************************************************/
#define IMPDRV_VDSP_P_CCOCR_WAIT_LOOP   (5U)           /**< The maximum wait loop count for the P_CCOCR register */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_VDSP_D_DDCL_WAIT_LOOP    (5U)           /**< The maximum wait loop count for the D_DDCL register */
/*******************************************************************************************************************//**
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        do {
            ...
            /* for VDSP error notice */
            if (IMPDRV_REGVAL_VDSP_ERROR == gp_val)
            {
...
)
{
    ...
    if ((IMPDRV_EC_OK == ercd) && (0U != (IMPDRV_VDSP_CHANNEL_OPE_BITS & intsts_val)))
    {
        ...
        if (0U != l_register)
        {
            ...
            /* for VDSP error notice */
            if (IMPDRV_REGVAL_VDSP_ERROR == int_status_val)
            {
                /** When the Timer0_out interrupt. error notice from VDSP */
                cb_ercd[cb_ercd_num] = IMPDRV_CB_RET_DSP_HALT;
                cb_ercd_num ++;
                if (IMPDRV_STATE_EXEC == state)
                {
                    state = IMPDRV_STATE_READY;
...
)
{
    ...
    const uint32_t  s_reg_addr_tbl[IMPDRV_DSP_CORENUM_VAL] = {
        ...
        IMPDRV_REG_IMPSLV_DSP2CSTS,
        IMPDRV_REG_IMPSLV_DSP3CSTS
    };
...
)
{
    ...
    if (ercd == IMPDRV_EC_OK)
    {
        l_register = IMPDRV_VDSP_P_L2A_ATT0;
        ercd = impdrv_osdep_write_reg(p_device_io[IMPDRV_DSP_VDSP_DEV_MAIN],
