...
***********************************************************************************************************************/
#define IMPDRV_INTEN0_CORE_MAX      (16U)               /**< Maximum number of cores for the Interrupt group 1. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_SYNCCTABLE_NUM       (24U)               /**< Maximum number of SYNCC table. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
#define IMPDRV_DSPCORE_NUM          (2U)               /**< Maximum number of DSP cores. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DSPNCT_VAL
 * Initial value of interrupt enable register.
***********************************************************************************************************************/
#define IMPDRV_REG_DSPNCT_VAL       (0x0003FFF3U)      /**< The setting value of DSPnCT. */
/*******************************************************************************************************************//**
 * @def IMPDRV_DSP_CORE_NUM
 * Maximum number of DSP core.
***********************************************************************************************************************/
#define IMPDRV_DSP_CORE_NUM        (2U)               /**< Maximum number of SYNCC table. */
...
st_impdrv_commonctl_ins_t g_impdrv_cmn_ctl_ins =
{
    ...
    0,                                                  /**< mutex_time_period                      */
    { NULL },                                           /**< device_io_dta                          */
    { {NULL}, {NULL} },                                 /**< device_io_dsp[IMPDRV_DSP_CORE_NUM]     */
...
)
{
    ...
    const st_impdrv_corectl_func_t s_corectl_func_tbl[IMPDRV_CORE_TYPE_MAX] =
    {
        ...
        {   impdrv_dmasctl_is_valid_core,   impdrv_dmasctl_check_state,     impdrv_dmasctl_set_state,
            impdrv_dmasctl_init_start,      impdrv_dmasctl_init_end,        NULL,
            NULL,                           impdrv_dmasctl_attr_init,       impdrv_dmasctl_set_mem_init,
            ...
            impdrv_dmasctl_set_cond_gosub,  NULL,                           impdrv_dmasctl_quit,
            impdrv_dmasctl_sync_start,      impdrv_dmasctl_sync_stop
        },
