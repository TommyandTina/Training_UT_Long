...
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_THREAD_OFFSET    (0x00000800U)       /**< H/W Register offset for DMAS sub-thread. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_REG_MAX_ADRS_CNFCHK
 *  End of offset address for ConfRegCheck of Slim-DMA.
***********************************************************************************************************************/
#define IMPDRV_DMAS_REG_MAX_ADRS_CNFCHK  (0x0000FFFFU)       /** End of offset address for ConfRegCheck of Slim-DMA. */
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        all_mask_val = IMPDRV_DMAS_SR_TRAP | IMPDRV_DMAS_SR_IER | IMPDRV_DMAS_SR_INT |
                    IMPDRV_DMAS_SR_WUP | IMPDRV_DMAS_SR_TEND;
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        write_info.chk_val = 0U;
         ...
         /** Write the Status Clear Register(SCR) */
        write_info.offset = IMPDRV_REG_DMAS_SCR;
        write_info.val =  IMPDRV_DMAS_SR_INT;
        write_info.read_back = false;
        ercd = impdrv_dmasctl_write_reg(&write_info);
...
)
{
    ...
    while ((IMPDRV_EC_OK == ercd) && (param_num > index))
    {
        ...
        else if (IMPDRV_DMAS_REG_MAX_ADRS_CNFCHK < p_chk_param[index].offset)
        {
            ercd = IMPDRV_EC_NG_NOTSUPPORT;
        }
        else
