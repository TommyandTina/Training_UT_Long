...
***********************************************************************************************************************/
#define IMPDRV_SYNCCTABLE_NUM       (30U)               /**< Maximum number of SYNCC table. */
/*******************************************************************************************************************//**
...
const st_impdrv_inten_tbl_t s_impdrv_inten_cnv_table[IMPDRV_INTEN_CORE_MAX] =
{
    ...
    {   IMPDRV_CORE_TYPE_PSCEXE,    0,  0x00008000U },
    {   IMPDRV_CORE_TYPE_PSCEXE,    1,  0x00010000U },
    {   IMPDRV_CORE_TYPE_CNN,       0,  0x00020000U }
};
...
)
{
    ...
    const st_impdrv_syncc_table_t s_impdrv_core_to_syncc_table[IMPDRV_SYNCCTABLE_NUM] =
    {
        ...
        {   IMPDRV_CORE_TYPE_PSCOUT,    4U,         0x34U   },
        {   IMPDRV_CORE_TYPE_PSCOUT,    5U,         0x35U   },
        {   IMPDRV_CORE_TYPE_PSCOUT,    6U,         0x36U   },
        {   IMPDRV_CORE_TYPE_PSCOUT,    7U,         0x37U   },
