...
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_ISR
 * Offset address of hardware register for ISR.
***********************************************************************************************************************/
#define IMPDRV_REG_ISR              (0x0100U)           /**< Offset address of hardware register for ISR. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_IMR
...
***********************************************************************************************************************/
#define IMPDRV_IRQCHTABLE_NUM       (5U)                /**< Maximum number of IRQ Channel table. */
/*******************************************************************************************************************//**
 * @def IMPDRV_SYNCCTABLE_NUM
 * Maximum number of SYNCC table.
***********************************************************************************************************************/
#define IMPDRV_SYNCCTABLE_NUM       (27U)               /**< Maximum number of SYNCC table. */
/*******************************************************************************************************************//**
...
const st_impdrv_inten_tbl_t s_impdrv_inten_cnv_table[IMPDRV_INTEN_CORE_MAX] =
{
    ...
    {   IMPDRV_CORE_TYPE_IMP,       4,  0x00000010U },
    {   IMPDRV_CORE_TYPE_IMP_SLIM,  0,  0x00000020U },
    {   IMPDRV_CORE_TYPE_OCV,       0,  0x00000040U },
    {   IMPDRV_CORE_TYPE_OCV,       1,  0x00000080U },
    {   IMPDRV_CORE_TYPE_OCV,       2,  0x00000100U },
    {   IMPDRV_CORE_TYPE_OCV,       3,  0x00000200U },
    {   IMPDRV_CORE_TYPE_OCV,       4,  0x00000400U },
    {   IMPDRV_CORE_TYPE_DMAC,      0,  0x00000800U },
    {   IMPDRV_CORE_TYPE_DMAC,      1,  0x00001000U },
    {   IMPDRV_CORE_TYPE_DMAC,      2,  0x00002000U },
    {   IMPDRV_CORE_TYPE_DMAC,      3,  0x00004000U },
    {   IMPDRV_CORE_TYPE_DMAC_SLIM, 0,  0x00008000U },
    {   IMPDRV_CORE_TYPE_DMAC_SLIM, 1,  0x00010000U },
    {   IMPDRV_CORE_TYPE_PSCEXE,    0,  0x00020000U },
    {   IMPDRV_CORE_TYPE_CNN,       0,  0x00040000U }
};

IMPDRV_STATIC
const st_impdrv_group_tbl_t s_impdrv_inten_group_table[IMPDRV_GROUP_MAX] =
{
    /** group_bit               group_reg   */
...
st_impdrv_commonctl_ins_t g_impdrv_cmn_ctl_ins =
{
    ...
    0,                                                  /**< mutex_time_period                      */
    { NULL },                                           /**< device_io_dta                          */
    { NULL, NULL, NULL, NULL, NULL, NULL }              /**< *p_commonctl[IMPDRV_INSTANCETABLE_NUM] */
};
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        write_val = ~write_val & IMPDRV_REG_IMR_INIT_VAL;
        write_val |= read_val  & (~IMPDRV_REG_IMR_INIT_VAL);
...
)
{
    ...
    if ((IMPDRV_EC_OK == ercd) && (IMPDRV_EC_OK == ercd_group))
    {
        ercd = impdrv_osdep_write_reg(&g_impdrv_cmn_ctl_ins.device_io_imptop,
                                    ...
                                    IMPDRV_REG_GROUP_INIT_VAL, true, IMPDRV_REG_GROUP_INIT_VAL);
    }
    ...
    {
        ercd = impdrv_osdep_write_reg(&g_impdrv_cmn_ctl_ins.device_io_imptop,
                s_impdrv_inten_addr[(uint32_t)p_commonctl->instance_num], IMPDRV_REG_IMR_INIT_VAL,
                true, IMPDRV_REG_IMR_INIT_VAL);
    }
...
)
{
    ...
    {
        IMPDRV_REG_ISR,         /**< IMPDRV_INSTANCE_0 */
        IMPDRV_REG_ISR,         /**< IMPDRV_INSTANCE_1 */
        IMPDRV_REG_ISR,         /**< IMPDRV_INSTANCE_2 */
        IMPDRV_REG_ISR,         /**< IMPDRV_INSTANCE_3 */
        IMPDRV_REG_ISR,         /**< IMPDRV_INSTANCE_4 */
    };
    ...
    st_impdrv_core_info_t       fb_core_info = {IMPDRV_CORE_TYPE_INVALID, 0U};
    e_impdrv_irq_group_t        irq_group;
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        ercd = impdrv_cmnctl_cnv_int_bit_core(s_impdrv_inten_cnv_table, IMPDRV_INTEN_CORE_MAX,
        ...
        {
            ercd = impdrv_cmnctl_fatal_cb(p_commonctl, &fb_core_info, IMPDRV_FC_UNEXPECT_INT, IMPDRV_EC_OK);
        }
    }
...
)
{
    ...
    /** Save the IRQ mask register value */
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_osdep_read_reg(
            &g_impdrv_cmn_ctl_ins.device_io_imptop,
            s_impdrv_inten_addr[(uint32_t)instance_num],
            &reg_val
        );
        if (IMPDRV_EC_OK == ercd)
        {
            p_commonctl->irq_mask_value = reg_val;
        }
    }
...
)
{
    ...
    /** Force the IRQ mask register setting. */
    if (IMPDRV_EC_OK == ercd)
    {
        index = 0U;
        while (IMPDRV_INTEN_CORE_MAX > index)
        {
            if ((s_impdrv_inten_cnv_table[index].core_type == p_core_info->core_type)
                && (s_impdrv_inten_cnv_table[index].core_num == p_core_info->core_num))
            {
                reg_val = IMPDRV_REG_IMR_INIT_VAL;
                reg_val &= ~(s_impdrv_inten_cnv_table[index].bit);
                break;
            }
            index++;
        }
...
)
{
    ...
    /** Restore of IRQ mask register setting */
    if (IMPDRV_EC_OK == ercd)
    {
        reg_val = p_commonctl->irq_mask_value;
        ercd = impdrv_osdep_write_reg(
            &g_impdrv_cmn_ctl_ins.device_io_imptop,
            s_impdrv_inten_addr[(uint32_t)instance_num],
            reg_val, true, reg_val
...
)
{
    ...
    const st_impdrv_corectl_func_t s_corectl_func_tbl[IMPDRV_CORE_TYPE_MAX] =
    {
        ...
        {   impdrv_impctl_is_valid_core,    impdrv_impctl_check_state,      impdrv_impctl_set_state,
            ...
            impdrv_impctl_bus_if_check,     impdrv_impctl_conf_reg_check,   NULL,
        ...
        {   impdrv_impsctl_is_valid_core,   impdrv_impsctl_check_state,     impdrv_impsctl_set_state,
            ...
            impdrv_impsctl_bus_if_check,    impdrv_impsctl_conf_reg_check,  NULL,
            NULL,                           impdrv_impsctl_pm_get_state,    impdrv_impsctl_quit,
            NULL,                           NULL
        },
        ...
        {   impdrv_dmactl_is_valid_core,    impdrv_dmactl_check_state,      impdrv_dmactl_set_state,
            ...
            impdrv_dmactl_bus_if_check,     impdrv_dmactl_conf_reg_check,   NULL,
        ...
        {   impdrv_dmasctl_is_valid_core,   impdrv_dmasctl_check_state,     impdrv_dmasctl_set_state,
            ...
            NULL,                           impdrv_dmasctl_conf_reg_check,  NULL,
            NULL,                           impdrv_dmasctl_pm_get_state,    impdrv_dmasctl_quit,
            NULL,                           NULL
        },
...
/***********************************************************************************************************************
* Start of function impdrv_cmnctl_get_dsp_func()
* CD_PD_02_03_0045
...
)
{
    ...
    const st_impdrv_syncc_table_t s_impdrv_core_to_syncc_table[IMPDRV_SYNCCTABLE_NUM] =
    {
        ...
        {   IMPDRV_CORE_TYPE_IMP,       4U,         0x04U   },
        {   IMPDRV_CORE_TYPE_IMP_SLIM,  0U,         0x05U   },
        ...
        {   IMPDRV_CORE_TYPE_PSCOUT,    0U,         0x30U   },
        {   IMPDRV_CORE_TYPE_PSCOUT,    1U,         0x31U   },
        {   IMPDRV_CORE_TYPE_PSCOUT,    2U,         0x32U   },
        {   IMPDRV_CORE_TYPE_PSCOUT,    3U,         0x33U   },
        {   IMPDRV_CORE_TYPE_CNN,       0U,         0x40U   },
        {   IMPDRV_CORE_TYPE_IMR,       4U,         0x54U   },
        {   IMPDRV_CORE_TYPE_IMR,       5U,         0x55U   },
...
)
{
    ...
    if ((IMPDRV_INSTANCE_5 == instance_num) || (IMPDRV_INSTANCE_6 == instance_num))
    {
        ercd = IMPDRV_EC_NG_NOTSUPPORT;
    }
...
/***********************************************************************************************************************
* Start of function impdrv_cmnctl_get_init_param()
* CD_PD_02_03_0046
...
)
{
    ...
    /** Input parameter confirmation process */
    if ((NULL == p_commonctl) || (NULL == p_irq_priority) || (NULL == p_osal_cb_args))
    {
        ercd = IMPDRV_EC_NG_ARGNULL;
    }
    else
...
/***********************************************************************************************************************
* End of function impdrv_cmnctl_get_init_param()
***********************************************************************************************************************/
...
)
{
    ...
    static
    const st_impdrv_chk_param_t s_chk_param_distributor[] = {
        { 0x0310U, 0x00000000U, 0xFFFFFFFFU },
        { 0x8110U, 0x00000000U, 0xFFFFFFFFU },
        { 0x8114U, 0x00000000U, 0xFFFFFFFFU },
        { 0x8118U, 0x00000000U, 0xFFFFFFFFU }
    };
    static
    const uint32_t s_param_num_distributor = sizeof(s_chk_param_distributor) / sizeof(s_chk_param_distributor[0]);

    /** Input parameter confirmation process */
    if ((NULL == p_commonctl) || (NULL == g_impdrv_cmn_ctl_ins.device_io_imptop.handle))
    {
        ercd = IMPDRV_EC_NG_ARGNULL;
    }

    /** Check the distributor register */
    index = 0U;
    while ((IMPDRV_EC_OK == ercd) && (s_param_num_distributor > index))
    {
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_osdep_read_reg(
                &g_impdrv_cmn_ctl_ins.device_io_imptop,
                (uint32_t)s_chk_param_distributor[index].offset,
                &reg_val
            );
        }
        if (IMPDRV_EC_OK == ercd)
        {
            ...
            if ((reg_val & s_chk_param_distributor[index].bit_mask) != s_chk_param_distributor[index].data)
            {
                /** Error Handring */
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_cmnctl_cnv_int_core_bit(
            p_cmn_init_data->p_core_info,
            p_cmn_init_data->use_core_num,
            s_impdrv_inten_cnv_table,
            IMPDRV_INTEN_CORE_MAX,
            p_use_core_info
        );
    }
    ...
    {
        i = 0U;
        while ((IMPDRV_INSTANCETABLE_NUM - 1U)  > i)
        {
            if ((NULL != g_impdrv_cmn_ctl_ins.p_commonctl[s_impdrv_cnv_ins_table[i]]) &&
...
)
{
    ...
    else if (IMPDRV_INTEN_CORE_MAX != cnv_table_num)
    {
        ercd = IMPDRV_EC_NG_PARAM;
    }
    else
...
)
{
    ...
    uint32_t                intsel = 0U;
    uint32_t                write_mask_val = ~write_val & IMPDRV_REG_IMR_INIT_VAL;
