...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_impdrv_dmasctl.c
* Version      : 3.19.0
* Product Name : IMP Driver
* Device(s)    : R-Car
* Description  : IMP Driver function of impdrv_dmasctl for xOS3
***********************************************************************************************************************/

/**
 * @file r_impdrv_dmasctl.c
 */
 ...
 **********************************************************************************************************************/
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_CORENUM_VAL
 * Maximum number of cores for DMAS.
***********************************************************************************************************************/
#define IMPDRV_DMAS_CORENUM_VAL          (4U)                /**< Maximum number of cores for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_EXEPARAM_CLBRK
 * Index value of extend parameter for CL break address.
***********************************************************************************************************************/
#define IMPDRV_DMAS_EXEPARAM_CLBRK       (0U)                /**< Index value of extend parameter for CL break address.*/
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_EXEPARAM_GOSUB
 * Index value of extend parameter for conditional GOSUB instruction.
***********************************************************************************************************************/
#define IMPDRV_DMAS_EXEPARAM_GOSUB       (1U)               /**< Index value of extend param for conditional GOSUB. */
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_CORENUM0MAIN
 * DMAS Core 0 Main thread identification value.
***********************************************************************************************************************/
#define IMPDRV_DMAS_CORENUM0MAIN         (0U)                /**< DMAS Core 0 Main thread identification value. */
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_CORENUM0SUB
 * DMAS Core 0 Sub thread identification value.
***********************************************************************************************************************/
#define IMPDRV_DMAS_CORENUM0SUB          (1U)                /**< DMAS Core 0 Sub thread identification value.  */
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_CORENUM1MAIN
 * DMAS Core 1 Main thread identification value.
***********************************************************************************************************************/
#define IMPDRV_DMAS_CORENUM1MAIN         (2U)                /**< DMAS Core 1 Main thread identification value. */
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_CORENUM1SUB
 * DMAS Core 1 Sub thread identification value.
***********************************************************************************************************************/
#define IMPDRV_DMAS_CORENUM1SUB          (3U)                /**< DMAS Core 1 Sub thread identification value.  */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SCTLR
 * Offset address of SCTLR register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SCTLR            (0x0004U)           /**< Offset address of SCTLR register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SR
 * Offset address of SR register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SR               (0x0008U)           /**< Offset address of SR register for DMAS. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SER
 * Offset address of VCR register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SER              (0x0010U)           /**< Offset address of VCR register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_IMR
 * Offset address of IMR register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_IMR              (0x0014U)           /**< Offset address of IMR register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SCTLR1
 * Offset address of SCTLR1 register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SCTLR1           (0x0018U)           /**< Offset address of SCTLR1 register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_CLSAR
 * Offset address of CLSAR register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_CLSAR            (0x0028U)           /**< Offset address of CLSAR register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SR1
 * Offset address of SR1 register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SR1              (0x0030U)           /**< Offset address of SR1 register for DMAS. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SYNCCR1
 * Offset address of SYNCCR1 register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SYNCCR1          (0x00ECU)           /**< Offset address of SYNCCR1 register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SYNCCR2
 * Offset address of SYNCCR2 register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SYNCCR2          (0x00F0U)           /**< Offset address of SYNCCR2 register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_SYNCCR3
 * Offset address of SYNCCR3 register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_SYNCCR3          (0x00F4U)           /**< Offset address of SYNCCR3 register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_CLBRKADDRR
 * Offset address of CLBRKADDRR register for DMA.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_CLBRKADDRR       (0x03F4U)           /**< Offset address of CLBRKADDRR register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_CLCNDGSBR
 * Offset address of CLCNDGSBR register for DMAS.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_CLCNDGSBR        (0x03FCU)           /**< Offset address of CLCNDGSBR register for DMAS. */
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_VCR
 * Hardware version value for DMAS.
***********************************************************************************************************************/
#define IMPDRV_DMAS_VCR                  (0x21111616U)       /**< Hardware version value for DMAS. */
/*******************************************************************************************************************//**
...
/*******************************************************************************************************************//**
 * @def IMPDRV_DMAS_CLCNDGSBR_MASK
 * Bit mask for Condition for conditional GOSUB instruction.
***********************************************************************************************************************/
#define IMPDRV_DMAS_CLCNDGSBR_MASK       (0x00000001U)       /**< Bit mask for Condition for conditional GOSUB. */
/*******************************************************************************************************************//**
 * @def IMPDRV_REG_DMAS_THREAD_OFFSET
 * H/W Register offset for DMAS sub-thread.
***********************************************************************************************************************/
#define IMPDRV_REG_DMAS_THREAD_OFFSET    (0x00001000U)       /**< H/W Register offset for DMAS sub-thread. */
/*******************************************************************************************************************//**
...
***********************************************************************************************************************/
IMPDRV_STATIC
e_impdrv_errorcode_t impdrv_dmasctl_set_extend_config(
    st_impdrv_corectl_t         *const p_corectl,
    const bool                  is_sub_thread
);
...
======================================================================================================================*/
/***********************************************************************************************************************
* Start of function impdrv_dmasctl_is_valid_core()
* CD_PD_02_04_3001
...
)
{
    ...
    if (core_num < IMPDRV_DMAS_CORENUM_VAL)
    {
        is_valid_core = true;
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_is_valid_core()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_check_state()
* CD_PD_02_04_3002
...
)
{
    ...
    {
        /** Check core number */
        is_valid_core = impdrv_dmasctl_is_valid_core(core_num);
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_check_state()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_state()
* CD_PD_02_04_3003
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_state()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_init_start()
* CD_PD_02_04_3004
...
)
{
    ...
    bool                    is_valid_core;
    uint32_t                ret = 0U;
    st_impdrv_core_info_t   core_info = {IMPDRV_CORE_TYPE_DMAC_SLIM, 0U};

    uint32_t                    pair_thead_num = core_num + 1U;
    bool                        is_sub_thread = false;
    st_impdrv_device_handle_t   device_handle_cnn;
    ...
    /** V4M's SDMAC controls CNN's power supply. */
    if (IMPDRV_EC_OK == ercd)
    {
        const st_impdrv_core_info_t core_info_cnn = {IMPDRV_CORE_TYPE_CNN, 0U};
        device_handle_cnn.handle = NULL;

        ercd = impdrv_osdep_pow_on_imp(&device_handle_cnn, core_info_cnn);
    }

    if (IMPDRV_EC_OK == ercd)
    {
        /** Request osdep to close the core */
        ercd = impdrv_osdep_dev_close(&device_handle_cnn);
    }
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        is_sub_thread = impdrv_dmasctl_is_sub_thread(core_num);
        ...
        if (NULL == p_coretypectl->core_ctl[pair_thead_num].device_io.handle)
        {
            ...
            core_info.core_num =  impdrv_dmasctl_osal_core_num(core_num);
            if (((uint32_t)-1) != core_info.core_num)
            {
                /** Request osdep to open core */
                ercd = impdrv_osdep_dev_open_imp(&(p_coretypectl->core_ctl[core_num].device_io), core_info);
            }
            else
            {
                ercd = IMPDRV_EC_NG_PARAM;
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_read_reg(
            &(p_coretypectl->core_ctl[core_num].device_io), IMPDRV_REG_DMAS_VCR, &ret, is_sub_thread);
    }

    /** Check core version (unsupported core?) */
    if (IMPDRV_EC_OK == ercd)
    {
        if (IMPDRV_DMAS_VCR != ret)
        {
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_init_start()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_init_end()
* CD_PD_02_04_3005
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_init_end()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_sync_start()
* CD_PD_02_04_3060
* [Covers: UD_PD_UD02_04_0060]
***********************************************************************************************************************/
e_impdrv_errorcode_t impdrv_dmasctl_sync_start(
...
)
{
    ...
    uint32_t                    pair_thead_num = core_num + 1U;
    bool                        is_sub_thread;
    st_impdrv_coretypectl_t     *p_coretypectl;
    st_impdrv_device_handle_t   *p_device_handle_cnn;


    /** Input parameter confirmation process */
    if (NULL == coretype_ctl)
    {
        ercd = IMPDRV_EC_NG_ARGNULL;
    }
    else
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        p_coretypectl = &coretype_ctl[IMPDRV_CORE_TYPE_DMAC_SLIM];
        ercd = impdrv_dmasctl_check_state(&p_coretypectl->core_ctl[core_num], core_num, IMPDRV_STATE_INIT);
    }

    /** V4M's SDMAC controls CNN's power supply. */
    if (IMPDRV_EC_OK == ercd)
    {
        p_device_handle_cnn = &(coretype_ctl[IMPDRV_CORE_TYPE_CNN].core_ctl[0].device_io);
        if (NULL == p_device_handle_cnn->handle)
        {
            const st_impdrv_core_info_t core_info_cnn = {IMPDRV_CORE_TYPE_CNN, 0U};

            ercd = impdrv_osdep_pow_on_imp(p_device_handle_cnn, core_info_cnn);
        }
    }

    /** Request for device open */
    if (IMPDRV_EC_OK == ercd)
    {
        /** Check if main thread or sub thread */
        is_sub_thread = impdrv_dmasctl_is_sub_thread(core_num);
        ...
        if (NULL == p_coretypectl->core_ctl[pair_thead_num].device_io.handle)
        {
            ...
            if (IMPDRV_EC_OK == ercd)
            {
                ...
                {
                    ercd = impdrv_dmasctl_init_core(&p_coretypectl->core_ctl[core_num]);
                }
            }
        }
        else
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_set_state(&p_coretypectl->core_ctl[core_num], IMPDRV_STATE_READY);
    }

    return ercd;
}
/***********************************************************************************************************************
* End of function impdrv_dmasctl_sync_start()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_sync_stop()
* CD_PD_02_04_3061
* [Covers: UD_PD_UD02_04_0061]
***********************************************************************************************************************/
e_impdrv_errorcode_t impdrv_dmasctl_sync_stop(
    st_impdrv_coretypectl_t coretype_ctl[IMPDRV_CORE_TYPE_MAX],
    const uint32_t          core_num
)
{
    ...
    {
        p_coretypectl = &coretype_ctl[IMPDRV_CORE_TYPE_DMAC_SLIM];
        ercd = impdrv_dmasctl_check_state(&p_coretypectl->core_ctl[core_num], core_num, IMPDRV_STATE_READY);
    }

    /** Request for device close */
    if (IMPDRV_EC_OK == ercd)
    {
        /** Check if main thread or sub thread */
        is_sub_thread = impdrv_dmasctl_is_sub_thread(core_num);
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_set_state(&p_coretypectl->core_ctl[core_num], IMPDRV_STATE_INIT);
    }

    /** V4M's SDMAC controls CNN's power supply. */
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_cnnctl_sync_pow_off(coretype_ctl);
        if (IMPDRV_EC_OK != ercd)
        {
            (void)impdrv_dmasctl_set_state(&p_coretypectl->core_ctl[core_num], IMPDRV_STATE_READY);
        }
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_sync_stop()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_quit()
* CD_PD_02_04_3024
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_quit()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_attr_init()
* CD_PD_02_04_3008
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_check_state(p_corectl, core_num, IMPDRV_STATE_INIT);
    }
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        p_corectl->param[IMPDRV_DMAS_EXEPARAM_CLBRK] = IMPDRV_CLBRK_ADDR_INVALID;
        p_corectl->param[IMPDRV_DMAS_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_INVALID;
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_attr_init()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_mem_init()
* CD_PD_02_04_3009
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_mem_init()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_core_map()
* CD_PD_02_04_3010
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_check_state(p_corectl, core_num, IMPDRV_STATE_READY);
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_core_map()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_cl()
* CD_PD_02_04_3011
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_cl()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_irq_mask()
* CD_PD_02_04_3012
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_irq_mask()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_cl_brk_addr()
* CD_PD_02_04_3055
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        {
            ercd = impdrv_dmasctl_check_state(p_corectl, core_num, IMPDRV_STATE_INT);
        }
    }
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        p_corectl->param[IMPDRV_DMAS_EXEPARAM_CLBRK] = cl_brk_addr;
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_cl_brk_addr()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_cond_gosub()
* CD_PD_02_04_3058
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        {
            p_corectl->param[IMPDRV_DMAS_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_OFF;
        }
        else
        {
            p_corectl->param[IMPDRV_DMAS_EXEPARAM_GOSUB] = IMPDRV_EXEPARAM_ON;
        }
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_cond_gosub()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_execute()
* CD_PD_02_04_3014
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_check_core_busy(p_corectl, is_sub_thread);
    }
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        all_mask_val = IMPDRV_DMAS_SR_TRAP | IMPDRV_DMAS_SR_IER | IMPDRV_DMAS_SR_INT |
        ...
        /** Soft reset */
        ercd = impdrv_dmasctl_soft_reset(p_corectl, is_sub_thread);

        /** SYNCC register setting */
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_dmasctl_set_syncc_config(p_corectl, is_sub_thread);
        }

        /** Set extended attribute to related registers */
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_dmasctl_set_extend_config(p_corectl, is_sub_thread);
        }
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ...
            write_info.offset = IMPDRV_REG_DMAS_SCR;
            write_info.val =  all_mask_val;
            write_info.read_back = false;
            ercd = impdrv_dmasctl_write_reg(&write_info);

            /** Write the Interrupt Mask Register(IMR) */
            if (IMPDRV_EC_OK == ercd)
            {
                inten_val = impdrv_dmasctl_get_inten_val(p_corectl);
                if (0U == inten_val)
                {
                    ercd = IMPDRV_EC_NG_PARAM;
                }
                ...
                if (IMPDRV_EC_OK == ercd)
                {
                    write_info.offset = IMPDRV_REG_DMAS_SER;
                    write_info.val =  inten_val | IMPDRV_DMAS_SER_FIX;
                ...
                if (IMPDRV_EC_OK == ercd)
                {
                    ...
                    write_info.offset = IMPDRV_REG_DMAS_IMR;
                    write_info.val =  (all_mask_val & ~inten_val) | IMPDRV_DMAS_SER_FIX;
                    write_info.chk_val = write_info.val;
                    ercd = impdrv_dmasctl_write_reg(&write_info);
                }
            }
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ...
            write_info.offset = IMPDRV_REG_DMAS_CLSAR;
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ...
            ercd = impdrv_dmasctl_set_state(p_corectl, IMPDRV_STATE_EXEC);
            if (IMPDRV_EC_OK == ercd)
            {
            ...
            if (IMPDRV_EC_OK == ercd)
            {
                ...
                write_info.offset = IMPDRV_REG_DMAS_SCTLR1;
                write_info.val =  IMPDRV_DMAS_SCTLR1_PS;
                write_info.read_back = false;
                ercd = impdrv_dmasctl_write_reg(&write_info);
            }
        }
        ...
        if (IMPDRV_EC_OK != ercd)
        {
            ...
            write_info.offset = IMPDRV_REG_DMAS_IMR;
            write_info.val = all_mask_val | IMPDRV_DMAS_SER_FIX;
            write_info.read_back = false;
            (void)impdrv_dmasctl_write_reg(&write_info);

            /** Restore core state */
            (void)impdrv_dmasctl_set_state(p_corectl, IMPDRV_STATE_READY);
        }
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_execute()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_int_handler()
* CD_PD_02_04_3015
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        ercd = impdrv_dmasctl_read_reg(&p_corectl->device_io, IMPDRV_REG_DMAS_SR,
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_check_state(p_corectl, core_num, IMPDRV_STATE_EXEC);
    }

    /** Call back occurrence of an interrupt to the CL execute requester */
    if (IMPDRV_EC_OK == ercd)
    {
        ercd = impdrv_dmasctl_check_inten(stat_val,
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ...
            write_info.p_device_handle = &p_corectl->device_io;
            write_info.offset = IMPDRV_REG_DMAS_IMR;
            write_info.val = reg_val | IMPDRV_DMAS_SER_FIX;
            write_info.is_sub_thread = is_sub_thread;
            write_info.read_back = true;
            write_info.chk_val = write_info.val;
            ercd = impdrv_dmasctl_write_reg(&write_info);
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ...
            ercd = impdrv_dmasctl_read_reg(&p_corectl->device_io, IMPDRV_REG_DMAS_SR1, &stat_sr1, is_sub_thread);
        }
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            ercd = impdrv_dmasctl_int_cb(p_corectl, core_num, cb_ercd, cb_ercd_num, is_check_intclear, stat_sr1);
        }
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_int_handler()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_resume_exe()
* CD_PD_02_04_3016
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        {
            write_info.offset = IMPDRV_REG_DMAS_SCR;
            write_info.val = (IMPDRV_DMAS_SR_INT | IMPDRV_DMAS_SR_CLBRK);
            write_info.read_back = false;
            write_info.chk_val = 0U;
            ercd = impdrv_dmasctl_write_reg(&write_info);
        }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_resume_exe()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_conf_reg_check()
* CD_PD_02_04_3054
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_conf_reg_check()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_max_core()
* CD_PD_02_04_3063
* [Covers: UD_PD_UD02_04_0063]
***********************************************************************************************************************/
uint32_t impdrv_dmasctl_max_core(
    void
)
{
    /** initialize local variables */
    uint32_t max_core = IMPDRV_DMAS_CORENUM_VAL;

    /** Returns the maximum core number */
    return max_core;
}
/***********************************************************************************************************************
* End of function impdrv_dmasctl_max_core()
***********************************************************************************************************************/
...
======================================================================================================================*/
/***********************************************************************************************************************
* Start of function impdrv_dmasctl_is_sub_thread()
* CD_PD_02_04_3021
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_is_sub_thread()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_osal_core_num()
* CD_PD_02_04_3022
...
)
{
    ...
    switch (core_num)
    {
        case IMPDRV_DMAS_CORENUM0MAIN:
        case IMPDRV_DMAS_CORENUM0SUB:
        {
            osal_core_num = 0U;
            break;
        }

        case IMPDRV_DMAS_CORENUM1MAIN:
        case IMPDRV_DMAS_CORENUM1SUB:
        {
            osal_core_num = 1U;
            break;
        }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_osal_core_num()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_read_reg()
* CD_PD_02_04_3023
...
)
{
    ...
    else if (IMPDRV_REG_DMAS_THREAD_OFFSET <= offset)
    {
        ercd = IMPDRV_EC_NG_PARAM;
    }
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        if (true == is_sub_thread)
        {
            ...
            addr += IMPDRV_REG_DMAS_THREAD_OFFSET;
        }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_read_reg()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_write_reg()
* CD_PD_02_04_3024
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        if ((IMPDRV_REG_DMAS_THREAD_OFFSET <= p_write_info->offset) ||
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_write_reg()
***********************************************************************************************************************/
/***********************************************************************************************************************
* Start of function impdrv_dmasctl_init_core()
* CD_PD_02_04_3020
...
)
{
    ...
    {
        write_info.p_device_handle = &p_corectl->device_io;
        write_info.offset = IMPDRV_DMAS_RAMTSTR;
        write_info.val = IMPDRV_DMAS_MASK;
    ...
    {
        loop = 0U;
        while (loop < IMPDRV_DMAS_LOOPTIME_VAL)
        {
            ercd = impdrv_dmasctl_read_reg(&p_corectl->device_io, IMPDRV_DMAS_RAMTSTR,
                &reg_val, false
            );
            if (IMPDRV_EC_OK != ercd)
            {
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_init_core()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_check_core_busy()
* CD_PD_02_04_3040
...
)
{
    ...
    {
        /** Check core busy */
        ercd = impdrv_dmasctl_read_reg(&p_corectl->device_io, IMPDRV_REG_DMAS_SCTLR1, &reg_val, is_sub_thread);
        if (IMPDRV_EC_OK == ercd)
        {
            /** When Check busy error, it is judged that preparation for execution is not in place */
            if (0U != (IMPDRV_DMAS_SCTLR1_PS & reg_val))
            {
                ercd = IMPDRV_EC_NG_SEQSTATE;
            }
        }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_check_core_busy()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_soft_reset()
* CD_PD_02_04_3042
...
)
{
    ...
    else
    {
        ...
        write_info.p_device_handle = &p_corectl->device_io;
        write_info.offset = IMPDRV_REG_DMAS_SCTLR;
        write_info.val = IMPDRV_DMAS_SCTLR_SWRST;
        write_info.is_sub_thread = is_sub_thread;
        write_info.read_back = false;
        write_info.chk_val = 0U;
        ercd = impdrv_dmasctl_write_reg(&write_info);
        if (IMPDRV_EC_OK == ercd)
        {
            write_info.val = IMPDRV_DMAS_SCTLR_CLR;
            ercd = impdrv_dmasctl_write_reg(&write_info);
        }
    }
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_soft_reset()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_syncc_config()
* CD_PD_02_04_3044
...
)
{
    ...
    else
    {
        ...
        write_info.p_device_handle = &p_corectl->device_io;
        write_info.offset = IMPDRV_REG_DMAS_SYNCCR0;
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            write_info.offset = IMPDRV_REG_DMAS_SYNCCR1;
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            write_info.offset = IMPDRV_REG_DMAS_SYNCCR2;
        ...
        if (IMPDRV_EC_OK == ercd)
        {
            write_info.offset = IMPDRV_REG_DMAS_SYNCCR3;
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_syncc_config()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_set_extend_config()
* CD_PD_02_04_3057
...
)
{
    ...
    else
    {
        ...
        exeparam_clbrk = p_corectl->param[IMPDRV_DMAS_EXEPARAM_CLBRK];
        exeparam_gosub = p_corectl->param[IMPDRV_DMAS_EXEPARAM_GOSUB];
    }

    /** Write the CL Break Address Register(CLBRKADDRR) */
    if ((IMPDRV_EC_OK == ercd) && (IMPDRV_CLBRK_ADDR_INVALID != exeparam_clbrk))
    {
        write_info.offset = IMPDRV_REG_DMAS_CLBRKADDRR;
    ...
    if ((IMPDRV_EC_OK == ercd) && (IMPDRV_EXEPARAM_INVALID != exeparam_gosub))
    {
        ...
        {
            reg_val |= IMPDRV_DMAS_CLCNDGSBR_MASK;
        }
        write_info.offset = IMPDRV_REG_DMAS_CLCNDGSBR;
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_set_extend_config()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_get_inten_val()
* CD_PD_02_04_3025
...
)
{
    ...
    if (NULL != p_corectl)
    {
        ...
        clbrk_val = p_corectl->param[IMPDRV_DMAS_EXEPARAM_CLBRK];
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_get_inten_val()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_check_inten()
* CD_PD_02_04_3047
...
)
{
    ...
    if (IMPDRV_EC_OK == ercd)
    {
        ...
        *p_state = IMPDRV_STATE_EXEC;
        ...
        if (0U != (IMPDRV_DMAS_SR_CLBRK & stat_val))
        {
        ...
        if (0U != (IMPDRV_DMAS_SR_INT & stat_val))
        {
        ...
        if (0U != (IMPDRV_DMAS_SR_TRAP & stat_val))
        {
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_check_inten()
***********************************************************************************************************************/

/***********************************************************************************************************************
* Start of function impdrv_dmasctl_int_cb()
* CD_PD_02_04_3045
...
/***********************************************************************************************************************
* End of function impdrv_dmasctl_int_cb()
***********************************************************************************************************************/
