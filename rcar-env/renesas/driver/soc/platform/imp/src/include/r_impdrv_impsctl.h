...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_impdrv_impsctl.h
* Version      : 3.19.0
* Product Name : IMP Driver
* Device(s)    : R-Car
* Description  : IMP Driver private header of impdrv_impsctl for xOS3
***********************************************************************************************************************/

#ifndef R_IMPDRV_IMPSCTL_H
#define R_IMPDRV_IMPSCTL_H
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_IMPSCTL
 * @defgroup IMPDRV_IMPSCTL_Defines macro definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_IMPSCTL
 * @defgroup IMPDRV_IMPSCTL_GENERIC_ENUM  IMPDRV Generic Enumeration
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_IMPSCTL
 * @defgroup IMPDRV_IMPSCTL_GENERIC_TYPES IMPDRV Generic Type definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/******************************************************************************************************************//**
 * @defgroup IMPDRV_IMPSCTL IMPDRV IMPSCTL
 *
 * @{
 *********************************************************************************************************************/
