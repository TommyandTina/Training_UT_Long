...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_impdrv_dmactl.h
* Version      : 3.19.0
* Product Name : IMP Driver
* Device(s)    : R-Car
* Description  : IMP Driver private header of impdrv_dmactl for xOS3
***********************************************************************************************************************/

#ifndef R_IMPDRV_DMACTL_H
#define R_IMPDRV_DMACTL_H
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_DMACTL
 * @defgroup IMPDRV_DMACTL_Defines macro definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_DMACTL
 * @defgroup IMPDRV_DMACTL_GENERIC_ENUM  IMPDRV Generic Enumeration
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_DMACTL
 * @defgroup IMPDRV_DMACTL_GENERIC_TYPES IMPDRV Generic Type definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/******************************************************************************************************************//**
 * @defgroup IMPDRV_DMACTL IMPDRV DMACTL
 *
 * @{
 *********************************************************************************************************************/
