...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_impdrv_dmasctl.h
* Version      : 3.19.0
* Product Name : IMP Driver
* Device(s)    : R-Car
* Description  : IMP Driver private header of impdrv_dmasctl for xOS3
***********************************************************************************************************************/

#ifndef R_IMPDRV_DMASCTL_H
#define R_IMPDRV_DMASCTL_H
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_DMASCTL
 * @defgroup IMPDRV_DMASCTL_Defines macro definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_DMASCTL
 * @defgroup IMPDRV_DMASCTL_GENERIC_ENUM  IMPDRV Generic Enumeration
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_DMASCTL
 * @defgroup IMPDRV_DMASCTL_GENERIC_TYPES IMPDRV Generic Type definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/******************************************************************************************************************//**
 * @defgroup IMPDRV_DMASCTL IMPDRV DMASCTL
 *
 * @{
 *********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @brief           Starts controlling the core in sync.
 * @syncasync       Synchronous
 * @reentrant       Non-Reentrant
 * @param[in,out]   p_coretypectl           Control data structure
 * @param[in]       core_num                Specified core number
 * @return          Function result
 * @retval          IMPDRV_EC_OK                    Successful completion
 * @retval          IMPDRV_EC_NG_SEQSTATE           Sequence error
...
/*******************************************************************************************************************//**
 * @brief           Stop controlling the core in sync
 * @syncasync       Synchronous
 * @reentrant       Non-Reentrant
 * @param[in,out]   p_coretypectl           Control data structure
 * @param[in]       core_num                Specified core number
...
/*******************************************************************************************************************//**
 * @brief            Configuration register check.
 * @syncasync        Synchronous.
 * @reentrant        Non-Reentrant
...
/*******************************************************************************************************************//**
 * @brief           Get the maximum core number
 * @syncasync       Synchronous
 * @reentrant       Non-Reentrant
