...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_impdrv_cnnctl.h
* Version      : 3.19.0
* Product Name : IMP Driver
* Device(s)    : R-Car
* Description  : IMP Driver private header of impdrv_cnnctl for xOS3
***********************************************************************************************************************/

#ifndef R_IMPDRV_CNNCTL_H
#define R_IMPDRV_CNNCTL_H
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_CNNCTL
 * @defgroup IMPDRV_CNNCTL_Defines macro definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_CNNCTL
 * @defgroup IMPDRV_CNNCTL_GENERIC_ENUM  IMPDRV Generic Enumeration
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/*******************************************************************************************************************//**
 * @ingroup IMPDRV_CNNCTL
 * @defgroup IMPDRV_CNNCTL_GENERIC_TYPES IMPDRV Generic Type definitions
 *
 * @{
 **********************************************************************************************************************/
/** @} */
...
/******************************************************************************************************************//**
 * @defgroup IMPDRV_CNNCTL IMPDRV CNNCTL
 *
 * @{
 *********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @brief           Synchronously power off the cores
 * @syncasync       Synchronous
 * @reentrant       Non-Reentrant
 * @param[in,out]   p_coretypectl           Control data structure
 * @return          Function result
