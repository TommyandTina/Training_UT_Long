...
static struct TEST_R_IMPDRV_AttrSetClBrkAddr_Pattern R_IMPDRV_AttrSetClBrkAddr_PCL[] =
{
	...
	/* R_IMPDRV_AttrSetClBrkAddr_0001 */ { { TEST_ADDR_READY_HANDLE , TEST_ADDR_NOT_NULL , { IMPDRV_CORE_TYPE_IMP      , 0 }      , 4           , { 1          , 1 }               , { 0 }         , { 0 }    , { OSAL_RETURN_OK, TRUE }            , { OSAL_RETURN_OK, TRUE }  }, { IMPDRV_EC_OK              } },
