...
static void Return_error(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	/* Fail to set PM policy for IMP0 impdrv_osdep_pm_get_policy returns IMPDRV_EC_NG_SEQSTATE */
	it_stub_set_impdrv_osdep_pm_get_policy(IMPDRV_EC_NG_SEQSTATE);
	ercd = R_IMPDRV_GetPMPolicy(handle, p_core_info, &policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SEQSTATE, *tret, "(No.%d) impdrv_osdep_pm_get_policy returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_SEQSTATE));

	/* Fail to set PM policy for IMP0 impdrv_osdep_pm_get_policy returns IMPDRV_EC_NG_ARGNULL */
	it_stub_set_impdrv_osdep_pm_get_policy(IMPDRV_EC_NG_ARGNULL);
	ercd = R_IMPDRV_GetPMPolicy(handle, p_core_info, &policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SYSTEMERROR, *tret, "(No.%d) impdrv_osdep_pm_get_policy returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_ARGNULL));

	/* Fail to set PM policy for IMP0 impdrv_osdep_pm_get_policy returns IMPDRV_EC_NG_PARAM */
	it_stub_set_impdrv_osdep_pm_get_policy(IMPDRV_EC_NG_PARAM);
	ercd = R_IMPDRV_GetPMPolicy(handle, p_core_info, &policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SYSTEMERROR, *tret, "(No.%d) impdrv_osdep_pm_get_policy returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_PARAM));

	/* Fail to set PM policy for IMP0 impdrv_osdep_pm_get_policy returns IMPDRV_EC_NG_SYSTEMERROR */
	it_stub_set_impdrv_osdep_pm_get_policy(IMPDRV_EC_NG_SYSTEMERROR);
	ercd = R_IMPDRV_GetPMPolicy(handle, p_core_info, &policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SYSTEMERROR, *tret, "(No.%d) impdrv_osdep_pm_get_policy returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_SYSTEMERROR));

	/* Fail to set PM policy for IMP0 impdrv_osdep_pm_get_policy returns IMPDRV_EC_NG_PMSYSTEMERROR */
	it_stub_set_impdrv_osdep_pm_get_policy(IMPDRV_EC_NG_PMSYSTEMERROR);
	ercd = R_IMPDRV_GetPMPolicy(handle, p_core_info, &policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) impdrv_osdep_pm_get_policy returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_PMSYSTEMERROR));
...
static void Valid_state(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	for (int8_t i = 0; i < ARRAY_SIZE(chk_state); i++)
	{
		...
		{
			core_testmsg(p_core_info, "Test core_type = %s, core_num = %d, ercd = %d fail\n",
