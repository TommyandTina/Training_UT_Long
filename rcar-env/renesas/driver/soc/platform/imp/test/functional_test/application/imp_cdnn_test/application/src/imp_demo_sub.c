 ...
 * Device(s)    : -
 * Description  : Memory functions for Sample Application not related how to use DSP 
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
=======================================================================================================================
*/
osal_mq_id_t mq_id_for_callback[] = {
    IMP_RESOURCE_ID + 20,
    IMP_RESOURCE_ID + 21,
    IMP_RESOURCE_ID + 22,
    IMP_RESOURCE_ID + 23,
...
osal_mq_id_t mq_id_for_send_msg[] = {
    IMP_RESOURCE_ID + 6,
    IMP_RESOURCE_ID + 7,
    IMP_RESOURCE_ID + 8,
    IMP_RESOURCE_ID + 9,
...
osal_mq_id_t mq_id_for_receive_msg[] = {
    IMP_RESOURCE_ID + 13,
    IMP_RESOURCE_ID + 14,
    IMP_RESOURCE_ID + 15,
    IMP_RESOURCE_ID + 16,
...
osal_mutex_id_t mutex_id_for_core_state[] = {
    IMP_RESOURCE_ID + 10,
    IMP_RESOURCE_ID + 11,
    IMP_RESOURCE_ID + 12,
    IMP_RESOURCE_ID + 13,
...
osal_mutex_id_t mutex_id_for_attr_state[] = {
    IMP_RESOURCE_ID + 17,
    IMP_RESOURCE_ID + 18,
    IMP_RESOURCE_ID + 19,
    IMP_RESOURCE_ID + 20,
...
osal_mutex_id_t mutex_id_for_impfw_api[] = {
    IMP_RESOURCE_ID + 24,
    IMP_RESOURCE_ID + 25,
    IMP_RESOURCE_ID + 26,
    IMP_RESOURCE_ID + 27,
...
osal_mutex_id_t mutex_id_for_drv[] = {
    IMP_RESOURCE_ID + 2
};

osal_thread_id_t thread_id_for_app[] = {
    IMP_RESOURCE_ID + 2,
    IMP_RESOURCE_ID + 3,
    IMP_RESOURCE_ID + 4,
    IMP_RESOURCE_ID + 5,
...
osal_thread_id_t thread_id_for_impfw[] = {
    IMP_RESOURCE_ID + 9,
    IMP_RESOURCE_ID + 10,
    IMP_RESOURCE_ID + 11,
    IMP_RESOURCE_ID + 12,
...
e_osal_return_t buffer_alloc(st_buffer_t * buffer, uint32_t size)
{
    ...
    ret_osal = R_OSAL_MmngrAlloc(s_osal_mmngr, size, 4096u, &buffer->buffer);
    if (OSAL_RETURN_OK != ret_osal)
    {
        val = (int32_t)ret_osal; /* cast to int32_t */
