...
static void Return_error(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	/* Fail to set memory protection mode impdrv_cmnctl_reg_write32 returns IMPDRV_EC_NG_SEQSTATE */
	it_stub_set_impdrv_impctl_check_state(IMPDRV_EC_NG_SEQSTATE);
	it_stub_set_impdrv_cmnctl_reg_write32(IMPDRV_EC_NG_SEQSTATE);
	ercd = R_IMPDRV_RegWrite32(handle, device_id, offset, data);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SEQSTATE, *tret, "(No.%d) impdrv_cmnctl_reg_write32 returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_SEQSTATE));

	/* Fail to set memory protection mode impdrv_cmnctl_reg_write32 returns IMPDRV_EC_NG_ARGNULL */
	it_stub_set_impdrv_impctl_check_state(IMPDRV_EC_NG_SEQSTATE);
	it_stub_set_impdrv_cmnctl_reg_write32(IMPDRV_EC_NG_ARGNULL);
	ercd = R_IMPDRV_RegWrite32(handle, device_id, offset, data);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SYSTEMERROR, *tret, "(No.%d) impdrv_cmnctl_reg_write32 returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_ARGNULL));

	/* Fail to set memory protection mode impdrv_cmnctl_reg_write32 returns IMPDRV_EC_NG_PARAM */
	it_stub_set_impdrv_impctl_check_state(IMPDRV_EC_NG_SEQSTATE);
	it_stub_set_impdrv_cmnctl_reg_write32(IMPDRV_EC_NG_PARAM);
	ercd = R_IMPDRV_RegWrite32(handle, device_id, offset, data);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SYSTEMERROR, *tret, "(No.%d) impdrv_cmnctl_reg_write32 returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_PARAM));

	/* Fail to set memory protection mode impdrv_cmnctl_reg_write32 returns IMPDRV_EC_NG_NOTSUPPORT */
	it_stub_set_impdrv_impctl_check_state(IMPDRV_EC_NG_SEQSTATE);
	it_stub_set_impdrv_cmnctl_reg_write32(IMPDRV_EC_NG_NOTSUPPORT);
	ercd = R_IMPDRV_RegWrite32(handle, device_id, offset, data);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_NOTSUPPORT, *tret, "(No.%d) impdrv_cmnctl_reg_write32 returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_NOTSUPPORT));

	/* Fail to set memory protection mode impdrv_cmnctl_reg_write32 returns IMPDRV_EC_NG_SYSTEMERROR */
	it_stub_set_impdrv_impctl_check_state(IMPDRV_EC_NG_SEQSTATE);
	it_stub_set_impdrv_cmnctl_reg_write32(IMPDRV_EC_NG_SYSTEMERROR);
	ercd = R_IMPDRV_RegWrite32(handle, device_id, offset, data);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SYSTEMERROR, *tret, "(No.%d) impdrv_cmnctl_reg_write32 returns %s", testno++, impdrv_err_to_name(IMPDRV_EC_NG_SYSTEMERROR));
