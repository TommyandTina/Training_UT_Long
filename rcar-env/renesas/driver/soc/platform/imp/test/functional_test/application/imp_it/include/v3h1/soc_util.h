...
***********************************************************************************************************************/
#define IMPDRV_REG_WPR                  (0x8000)    /** Offset address of hardware register for WPR.        */
/*******************************************************************************************************************//**
...
#define IMPDRV_IMPS_INTSTS_CLR       (IMPDRV_IMPS_INTSTS_TRAP | IMPDRV_IMPS_INTSTS_IER | IMPDRV_IMPS_INTSTS_INT | \
                                                             IMPDRV_IMPS_INTSTS_HPINT |  IMPDRV_IMPS_INTSTS_APIPINT)
                                                                            /**< CLR register value for Slim-IMP. */
/*******************************************************************************************************************//**
...
#define OFS_MAX_VAL_THRES       (0x1E8)
#define OFS_MIN_VAL_THRES       (0x1EC)
#define OFS_MAXSUM_CNT_THRES    (0x1F0)
#define OFS_MINSUM_CNT_THRES    (0x1F4)
#define OFS_MAXSUM_CNT          (0x1E0u)
#define OFS_MINSUM_CNT          (0x1E4u)
