...
static void Return_error(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	/* Fail to open device for DSP0: R_OSAL_IoDeviceOpen returns OSAL_RETURN_FAIL */
	core_info.core_type = IMPDRV_CORE_TYPE_DSP;
	core_info.core_num = 0;
	it_stub_set_R_OSAL_IoDeviceOpen(OSAL_RETURN_FAIL, "vdsp00_00");
	ercd = R_IMPDRV_GetPMState(handle, &core_info, &pmstate);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_SYSTEMERROR, *tret, "(No.%d) R_OSAL_IoDeviceOpen for DSP0 returns %s", testno++, osal_err_to_name(OSAL_RETURN_FAIL));

	/* Fail to get PM state for IMP0: R_OSAL_PmGetState returns OSAL_RETURN_PAR */
	it_stub_set_R_OSAL_PmGetState(OSAL_RETURN_PAR);
	ercd = R_IMPDRV_GetPMState(handle, p_core_info, &pmstate);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmGetState returns %s", testno++, osal_err_to_name(OSAL_RETURN_PAR));

	/* Fail to get PM state for IMP0: R_OSAL_PmGetState returns OSAL_RETURN_DEV */
	it_stub_set_R_OSAL_PmGetState(OSAL_RETURN_DEV);
	ercd = R_IMPDRV_GetPMState(handle, p_core_info, &pmstate);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmGetState returns %s", testno++, osal_err_to_name(OSAL_RETURN_DEV));

	/* Fail to get PM state for IMP0: R_OSAL_PmGetState returns OSAL_RETURN_HANDLE */
	it_stub_set_R_OSAL_PmGetState(OSAL_RETURN_HANDLE);
	ercd = R_IMPDRV_GetPMState(handle, p_core_info, &pmstate);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmGetState returns %s", testno++, osal_err_to_name(OSAL_RETURN_HANDLE));

	/* Fail to get PM state for IMP0: R_OSAL_PmGetState returns OSAL_RETURN_STATE */
	it_stub_set_R_OSAL_PmGetState(OSAL_RETURN_STATE);
	ercd = R_IMPDRV_GetPMState(handle, p_core_info, &pmstate);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmGetState returns %s", testno++, osal_err_to_name(OSAL_RETURN_STATE));

	/* Fail to get PM state for IMP0: R_OSAL_PmGetState returns OSAL_RETURN_UNSUPPORTED_OPERATION */
	it_stub_set_R_OSAL_PmGetState(OSAL_RETURN_UNSUPPORTED_OPERATION);
	ercd = R_IMPDRV_GetPMState(handle, p_core_info, &pmstate);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmGetState returns %s", testno++, osal_err_to_name(OSAL_RETURN_UNSUPPORTED_OPERATION));

	/* Fail to get PM state for IMP0: R_OSAL_PmGetState returns OSAL_RETURN_FAIL */
	it_stub_set_R_OSAL_PmGetState(OSAL_RETURN_FAIL);
	ercd = R_IMPDRV_GetPMState(handle, p_core_info, &pmstate);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmGetState returns %s", testno++, osal_err_to_name(OSAL_RETURN_FAIL));
