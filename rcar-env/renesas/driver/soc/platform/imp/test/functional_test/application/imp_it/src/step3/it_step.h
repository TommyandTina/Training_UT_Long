...
extern int32_t it_SM_IntHandler_Main(struct test_params_t *tparam, struct test_result_t *test_result);
...
extern int32_t it_DSP_CBFUNC_Main(struct test_params_t *tparam, struct test_result_t *test_result);
...
#define RUN_DSP_CALLBACK	run_test(it_DSP_CBFUNC_Main, tparam, tret, test_result);	/*TODO: DSP support V4H only*/
#else
#define RUN_DSP_TEST
#define RUN_DSP_CALLBACK
#endif
...
{	\
		...
		run_test(it_SM_IntHandler_Main,				tparam, tret, test_result);	\
