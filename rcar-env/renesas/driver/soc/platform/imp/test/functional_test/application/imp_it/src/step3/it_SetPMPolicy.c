...
static void Return_error(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	/* Fail to set PM policy for IMP0: R_OSAL_PmSetPolicy returns OSAL_RETURN_PAR */
	it_stub_set_R_OSAL_PmSetPolicy(OSAL_RETURN_PAR);
	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmSetPolicy returns %s", testno++, osal_err_to_name(OSAL_RETURN_PAR));

	/* Fail to set PM policy for IMP0: R_OSAL_PmSetPolicy returns OSAL_RETURN_DEV */
	it_stub_set_R_OSAL_PmSetPolicy(OSAL_RETURN_DEV);
	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmSetPolicy returns %s", testno++, osal_err_to_name(OSAL_RETURN_DEV));

	/* Fail to set PM policy for IMP0: R_OSAL_PmSetPolicy returns OSAL_RETURN_TIME */
	it_stub_set_R_OSAL_PmSetPolicy(OSAL_RETURN_TIME);
	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmSetPolicy returns %s", testno++, osal_err_to_name(OSAL_RETURN_TIME));

	/* Fail to set PM policy for IMP0: R_OSAL_PmSetPolicy returns OSAL_RETURN_HANDLE */
	it_stub_set_R_OSAL_PmSetPolicy(OSAL_RETURN_HANDLE);
	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmSetPolicy returns %s", testno++, osal_err_to_name(OSAL_RETURN_HANDLE));

	/* Fail to set PM policy for IMP0: R_OSAL_PmSetPolicy returns OSAL_RETURN_STATE */
	it_stub_set_R_OSAL_PmSetPolicy(OSAL_RETURN_STATE);
	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmSetPolicy returns %s", testno++, osal_err_to_name(OSAL_RETURN_STATE));

	/* Fail to set PM policy for IMP0: R_OSAL_PmSetPolicy returns OSAL_RETURN_UNSUPPORTED_OPERATION */
	it_stub_set_R_OSAL_PmSetPolicy(OSAL_RETURN_UNSUPPORTED_OPERATION);
	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmSetPolicy returns %s", testno++, osal_err_to_name(OSAL_RETURN_UNSUPPORTED_OPERATION));

	/* Fail to set PM policy for IMP0: R_OSAL_PmSetPolicy returns OSAL_RETURN_FAIL */
	it_stub_set_R_OSAL_PmSetPolicy(OSAL_RETURN_FAIL);
	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, policy);
	it_stub_reset();
	FailTestPrint(ercd, IMPDRV_EC_NG_PMSYSTEMERROR, *tret, "(No.%d) R_OSAL_PmSetPolicy returns %s", testno++, osal_err_to_name(OSAL_RETURN_FAIL));
	...
	/* Fail to set released state for IMP0 after open device: R_OSAL_PmSetRequiredState returns OSAL_RETURN_PAR */
	...
	/* Fail to set released state for IMP0 after open device: R_OSAL_PmSetRequiredState returns OSAL_RETURN_DEV */
	...
	/* Fail to set released state for IMP0 after open device: R_OSAL_PmSetRequiredState returns OSAL_RETURN_TIME */
	...
	/* Fail to set released state for IMP0 after open device: R_OSAL_PmSetRequiredState returns OSAL_RETURN_HANDLE */
	...
	/* Fail to set released state for IMP0 after open device: R_OSAL_PmSetRequiredState returns OSAL_RETURN_STATE */
	...
	/* Fail to set released state for IMP0 after open device: R_OSAL_PmSetRequiredState returns OSAL_RETURN_UNSUPPORTED_OPERATION */
	...
	/* Fail to set released state for IMP0 after open device: R_OSAL_PmSetRequiredState returns OSAL_RETURN_FAIL */
...
static void SetPMPolicy(
	struct test_params_t *tparam,
	impdrv_ctrl_handle_t handle,
	st_impdrv_core_info_t *p_core_info,
	const e_impdrv_pm_policy_t target_policy,
	int32_t *result
)
{
	e_impdrv_errorcode_t ercd;
	e_impdrv_pm_policy_t chk_policy;

	ercd = R_IMPDRV_SetPMPolicy(handle, p_core_info, target_policy);
...
static void Valid_state(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	for (int8_t i = 0; i < ARRAY_SIZE(chk_state); i++)
	{
		...
		SetPMPolicy(tparam, handle, p_core_info, policy, &result);
