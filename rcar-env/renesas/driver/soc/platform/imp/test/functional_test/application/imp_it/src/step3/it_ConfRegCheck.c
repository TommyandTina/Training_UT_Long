...
static void Return_error(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	prepare_test(handle, &core_info);
	it_stub_set_R_OSAL_IoRead32(OSAL_RETURN_PAR, 5, 0);
	ercd = R_IMPDRV_ConfRegCheck(handle, p_chk_param, param_num, &core_info);
	it_stub_reset();
	...
	prepare_test(handle, &core_info);
	it_stub_set_R_OSAL_IoRead32(OSAL_RETURN_DEV, 5, 0);
	ercd = R_IMPDRV_ConfRegCheck(handle, p_chk_param, param_num, &core_info);
	it_stub_reset();
	...
	prepare_test(handle, &core_info);
	it_stub_set_R_OSAL_IoRead32(OSAL_RETURN_IO, 5, 0);
	ercd = R_IMPDRV_ConfRegCheck(handle, p_chk_param, param_num, &core_info);
	it_stub_reset();
	...
	prepare_test(handle, &core_info);
	it_stub_set_R_OSAL_IoRead32(OSAL_RETURN_HANDLE, 5, 0);
	ercd = R_IMPDRV_ConfRegCheck(handle, p_chk_param, param_num, &core_info);
	it_stub_reset();
	...
	prepare_test(handle, &core_info);
	it_stub_set_R_OSAL_IoRead32(OSAL_RETURN_STATE, 5, 0);
	ercd = R_IMPDRV_ConfRegCheck(handle, p_chk_param, param_num, &core_info);
	it_stub_reset();
	...
	prepare_test(handle, &core_info);
	it_stub_set_R_OSAL_IoRead32(OSAL_RETURN_FAIL, 5, 0);
	ercd = R_IMPDRV_ConfRegCheck(handle, p_chk_param, param_num, &core_info);
	it_stub_reset();
