...
static void Return_error(struct test_params_t *tparam, struct test_result_t *tret)
{
	...
	/* Fail to write register impdrv_osdep_read_reg returns IMPDRV_EC_NG_SEQSTATE */
	...
	/* Fail to write register impdrv_osdep_read_reg returns IMPDRV_EC_NG_ARGNULL */
	...
	/* Fail to write register impdrv_osdep_read_reg returns IMPDRV_EC_NG_PARAM */
	...
	/* Fail to write register impdrv_osdep_read_reg returns IMPDRV_EC_NG_SYSTEMERROR */
